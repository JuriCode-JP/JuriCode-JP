...
| 法人税法施行令 | Order for Enforcement of the Corporation Tax Act | `houjin-zei-hou-shikkourei` | 340CO0000000097 |
| 所得税法施行令 | Order for Enforcement of the Income Tax Act | `shotoku-zei-hou-shikkourei` | 340CO0000000096 |
| 消費税法施行令 | Order for Enforcement of the Consumption Tax Act | `shouhi-zei-hou-shikkourei` | 363CO0000000360 |
| 相続税法施行令 | Order for Enforcement of the Inheritance Tax Act | `souzoku-zei-hou-shikkourei` | 325CO0000000071 |
| 国税通則法施行令 | Order for Enforcement of the Act on General Rules for National Taxes | `kokuzei-tsuusoku-hou-shikkourei` | 337CO0000000135 |
| 地方税法施行令 | Order for Enforcement of the Local Tax Act | `chihou-zei-hou-shikkourei` | 325CO0000000245 |
| 法人税法施行規則 | Regulations for Enforcement of the Corporation Tax Act | `houjin-zei-hou-shikoukisoku` | 340M50000040012 |
| 所得税法施行規則 | Regulations for Enforcement of the Income Tax Act | `shotoku-zei-hou-shikoukisoku` | 340M50000040011 |
| 消費税法施行規則 | Regulations for Enforcement of the Consumption Tax Act | `shouhi-zei-hou-shikoukisoku` | 363M50000040053 |
...
国税庁(NTA)の法令解釈通達。e-Gov 法令ではないため法令IDを持たない(著作権法13条2号により著作権の対象外=PD)。出典は NTA 通達ページ。

| 通達名(日本語) | 通達名(英語) | ローマ字略称 | 出典 |
|---|---|---|---|
| 法人税基本通達 | Basic Circular on the Corporation Tax Act | `hojin-kihon-tsutatsu` | NTA |
...
| 租税特別措置法(株式等に係る譲渡所得等関係)の取扱い | Circular on the Act on Special Measures Concerning Taxation (Capital Gains on Shares etc.) | `sochi-kabushiki-tsutatsu` | NTA |
| 租税特別措置法に係る所得税の取扱い(源泉所得税関係) | Circular on the Act on Special Measures Concerning Taxation (Withholding Income Tax) | `sochi-gensen-tsutatsu` | NTA |
| 租税特別措置法関係通達(第40条 取扱い) | Circular on the Act on Special Measures Concerning Taxation (Article 40, Non-taxation of Capital Gains on Donations to Public-interest Corporations) | `sochi-40jou-tsutatsu` | NTA |
