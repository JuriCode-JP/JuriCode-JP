...
article_number: '27'
article_id: kokuzei-tsuusoku-hou-shikkourei-art-27
...
# 国税通則法施行令 第27条(（過少申告加算税等を課さない部分の税額の計算等）)
...
法第六十五条第五項（法第六十六条第七項（無申告加算税）において準用する場合を含む。）に規定する政令で定めるところにより計算した金額は、次の各号に掲げる場合の区分に応じ、当該各号に定める税額（法第六十六条第七項において準用する場合にあつては、第一号に定める税額）とする。
