...
- number: 1
  ...
  segments:
  - id: minpou-art-448-p1
    type: simple
    text: 保証人の負担が債務の目的又は態様において主たる債務より重いときは、これを主たる債務の限度に減縮する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-448-p2
    type: simple
    text: 主たる債務の目的又は態様が保証契約の締結後に加重されたときであっても、保証人の負担は加重されない。
    modality: unspecified
cases: []
amendments: []
tags:
