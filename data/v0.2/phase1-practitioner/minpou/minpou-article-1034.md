...
- number: 1
  ...
  segments:
  - id: minpou-art-1034-p1
    type: simple
    text: 配偶者は、居住建物の通常の必要費を負担する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-1034-p2
    type: junyou
    text: 第五百八十三条第二項の規定は、前項の通常の必要費以外の費用について準用する。
    modality: unspecified
    references:
    - 前項
cases: []
