...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-252-p3
    type: simple
    text: 前二項の規定による決定が、共有者間の決定に基づいて共有物を使用する共有者に特別の影響を及ぼすべきときは、その承諾を得なければならない。
    modality: gimu
    references:
    - 前二項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-252-p4-hashira
    type: hashira
    text: 共有者は、前三項の規定により、共有物に、次の各号に掲げる賃借権その他の使用及び収益を目的とする権利（以下この項において「賃借権等」という。）であって、当該各号に定める期間を超えないものを設定することができる。
    modality: kanou_kenri
    references:
    - 前三項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-252-p5
    type: simple
    text: 各共有者は、前各項の規定にかかわらず、保存行為をすることができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
