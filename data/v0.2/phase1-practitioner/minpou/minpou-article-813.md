...
- number: 1
  ...
  segments:
  - id: minpou-art-813-p1
    type: simple
    text: 離縁の届出は、その離縁が前条において準用する第七百三十九条第二項の規定並びに第八百十一条及び第八百十一条の二の規定その他の法令の規定に違反しないことを認めた後でなければ、受理することができない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-813-p2
    type: simple
    text: 離縁の届出が前項の規定に違反して受理されたときであっても、離縁は、そのためにその効力を妨げられない。
