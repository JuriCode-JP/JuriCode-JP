...
- number: 1
  ...
  segments:
  - id: minpou-art-498-p1
    type: simple
    text: 弁済の目的物又は前条の代金が供託された場合には、債権者は、供託物の還付を請求することができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-498-p2
    type: simple
    text: 債務者が債権者の給付に対して弁済をすべき場合には、債権者は、その給付をしなければ、供託物を受け取ることができない。
