...
- number: 1
  ...
  segments:
  - id: minpou-art-988-p1-honbun
    type: honbun
    text: 受遺者が遺贈の承認又は放棄をしないで死亡したときは、その相続人は、自己の相続権の範囲内で、遺贈の承認又は放棄をすることができる。
    modality: kanou_kenri
  - id: minpou-art-988-p1-tadashi
    type: tadashi
