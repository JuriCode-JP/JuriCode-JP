...
- number: 1
  ...
  segments:
  - id: minpou-art-320-p1
    type: simple
    text: 動産の保存の先取特権は、動産の保存のために要した費用又は動産に関する権利の保存、承認若しくは実行のために要した費用に関し、その動産について存在する。
...
<!-- segment: simple id: minpou-art-320-p1 -->
