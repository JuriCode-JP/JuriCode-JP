...
- number: 1
  ...
  segments:
  - id: minpou-art-491-p1
    type: simple
    text: 一個の債務の弁済として数個の給付をすべき場合において、弁済をする者がその債務の全部を消滅させるのに足りない給付をしたときは、前三条の規定を準用する。
...
<!-- segment: simple id: minpou-art-491-p1 -->
