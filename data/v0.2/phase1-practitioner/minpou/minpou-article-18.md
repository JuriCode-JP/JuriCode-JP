...
- number: 1
  ...
  - id: minpou-art-18-p1
    type: simple
    text: 第十五条第一項本文に規定する原因が消滅したときは、家庭裁判所は、本人、配偶者、四親等内の親族、未成年後見人、未成年後見監督人、補助人、補助監督人又は検察官の請求により、補助開始の審判を取り消さなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
...
- number: 3
  ...
  - id: minpou-art-18-p3
    type: simple
    text: 前条第一項の審判及び第八百七十六条の九第一項の審判をすべて取り消す場合には、家庭裁判所は、補助開始の審判を取り消さなければならない。
    modality: gimu
    references:
    - 前条
cases: []
