...
- number: 1
  ...
  segments:
  - id: minpou-art-495-p1
    type: simple
    text: 前条の規定による供託は、債務の履行地の供託所にしなければならない。
    modality: gimu
    references:
    - 前条
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-495-p2
    type: simple
    text: 供託所について法令に特別の定めがない場合には、裁判所は、弁済者の請求により、供託所の指定及び供託物の保管者の選任をしなければならない。
    modality: gimu
- number: 3
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: minpou-art-495-p3
    type: simple
    text: 前条の規定により供託をした者は、遅滞なく、債権者に供託の通知をしなければならない。
    modality: gimu
    references:
    - 前条
cases: []
