...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-209-p2
    type: simple
    text: 前項の場合には、使用の日時、場所及び方法は、隣地の所有者及び隣地を現に使用している者（以下この条において「隣地使用者」という。）のために損害が最も少ないものを選ばなければならない。
    modality: gimu
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-209-p3-honbun
    type: honbun
    text: 第一項の規定により隣地を使用する者は、あらかじめ、その目的、日時、場所及び方法を隣地の所有者及び隣地使用者に通知しなければならない。
    modality: gimu
  - id: minpou-art-209-p3-tadashi
    type: tadashi
    text: ただし、あらかじめ通知することが困難なときは、使用を開始した後、遅滞なく、通知することをもって足りる。
    modality: unspecified
- number: 4
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: minpou-art-209-p4
    type: simple
    text: 第一項の場合において、隣地の所有者又は隣地使用者が損害を受けたときは、その償金を請求することができる。
