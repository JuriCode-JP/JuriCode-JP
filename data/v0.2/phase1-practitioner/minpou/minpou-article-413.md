...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-413-p2
    type: simple
    text: 債権者が債務の履行を受けることを拒み、又は受けることができないことによって、その履行の費用が増加したときは、その増加額は、債権者の負担とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: minpou-art-413-p1 -->
<!-- segment: simple id: minpou-art-413-p2 -->
