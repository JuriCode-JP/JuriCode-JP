...
- number: 1
  ...
  segments:
  - id: minpou-art-998-p1-honbun
    type: honbun
    text: 遺贈義務者は、遺贈の目的である物又は権利を、相続開始の時（その後に当該物又は権利について遺贈の目的として特定した場合にあっては、その特定した時）の状態で引き渡し、又は移転する義務を負う。
    modality: unspecified
  - id: minpou-art-998-p1-tadashi
    type: tadashi
