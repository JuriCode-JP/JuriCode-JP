...
- number: 1
  ...
  segments:
  - id: minpou-art-302-p1-honbun
    type: honbun
    text: 留置権は、留置権者が留置物の占有を失うことによって、消滅する。
    modality: unspecified
  - id: minpou-art-302-p1-tadashi
    type: tadashi
    text: ただし、第二百九十八条第二項の規定により留置物を賃貸し、又は質権の目的としたときは、この限りでない。
    modality: jogai
cases: []
amendments: []
tags:
