...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-651-p2-hashira
    type: hashira
    text: 前項の規定により委任の解除をした者は、次に掲げる場合には、相手方の損害を賠償しなければならない。ただし、やむを得ない事由があったときは、この限りでない。
    modality: jogai
    references:
    - 前項
cases: []
