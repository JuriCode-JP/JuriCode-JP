...
- number: 1
  ...
  segments:
  - id: minpou-art-646-p1
    type: simple
    text: 受任者は、委任事務を処理するに当たって受け取った金銭その他の物を委任者に引き渡さなければならない。その収取した果実についても、同様とする。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: minpou-art-646-p2
    type: simple
    text: 受任者は、委任者のために自己の名で取得した権利を委任者に移転しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
