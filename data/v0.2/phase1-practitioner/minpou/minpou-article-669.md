...
- number: 1
  ...
  segments:
  - id: minpou-art-669-p1
    type: simple
    text: 金銭を出資の目的とした場合において、組合員がその出資をすることを怠ったときは、その利息を支払うほか、損害の賠償をしなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: minpou-art-669-p1 -->
