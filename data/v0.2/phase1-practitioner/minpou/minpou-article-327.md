...
- number: 1
  ...
  segments:
  - id: minpou-art-327-p1
    type: simple
    text: 不動産の工事の先取特権は、工事の設計、施工又は監理をする者が債務者の不動産に関してした工事の費用に関し、その不動産について存在する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-327-p2
    type: simple
    text: 前項の先取特権は、工事によって生じた不動産の価格の増加が現存する場合に限り、その増価額についてのみ存在する。
    modality: unspecified
    references:
    - 前項
cases: []
