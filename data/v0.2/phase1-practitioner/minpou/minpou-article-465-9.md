...
article_number: 465-9
article_id: minpou-art-465-9
...
- number: 1
  ...
  segments:
  - id: minpou-art-465-9-p1-hashira
    type: hashira
    text: 前三条の規定は、保証人になろうとする者が次に掲げる者である保証契約については、適用しない。
    modality: jogai
    references:
    - 前三条
  - id: minpou-art-465-9-p1-kou-1
    type: kou
    text: 一　主たる債務者が法人である場合のその理事、取締役、執行役又はこれらに準ずる者
    modality: unspecified
    item_number: 1
  - id: minpou-art-465-9-p1-kou-2
    type: kou
    text: '二　主たる債務者が法人である場合の次に掲げる者
    ...
    modality: unspecified
    item_number: 2
  - id: minpou-art-465-9-p1-kou-3
    type: kou
    text: 三　主たる債務者（法人であるものを除く。以下この号において同じ。）と共同して事業を行う者又は主たる債務者が行う事業に現に従事している主たる債務者の配偶者
    modality: unspecified
    item_number: 3
cases: []
amendments: []
...
# 民法 第465-9条(（公正証書の作成と保証の効力に関する規定の適用除外）)
