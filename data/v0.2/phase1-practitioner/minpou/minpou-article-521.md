...
- number: 1
  ...
  segments:
  - id: minpou-art-521-p1
    type: simple
    text: 何人も、法令に特別の定めがある場合を除き、契約をするかどうかを自由に決定することができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-521-p2
    type: simple
    text: 契約の当事者は、法令の制限内において、契約の内容を自由に決定することができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
