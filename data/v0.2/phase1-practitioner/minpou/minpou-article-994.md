...
- number: 1
  ...
  segments:
  - id: minpou-art-994-p1
    type: simple
    text: 遺贈は、遺言者の死亡以前に受遺者が死亡したときは、その効力を生じない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-994-p2-honbun
    type: honbun
    text: 停止条件付きの遺贈については、受遺者がその条件の成就前に死亡したときも、前項と同様とする。
    modality: gimu
    references:
    - 前項
  - id: minpou-art-994-p2-tadashi
    type: tadashi
