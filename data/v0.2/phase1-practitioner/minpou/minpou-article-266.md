...
- number: 1
  ...
  segments:
  - id: minpou-art-266-p1
    type: junyou
    text: 第二百七十四条から第二百七十六条までの規定は、地上権者が土地の所有者に定期の地代を支払わなければならない場合について準用する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-266-p2
    type: simple
    text: 地代については、前項に規定するもののほか、その性質に反しない限り、賃貸借に関する規定を準用する。
    modality: unspecified
    references:
    - 前項
cases: []
