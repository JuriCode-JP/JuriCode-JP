...
- number: 1
  ...
  segments:
  - id: minpou-art-259-p1
    type: simple
    text: 共有者の一人が他の共有者に対して共有に関する債権を有するときは、分割に際し、債務者に帰属すべき共有物の部分をもって、その弁済に充てることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-259-p2
    type: simple
    text: 債権者は、前項の弁済を受けるため債務者に帰属すべき共有物の部分を売却する必要があるときは、その売却を請求することができる。
    modality: kanou_kenri
    references:
    - 前項
cases: []
