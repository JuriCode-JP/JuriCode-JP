...
- number: 2
  ...
  - id: minpou-art-95-p2
    type: simple
    text: 前項第二号の規定による意思表示の取消しは、その事情が法律行為の基礎とされていることが表示されていたときに限り、することができる。
...
- number: 4
  ...
  - id: minpou-art-95-p4
    type: simple
    text: 第一項の規定による意思表示の取消しは、善意でかつ過失がない第三者に対抗することができない。
    modality: kanou_negative
cases: []
amendments: []
tags:
