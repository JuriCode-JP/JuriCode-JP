...
- number: 1
  ...
  segments:
  - id: minpou-art-410-p1
    type: simple
    text: 債権の目的である給付の中に不能のものがある場合において、その不能が選択権を有する者の過失によるものであるときは、債権は、その残存するものについて存在する。
...
<!-- segment: simple id: minpou-art-410-p1 -->
