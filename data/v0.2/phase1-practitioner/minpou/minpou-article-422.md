...
- number: 1
  ...
  segments:
  - id: minpou-art-422-p1
    type: simple
    text: 債権者が、損害賠償として、その債権の目的である物又は権利の価額の全部の支払を受けたときは、債務者は、その物又は権利について当然に債権者に代位する。
...
<!-- segment: simple id: minpou-art-422-p1 -->
