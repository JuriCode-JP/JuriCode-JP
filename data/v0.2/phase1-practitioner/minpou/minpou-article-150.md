...
- number: 1
  ...
  segments:
  - id: minpou-art-150-p1
    type: simple
    text: 催告があったときは、その時から六箇月を経過するまでの間は、時効は、完成しない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-150-p2
    type: simple
    text: 催告によって時効の完成が猶予されている間にされた再度の催告は、前項の規定による時効の完成猶予の効力を有しない。
    modality: unspecified
    references:
    - 前項
cases: []
