...
- number: 1
  ...
  segments:
  - id: minpou-art-993-p1
    type: junyou
    text: 第二百九十九条の規定は、遺贈義務者が遺言者の死亡後に遺贈の目的物について費用を支出した場合について準用する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-993-p2
    type: simple
    text: 果実を収取するために支出した通常の必要費は、果実の価格を超えない限度で、その償還を請求することができる。
