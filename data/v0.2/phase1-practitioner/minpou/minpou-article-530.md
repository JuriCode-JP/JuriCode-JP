...
- number: 1
  ...
  segments:
  - id: minpou-art-530-p1
    type: simple
    text: 前の広告と同一の方法による広告の撤回は、これを知らない者に対しても、その効力を有する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-530-p2-honbun
    type: honbun
    text: 広告の撤回は、前の広告と異なる方法によっても、することができる。
    modality: kanou_kenri
  - id: minpou-art-530-p2-tadashi
    type: tadashi
    text: ただし、その撤回は、これを知った者に対してのみ、その効力を有する。
    modality: unspecified
cases: []
amendments: []
tags:
