...
- number: 1
  ...
  segments:
  - id: minpou-art-346-p1-honbun
    type: honbun
    text: 質権は、元本、利息、違約金、質権の実行の費用、質物の保存の費用及び債務の不履行又は質物の隠れた瑕疵によって生じた損害の賠償を担保する。
    modality: unspecified
  - id: minpou-art-346-p1-tadashi
    type: tadashi
