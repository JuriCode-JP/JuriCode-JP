...
- number: 1
  ...
  segments:
  - id: minpou-art-861-p1
    type: simple
    text: 後見人は、その就職の初めにおいて、被後見人の生活、教育又は療養看護及び財産の管理のために毎年支出すべき金額を予定しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: minpou-art-861-p2
    type: simple
    text: 後見人が後見の事務を行うために必要な費用は、被後見人の財産の中から支弁する。
