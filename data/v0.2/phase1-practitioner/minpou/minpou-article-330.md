...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-330-p2
    type: simple
    text: 前項の場合において、第一順位の先取特権者は、その債権取得の時において第二順位又は第三順位の先取特権者があることを知っていたときは、これらの者に対して優先権を行使することができない。第一順位の先取特権者のために物を保存した者に対しても、同様とする。
    modality: gimu
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-330-p3
    type: simple
    text: 果実に関しては、第一の順位は農業の労務に従事する者に、第二の順位は種苗又は肥料の供給者に、第三の順位は土地の賃貸人に属する。
    modality: unspecified
cases: []
amendments: []
tags:
