...
- number: 1
  ...
  segments:
  - id: minpou-art-348-p1-zen
    type: zen_dan
    text: 質権者は、その権利の存続期間内において、自己の責任で、質物について、転質をすることができる。
    modality: kanou_kenri
  - id: minpou-art-348-p1-kou
    type: kou_dan
    text: この場合において、転質をしたことによって生じた損失については、不可抗力によるものであっても、その責任を負う。
    modality: unspecified
    depends_on: minpou-art-348-p1-zen
cases: []
amendments: []
tags:
- phase1-practitioner
