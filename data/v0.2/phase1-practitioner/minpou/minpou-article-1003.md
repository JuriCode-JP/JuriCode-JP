...
- number: 1
  ...
  segments:
  - id: minpou-art-1003-p1-honbun
    type: honbun
    text: 負担付遺贈の目的の価額が相続の限定承認又は遺留分回復の訴えによって減少したときは、受遺者は、その減少の割合に応じて、その負担した義務を免れる。
    modality: unspecified
  - id: minpou-art-1003-p1-tadashi
    type: tadashi
