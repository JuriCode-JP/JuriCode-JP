...
- number: 1
  ...
  segments:
  - id: minpou-art-674-p1
    type: simple
    text: 当事者が損益分配の割合を定めなかったときは、その割合は、各組合員の出資の価額に応じて定める。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-674-p2
    type: simple
    text: 利益又は損失についてのみ分配の割合を定めたときは、その割合は、利益及び損失に共通であるものと推定する。
    modality: unspecified
cases: []
amendments: []
tags:
