...
- number: 1
  ...
  segments:
  - id: minpou-art-340-p1
    type: simple
    text: 不動産の売買の先取特権の効力を保存するためには、売買契約と同時に、不動産の代価又はその利息の弁済がされていない旨を登記しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: minpou-art-340-p1 -->
