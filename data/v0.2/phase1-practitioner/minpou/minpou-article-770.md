...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: minpou-art-770-p2
    type: simple
    text: 裁判所は、前項第一号から第三号までに掲げる事由がある場合であっても、一切の事情を考慮して婚姻の継続を相当と認めるときは、離婚の請求を棄却することができる。
    modality: kanou_kenri
    references:
    - 前項
cases: []
