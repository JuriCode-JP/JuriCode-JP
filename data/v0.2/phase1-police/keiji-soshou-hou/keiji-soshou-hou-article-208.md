...
article_number: '208'
article_id: keiji-soshou-hou-art-208
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-208-p1
    type: simple
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-208-p2
    type: simple
    text: 裁判官は、やむを得ない事由があると認めるときは、検察官の請求により、前項の期間を延長することができる。この期間の延長は、通じて十日を超えることができない。
