...
article_number: '26'
article_id: keiji-soshou-hou-art-26
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-26-p2
    type: simple
    text: 決定は、裁判所書記所属の裁判所がこれをしなければならない。但し、第二十四条第一項の場合には、裁判所書記の附属する受命裁判官が、忌避の申立を却下する裁判をすることができる。
