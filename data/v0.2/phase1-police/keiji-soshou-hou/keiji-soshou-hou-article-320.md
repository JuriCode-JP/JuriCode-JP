...
article_number: '320'
article_id: keiji-soshou-hou-art-320
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-320-p1
    type: simple
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-320-p2
    type: simple
    text: 第二百九十一条の二の決定があつた事件の証拠については、前項の規定は、これを適用しない。但し、検察官、被告人又は弁護人が証拠とすることに異議を述べたものについては、この限りでない。
    modality: jogai
    references:
    - 前項
cases: []
