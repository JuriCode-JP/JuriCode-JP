...
article_number: '335'
article_id: keiji-soshou-hou-art-335
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-335-p1
    type: simple
    text: 有罪の言渡をするには、罪となるべき事実、証拠の標目及び法令の適用を示さなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-335-p2
    type: simple
    text: 法律上犯罪の成立を妨げる理由又は刑の加重減免の理由となる事実が主張されたときは、これに対する判断を示さなければならない。
    modality: gimu
cases: []
amendments: []
tags:
