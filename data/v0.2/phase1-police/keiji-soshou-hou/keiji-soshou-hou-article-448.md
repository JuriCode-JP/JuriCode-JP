...
article_number: '448'
article_id: keiji-soshou-hou-art-448
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-448-p1
    type: simple
    text: 再審の請求が理由のあるときは、再審開始の決定をしなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-448-p2
    type: simple
    text: 再審開始の決定をしたときは、決定で刑の執行を停止することができる。
