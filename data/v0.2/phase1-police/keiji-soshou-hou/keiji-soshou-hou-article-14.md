...
article_number: '14'
article_id: keiji-soshou-hou-art-14
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-14-p1
    type: simple
    text: 裁判所は、管轄権を有しないときでも、急速を要する場合には、事実発見のため必要な処分をすることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-14-p2
    type: simple
    text: 前項の規定は、受命裁判官にこれを準用する。
