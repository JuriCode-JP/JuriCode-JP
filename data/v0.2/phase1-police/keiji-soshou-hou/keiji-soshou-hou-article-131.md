...
article_number: '131'
article_id: keiji-soshou-hou-art-131
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-131-p1
    type: simple
    text: 身体の検査については、これを受ける者の性別、健康状態その他の事情を考慮した上、特にその方法に注意し、その者の名誉を害しないように注意しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-131-p2
    type: simple
    text: 女子の身体を検査する場合には、医師又は成年の女子をこれに立ち会わせなければならない。
    modality: gimu
cases: []
amendments: []
tags:
