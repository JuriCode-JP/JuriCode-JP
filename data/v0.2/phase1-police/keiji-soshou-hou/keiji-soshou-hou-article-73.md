...
article_number: '73'
article_id: keiji-soshou-hou-art-73
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-73-p1
    type: simple
    text: 勾引状を執行するには、これを被告人に示した上、できる限り速やかに且つ直接、指定された裁判所その他の場所に引致しなければならない。第六十六条第四項の勾引状については、これを発した裁判官に引致しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-73-p3
    type: simple
    text: 勾引状又は勾留状を所持しないためこれを示すことができない場合において、急速を要するときは、前二項の規定にかかわらず、被告人に対し公訴事実の要旨及び令状が発せられている旨を告げて、その執行をすることができる。但し、令状は、できる限り速やかにこれを示さなければならない。
    modality: gimu
    references:
    - 前二項
cases: []
