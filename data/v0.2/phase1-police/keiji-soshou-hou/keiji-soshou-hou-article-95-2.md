...
article_number: 95-2
article_id: keiji-soshou-hou-art-95-2
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-95-2-p1
    type: simple
    text: 期間を指定されて勾留の執行停止をされた被告人が、正当な理由がなく、当該期間の終期として指定された日時に、出頭すべき場所として指定された場所に出頭しないときは、二年以下の拘禁刑に処する。
    modality: gimu_kei
cases: []
amendments: []
tags:
