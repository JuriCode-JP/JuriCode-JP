...
article_number: '398'
article_id: keiji-soshou-hou-art-398
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-398-p1
    type: simple
    text: 不法に、管轄違を言い渡し、又は公訴を棄却したことを理由として原判決を破棄するときは、判決で事件を原裁判所に差し戻さなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: keiji-soshou-hou-art-398-p1 -->
