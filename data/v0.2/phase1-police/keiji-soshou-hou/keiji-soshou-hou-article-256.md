...
article_number: '256'
article_id: keiji-soshou-hou-art-256
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-256-p1
    type: simple
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-256-p3
    type: simple
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-256-p4
    type: simple
    text: 罪名は、適用すべき罰条を示してこれを記載しなければならない。但し、罰条の記載の誤は、被告人の防禦に実質的な不利益を生ずる虞がない限り、公訴提起の効力に影響を及ぼさない。
    modality: unspecified
- number: 5
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-256-p5
    type: simple
    text: 数個の訴因及び罰条は、予備的に又は択一的にこれを記載することができる。
...
- number: 6
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-256-p6
    type: simple
    text: 起訴状には、裁判官に事件につき予断を生ぜしめる虞のある書類その他の物を添附し、又はその内容を引用してはならない。
