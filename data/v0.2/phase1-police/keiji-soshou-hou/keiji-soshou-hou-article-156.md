...
article_number: '156'
article_id: keiji-soshou-hou-art-156
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-156-p1
    type: simple
    text: 証人には、その実験した事実により推測した事項を供述させることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-156-p2
    type: simple
    text: 前項の供述は、鑑定に属するものでも、証言としての効力を妨げられない。
