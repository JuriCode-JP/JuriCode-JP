...
article_number: '54'
article_id: keiji-soshou-hou-art-54
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-54-p1
    type: simple
    text: 書類の送達については、裁判所の規則に特別の定のある場合を除いては、民事訴訟に関する法令の規定（公示送達に関する規定を除く。）を準用する。
...
<!-- segment: simple id: keiji-soshou-hou-art-54-p1 -->
