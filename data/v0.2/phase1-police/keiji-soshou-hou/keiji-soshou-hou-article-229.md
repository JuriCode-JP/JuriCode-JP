...
article_number: '229'
article_id: keiji-soshou-hou-art-229
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-229-p1
    type: simple
    text: 変死者又は変死の疑のある死体があるときは、その所在地を管轄する地方検察庁又は区検察庁の検察官は、検視をしなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-229-p2
    type: simple
    text: 検察官は、検察事務官又は司法警察員に前項の処分をさせることができる。
