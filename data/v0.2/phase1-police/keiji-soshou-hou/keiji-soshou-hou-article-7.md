...
article_number: '7'
article_id: keiji-soshou-hou-art-7
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-7-p1
    type: simple
    text: 土地管轄を異にする数個の関連事件が同一裁判所に係属する場合において、併せて審判することを必要としないものがあるときは、その裁判所は、決定で管轄権を有する他の裁判所にこれを移送することができる。
...
<!-- segment: simple id: keiji-soshou-hou-art-7-p1 -->
