...
article_number: '201'
article_id: keiji-soshou-hou-art-201
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-201-p1
    type: simple
    text: 逮捕状により被疑者を逮捕するには、逮捕状を被疑者に示さなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-201-p2
    type: simple
    text: 第七十三条第三項の規定は、逮捕状により被疑者を逮捕する場合にこれを準用する。
