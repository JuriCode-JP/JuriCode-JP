...
article_number: '99'
article_id: keiji-soshou-hou-art-99
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-99-p1
    type: simple
    text: 裁判所は、必要があるときは、証拠物又は没収すべき物と思料するものを差し押えることができる。但し、特別の定のある場合は、この限りでない。
    modality: jogai
- number: 2
  has_proviso: false
  has_items: false
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-99-p3
    type: simple
    text: 裁判所は、差し押えるべき物を指定し、所有者、所持者又は保管者にその物の提出を命ずることができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
