...
article_number: '3'
article_id: keiji-soshou-hou-art-3
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-3-p1
    type: simple
    text: 事物管轄を異にする数個の事件が関連するときは、上級の裁判所は、併せてこれを管轄することができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-3-p2
    type: simple
    text: 高等裁判所の特別権限に属する事件と他の事件とが関連するときは、高等裁判所は、併せてこれを管轄することができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
