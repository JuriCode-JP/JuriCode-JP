...
article_number: '11'
article_id: keiji-soshou-hou-art-11
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-11-p1
    type: simple
    text: 同一事件が事物管轄を同じくする数個の裁判所に係属するときは、最初に公訴を受けた裁判所が、これを審判する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-11-p2
    type: simple
    text: 各裁判所に共通する直近上級の裁判所は、検察官又は被告人の請求により、決定で後に公訴を受けた裁判所にその事件を審判させることができる。
