...
article_number: '365'
article_id: keiji-soshou-hou-art-365
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-365-p1
    type: simple
    text: 上訴権回復の請求があつたときは、原裁判所は、前条の決定をするまで裁判の執行を停止する決定をすることができる。この場合には、被告人に対し勾留状を発することができる。
...
<!-- segment: simple id: keiji-soshou-hou-art-365-p1 -->
