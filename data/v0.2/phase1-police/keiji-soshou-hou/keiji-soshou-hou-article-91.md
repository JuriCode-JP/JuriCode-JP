...
article_number: '91'
article_id: keiji-soshou-hou-art-91
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-91-p1
    type: simple
    text: 勾留による拘禁が不当に長くなつたときは、裁判所は、第八十八条に規定する者の請求により、又は職権で、決定を以て勾留を取り消し、又は保釈を許さなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
