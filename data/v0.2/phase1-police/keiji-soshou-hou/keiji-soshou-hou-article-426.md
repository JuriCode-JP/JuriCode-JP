...
article_number: '426'
article_id: keiji-soshou-hou-art-426
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-426-p1
    type: simple
    text: 抗告の手続がその規定に違反したとき、又は抗告が理由のないときは、決定で抗告を棄却しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-426-p2
    type: simple
    text: 抗告が理由のあるときは、決定で原決定を取り消し、必要がある場合には、更に裁判をしなければならない。
    modality: gimu
cases: []
amendments: []
tags:
