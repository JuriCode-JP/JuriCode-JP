...
article_number: '155'
article_id: keiji-soshou-hou-art-155
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-155-p1
    type: simple
    text: 宣誓の趣旨を理解することができない者は、宣誓をさせないで、これを尋問しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-155-p2
    type: simple
    text: 前項に掲げる者が宣誓をしたときでも、その供述は、証言としての効力を妨げられない。
