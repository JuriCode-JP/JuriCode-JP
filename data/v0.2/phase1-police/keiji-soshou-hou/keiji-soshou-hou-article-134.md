...
article_number: '134'
article_id: keiji-soshou-hou-art-134
...
- number: 1
  ...
  segments:
  - id: keiji-soshou-hou-art-134-p1
    type: simple
    text: 第百三十二条の規定により召喚を受け正当な理由がなく出頭しない者は、十万円以下の罰金又は拘留に処する。
    modality: gimu_kei
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keiji-soshou-hou-art-134-p2
    type: simple
    text: 前項の罪を犯した者には、情状により、罰金及び拘留を併科することができる。
