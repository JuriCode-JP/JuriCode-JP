...
article_number: '77'
article_id: douro-koutsuu-hou-art-77
...
- number: 1
  ...
  segments:
  - id: douro-koutsuu-hou-art-77-p1-hashira
    type: hashira
    text: 次の各号のいずれかに該当する者は、それぞれ当該各号に掲げる行為について当該行為に係る場所を管轄する警察署長（以下この節において「所轄警察署長」という。）の許可（当該行為に係る場所が同一の公安委員会の管理に属する二以上の警察署長の管轄にわたるときは、そのいずれかの所轄警察署長の許可。以下この節において同じ。）を受けなければならない。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-77-p2-hashira
    type: hashira
    text: 前項の許可の申請があつた場合において、当該申請に係る行為が次の各号のいずれかに該当するときは、所轄警察署長は、許可をしなければならない。
    modality: gimu
    references:
    - 前項
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-77-p3
    type: simple
    text: 第一項の規定による許可をする場合において、必要があると認めるときは、所轄警察署長は、当該許可に係る行為が前項第一号に該当する場合を除き、当該許可に道路における危険を防止し、その他交通の安全と円滑を図るため必要な条件を付することができる。
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-77-p4
    type: simple
    text: 所轄警察署長は、道路における危険を防止し、その他交通の安全と円滑を図るため特別の必要が生じたときは、前項の規定により付した条件を変更し、又は新たに条件を付することができる。
    modality: kanou_kenri
    references:
    - 前項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-77-p5
    type: simple
    text: 所轄警察署長は、第一項の規定による許可を受けた者が前二項の規定による条件に違反したとき、又は道路における危険を防止し、その他交通の安全と円滑を図るため特別の必要が生じたときは、その許可を取り消し、又はその許可の効力を停止することができる。
    modality: kanou_kenri
    references:
    - 前二項
- number: 6
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-77-p6-honbun
    type: honbun
    text: 所轄警察署長は、第三項又は第四項の規定による条件に違反した者について前項の規定による処分をしようとするときは、当該処分に係る者に対し、あらかじめ、弁明をなすべき日時、場所及び当該処分をしようとする理由を通知して、当該事案について弁明及び有利な証拠の提出の機会を与えなければならない。
    modality: gimu
    references:
    - 前項
  - id: douro-koutsuu-hou-art-77-p6-tadashi
    type: tadashi
    text: ただし、交通の危険を防止するため緊急やむを得ないときは、この限りでない。
    modality: jogai
- number: 7
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-77-p7
    type: simple
