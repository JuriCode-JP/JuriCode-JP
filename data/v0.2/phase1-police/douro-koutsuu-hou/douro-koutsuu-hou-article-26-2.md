...
article_number: 26-2
article_id: douro-koutsuu-hou-art-26-2
...
- number: 1
  ...
  segments:
  - id: douro-koutsuu-hou-art-26-2-p1
    type: simple
    text: 車両は、みだりにその進路を変更してはならない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-26-2-p2
    type: simple
    text: 車両は、進路を変更した場合にその変更した後の進路と同一の進路を後方から進行してくる車両等の速度又は方向を急に変更させることとなるおそれがあるときは、進路を変更してはならない。
    modality: gimu_negative
- number: 3
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-26-2-p3-hashira
    type: hashira
    text: 車両は、車両通行帯を通行している場合において、その車両通行帯が当該車両通行帯を通行している車両の進路の変更の禁止を表示する道路標示によつて区画されているときは、次に掲げる場合を除き、その道路標示をこえて進路を変更してはならない。
    modality: gimu_negative
