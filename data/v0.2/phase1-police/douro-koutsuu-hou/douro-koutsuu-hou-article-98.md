...
article_number: '98'
article_id: douro-koutsuu-hou-art-98
...
- number: 1
  ...
  segments:
  - id: douro-koutsuu-hou-art-98-p1
    type: simple
    text: 自動車教習所（免許を受けようとする者に対し、自動車の運転に関する技能及び知識について教習を行う施設をいう。以下同じ。）を設置し、又は管理する者は、当該自動車教習所において行う自動車の運転に関する教習の水準の維持向上に努めなければならない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-98-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-98-p3
    type: simple
    text: 公安委員会は、前項の規定による届出をした自動車教習所を設置し、又は管理する者に対し、自動車の運転に関する教習の適正な水準を確保するため、当該自動車教習所における教習の態様に応じて、必要な指導又は助言をするものとする。
    modality: gimu
    references:
    - 前項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-98-p4
    type: simple
    text: 公安委員会は、前項の指導又は助言をした場合において、必要があると認めるときは、自動車安全運転センターに対し、当該指導又は助言に係る自動車教習所における自動車の運転に関する技能又は知識の教習を行う職員に対する研修その他当該職員の資質の向上を図るための措置について、必要な配慮を加えるよう求めることができる。
    modality: kanou_kenri
    references:
    - 前項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: douro-koutsuu-hou-art-98-p5
    type: simple
    text: 公安委員会は、内閣府令で定めるところにより、第三項の指導又は助言をするため必要な限度において、第二項の規定による届出をした自動車教習所を設置し、又は管理する者に対し、必要な報告又は資料の提出を求めることができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
