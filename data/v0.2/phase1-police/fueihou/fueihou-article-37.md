...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: fueihou-art-37-p3
    type: simple
    text: 前項の規定により警察職員が立ち入るときは、その身分を示す証明書を携帯し、関係者に提示しなければならない。
    modality: gimu
    references:
    - 前項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: fueihou-art-37-p4
    type: simple
    text: 第二項の規定による権限は、犯罪捜査のために認められたものと解してはならない。
...
# 風俗営業等の規制及び業務の適正化等に関する法律 第37条(（報告及び立入り）)
