...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: fueihou-art-23-p2
    type: simple
    text: 第二条第一項第四号のまあじやん屋又は同項第五号の営業を営む者は、その営業に関し、遊技の結果に応じて賞品を提供してはならない。
    modality: gimu_negative
    references:
    - 同項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: fueihou-art-23-p3
    type: junyou
    text: 第一項第三号及び第四号の規定は、第二条第一項第五号の営業を営む者について準用する。
    modality: unspecified
cases: []
amendments: []
tags:
...
# 風俗営業等の規制及び業務の適正化等に関する法律 第23条(（遊技場営業を営む者の禁止行為）)
