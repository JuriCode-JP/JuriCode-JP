...
- number: 1
  ...
  segments:
  - id: keihou-art-244-p1
    type: simple
    text: 配偶者、直系血族又は同居の親族との間で第二百三十五条の罪、第二百三十五条の二の罪又はこれらの罪の未遂罪を犯した者は、その刑を免除する。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: keihou-art-244-p3
    type: simple
    text: 前二項の規定は、親族でない共犯については、適用しない。
    modality: jogai
    references:
    - 前二項
cases: []
