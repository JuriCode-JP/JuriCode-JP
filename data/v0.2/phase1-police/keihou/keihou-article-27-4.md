...
- number: 1
  ...
  segments:
  - id: keihou-art-27-4-p1-hashira
    type: hashira
    text: 次に掲げる場合においては、刑の一部の執行猶予の言渡しを取り消さなければならない。ただし、第三号の場合において、猶予の言渡しを受けた者が第二十七条の二第一項第三号に掲げる者であるときは、この限りでない。
    modality: jogai
