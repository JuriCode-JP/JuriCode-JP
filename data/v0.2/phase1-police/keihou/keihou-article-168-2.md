...
article_number: 168-2
article_id: keihou-art-168-2
...
- number: 1
  ...
  segments:
  - id: keihou-art-168-2-p1-hashira
    type: hashira
    text: 正当な理由がないのに、人の電子計算機における実行の用に供する目的で、次に掲げる電磁的記録その他の記録を作成し、又は提供した者は、三年以下の拘禁刑又は五十万円以下の罰金に処する。
    modality: gimu_kei
...
parent_section:
  ...
  hen_name_ja: 第二編　罪
  shou: 192
  shou_name_ja: 第十九章の二　不正指令電磁的記録に関する罪
---

# 刑法 第168-2条(（不正指令電磁的記録作成等）)
