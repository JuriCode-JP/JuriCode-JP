...
- number: 1
  ...
  segments:
  - id: keihou-art-48-p1-honbun
    type: honbun
    text: 罰金と他の刑とは、併科する。
    modality: unspecified
  - id: keihou-art-48-p1-tadashi
    type: tadashi
    text: ただし、第四十六条第一項の場合は、この限りでない。
    modality: jogai
- number: 2
  has_proviso: false
  has_items: false
  ...
  - id: keihou-art-48-p2
    type: simple
    text: 併合罪のうちの二個以上の罪について罰金に処するときは、それぞれの罪について定めた罰金の多額の合計以下で処断する。
    modality: unspecified
cases: []
amendments: []
tags:
