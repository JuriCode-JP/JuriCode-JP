...
- number: 1
  ...
  segments:
  - id: keihou-art-154-p1
    type: simple
    text: 行使の目的で、御璽、国璽若しくは御名を使用して詔書その他の文書を偽造し、又は偽造した御璽、国璽若しくは御名を使用して詔書その他の文書を偽造した者は、無期又は三年以上の拘禁刑に処する。
    modality: gimu_kei
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: keihou-art-154-p2
    type: simple
    text: 御璽若しくは国璽を押し又は御名を署した詔書その他の文書を変造した者も、前項と同様とする。
    modality: gimu
    references:
    - 前項
cases: []
