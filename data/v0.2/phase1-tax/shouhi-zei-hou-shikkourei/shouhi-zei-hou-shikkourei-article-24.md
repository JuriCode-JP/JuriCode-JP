...
- number: 1
  ...
  segments:
  - id: shouhi-zei-hou-shikkourei-art-24-p1-hashira
    type: hashira
    text: 法第十二条第三項に規定する政令で定める特殊な関係にある者は、次に掲げる者（その者が同項の新設分割子法人で自己の株式又は出資を有する場合の当該新設分割子法人を除く。）とする。
    modality: gimu
    references:
    - 同項
  - id: shouhi-zei-hou-shikkourei-art-24-p1-kou-1
    type: kou
    text: '一　法第十二条第一項に規定する新設分割親法人（以下この条において「新設分割親法人」という。）の株主等（株主又は合名会社、合資会社若しくは合同会社の社員その他法人の出資者をいい、当該新設分割親法人が自己の株式又は出資を有する場合の当該新設分割親法人を除く。以下この項において同じ。）の一人（個人である株主等に限るものとし、次に掲げる者を含むものとする。以下この号において同じ。）が新設分割親法人を支配している場合における当該株主等の一人
    ...
    item_number: 1
  - id: shouhi-zei-hou-shikkourei-art-24-p1-kou-2
    type: kou
    text: '二　新設分割親法人の株主等の一人（個人である株主等については、その者と前号イからホまでに規定する関係のある個人を含む。以下この号において同じ。）及び次に掲げる会社が新設分割親法人を支配している場合における当該株主等の一人及び次に掲げる会社
    ...
    modality: unspecified
    item_number: 2
  - id: shouhi-zei-hou-shikkourei-art-24-p1-kou-3
    type: kou
    text: 三　新設分割親法人の二以上の株主等（同一の個人又は法人と前号イからハまでに規定する関係のある会社に限る。）及びそれぞれこれらの株主等と同号イからハまでに規定する関係のある会社が新設分割親法人を支配している場合における当該二以上の株主等及び当該関係のある会社
    modality: unspecified
    item_number: 3
  - id: shouhi-zei-hou-shikkourei-art-24-p1-kou-4
    type: kou
    text: '四　次に掲げる会社
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikkourei-art-24-p2-hashira
    type: hashira
    text: 前項第一号から第三号までに規定する新設分割親法人を支配している場合とは、次に掲げる場合のいずれかに該当する場合をいう。
    modality: teigi
    references:
    - 前項
  - id: shouhi-zei-hou-shikkourei-art-24-p2-kou-1
    type: kou
    text: 一　新設分割親法人の発行済株式又は出資（その有する自己の株式又は出資を除く。）の総数又は総額の百分の五十を超える数又は金額の株式又は出資を有する場合
    modality: unspecified
    item_number: 1
  - id: shouhi-zei-hou-shikkourei-art-24-p2-kou-2
    type: kou
    text: '二　新設分割親法人の次に掲げる議決権のいずれかにつき、その総数（当該議決権を行使することができない株主等（株主又は合名会社、合資会社若しくは合同会社の社員その他法人の出資者をいう。次号並びに第四項及び第五項において同じ。）が有する当該議決権の数を除く。）の百分の五十を超える数を有する場合
    ...
    modality: unspecified
    item_number: 2
  - id: shouhi-zei-hou-shikkourei-art-24-p2-kou-3
    type: kou
    text: 三　新設分割親法人の株主等（合名会社、合資会社又は合同会社の社員（当該新設分割親法人が業務を執行する社員を定めた場合にあつては、業務を執行する社員）に限る。）の総数の半数を超える数を占める場合
    modality: unspecified
    item_number: 3
- number: 3
  has_proviso: false
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikkourei-art-24-p3
    type: simple
    text: 第一項第二号及び第四号に規定する他の会社を支配している場合とは、前項各号の規定中「新設分割親法人」とあるのを「他の会社」と読み替えた場合に同項各号に掲げる場合のいずれかに該当する場合をいう。
    modality: teigi
    references:
    - 前項
    - 同項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikkourei-art-24-p4
    type: simple
    text: 法第十二条第三項に規定する政令で定める場合は、同項の新設分割子法人の第二項第二号イからニまでに掲げる議決権のいずれかにつきその総数（当該議決権を行使することができない株主等が有する当該議決権の数を除く。）の百分の五十を超える数を新設分割親法人等（同条第三項の新設分割親法人及び当該新設分割親法人と同項に規定する政令で定める特殊な関係にある者をいう。以下この項において同じ。）が有する場合又は同条第三項の新設分割子法人の株主等（合名会社、合資会社又は合同会社の社員（当該新設分割子法人が業務を執行する社員を定めた場合にあつては、業務を執行する社員）に限る。）の総数の半数を超える数を新設分割親法人等が占める場合とする。
    modality: gimu
    references:
    - 同項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikkourei-art-24-p5
    type: simple
    text: 個人又は法人との間で当該個人又は法人の意思と同一の内容の議決権を行使することに同意している者がある場合には、当該者が有する議決権は当該個人又は法人が有するものとみなし、かつ、当該個人又は法人（当該議決権に係る会社の株主等であるものを除く。）は当該議決権に係る会社の株主等であるものとみなして、第二項から前項までの規定を適用する。
    modality: unspecified
    references:
    - 前項
cases: []
