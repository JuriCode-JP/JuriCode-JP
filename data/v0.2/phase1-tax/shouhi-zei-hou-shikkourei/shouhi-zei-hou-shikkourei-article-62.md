...
article_number: '62'
article_id: shouhi-zei-hou-shikkourei-art-62
...
- number: 1
  ...
  segments:
  - id: shouhi-zei-hou-shikkourei-art-62-p1-hashira
    type: hashira
    text: 法第四十五条第五項に規定する政令で定める金額は、次の各号に掲げる課税資産の譲渡等（特定資産の譲渡等に該当するものを除く。以下この項、第六十五条第一号及び第六十八条において同じ。）の区分に応じ当該各号に定める金額とし、法第四十五条第五項に規定する政令で定めるところにより計算した金額は、当該各号に定める金額の合計額に百分の七十八を乗じて算出した金額とする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikkourei-art-62-p2
    type: simple
    text: 法第四十五条第五項ただし書に規定する政令で定める規定は、法第二十八条第一項ただし書の規定とする。
    modality: gimu
cases: []
amendments: []
tags:
