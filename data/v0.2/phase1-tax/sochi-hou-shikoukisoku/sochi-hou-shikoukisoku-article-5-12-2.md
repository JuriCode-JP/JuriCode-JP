...
- number: 1
  ...
  - id: sochi-hou-shikoukisoku-art-5-12-2-p1-kou-1
    type: kou
    text: '法第十条の五の五第一項の規定の適用を受ける場合　同条第五項に規定する明細書及び次に掲げる同条第一項に規定する特定認定の区分に応じそれぞれ次に定める書類
  ...
  - id: sochi-hou-shikoukisoku-art-5-12-2-p1-kou-2
    type: kou
    text: 法第十条の五の五第二項の規定の適用を受ける場合　同条第五項に規定する明細書
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
