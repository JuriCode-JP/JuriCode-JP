...
article_number: 5-14
article_id: sochi-hou-shikoukisoku-art-5-14
...
- number: 1
  ...
  segments:
  - id: sochi-hou-shikoukisoku-art-5-14-p1
    type: simple
    text: 施行令第六条の四第五項に規定する財務省令で定める書類は、システム仕様書その他の書類とする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 租税特別措置法施行規則 第5-14条(（医療用機器等の特別償却）)
