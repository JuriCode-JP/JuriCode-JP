...
article_number: 37-4-2
article_id: sochi-hou-shikoukisoku-art-37-4-2
...
- number: 1
  ...
  segments:
  - id: sochi-hou-shikoukisoku-art-37-4-2-p1-hashira
    type: hashira
    text: 法第八十七条第七項に規定する財務省令で定める事項は、次に定める事項とする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-shikoukisoku-art-37-4-2-p2
    type: simple
    text: 前項第八号に掲げる事項については、国税庁長官、国税局長又は税務署長に当該事項を記載した書面を提出し、又は当該事項を記録した電磁的記録（施行令第四十六条の八の二第五項に規定する電磁的記録をいう。第三十七条の四の四第五項において同じ。）を提供している場合には、その旨を記載することにより、当該事項の記載を省略することができる。
...
# 租税特別措置法施行規則 第37-4-2条(（実績報告書の記載事項等）)
...
三　対象年度（法第八十七条第七項に規定する対象年度をいう。以下この項において同じ。）

四　法第八十七条第三項第一号又は第二号のいずれにも該当しない旨
