...
article_number: '39'
article_id: houjin-zei-hou-art-39
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-art-39-p1-hashira
    type: hashira
    text: 内国法人が次に掲げる国税又は地方税を納付し、又は納入したことにより生じた損失の額（その納付又は納入に係る求償権につき生じた損失の額を含む。次項において同じ。）は、その内国法人の各事業年度の所得の金額の計算上、損金の額に算入しない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-39-p2-hashira
    type: hashira
