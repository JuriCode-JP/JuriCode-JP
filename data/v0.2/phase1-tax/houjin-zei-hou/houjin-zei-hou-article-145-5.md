...
article_id: houjin-zei-hou-art-145-5
...
- effective_date: '2024-04-01'
  ...
  description: 本条を改正（「（申告及び納付）」→（削除）ほか）
