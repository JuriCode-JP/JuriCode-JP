...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-64-13-p2
    type: simple
    text: 前項の規定により同項に規定する評価益の額又は評価損の額を益金の額又は損金の額に算入された資産の帳簿価額その他同項の規定の適用に関し必要な事項は、政令で定める。
    modality: unspecified
    references:
    - 前項
    - 同項
