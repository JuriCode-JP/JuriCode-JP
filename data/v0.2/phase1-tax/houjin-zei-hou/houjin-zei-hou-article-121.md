...
article_number: '121'
article_id: houjin-zei-hou-art-121
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-art-121-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-121-p2-hashira
    type: hashira
    text: 前項の承認を受けている内国法人は、次に掲げる申告書及びこれらの申告書に係る修正申告書について、青色の申告書により提出することができる。
    modality: kanou_kenri
    references:
    - 前項
