...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-64-6-p2
    type: simple
    text: 前項に規定する特定資産譲渡等損失額とは、第一号に掲げる金額から第二号に掲げる金額を控除した金額をいう。
    modality: teigi
    references:
    - 前項
  - id: houjin-zei-hou-art-64-6-p2-kou-1
    type: kou
    ...
    item_number: 1
  - id: houjin-zei-hou-art-64-6-p2-kou-2
    type: kou
