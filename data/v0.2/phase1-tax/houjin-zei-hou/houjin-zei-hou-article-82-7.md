...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-82-7-p2-hashira
    type: hashira
    text: 前項に規定する特定法人とは、次に掲げる法人をいう。
    modality: teigi
    references:
    - 前項
  - id: houjin-zei-hou-art-82-7-p2-kou-1
    type: kou
    text: 一　当該対象会計年度開始の時における資本金の額又は出資金の額が一億円を超える法人
    modality: unspecified
    item_number: 1
  - id: houjin-zei-hou-art-82-7-p2-kou-2
    type: kou
    text: 二　保険業法に規定する相互会社
    modality: unspecified
    item_number: 2
  - id: houjin-zei-hou-art-82-7-p2-kou-3
    type: kou
    text: 三　投資法人（第一号に掲げる法人を除く。）
    modality: unspecified
    item_number: 3
  - id: houjin-zei-hou-art-82-7-p2-kou-4
    type: kou
