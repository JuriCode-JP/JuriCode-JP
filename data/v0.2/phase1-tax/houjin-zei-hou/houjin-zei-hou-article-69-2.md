...
article_number: 69-2
article_id: houjin-zei-hou-art-69-2
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-69-2-p2
    type: simple
    text: 前項の規定は、内国法人である公益法人等又は人格のない社団等の収益事業以外の事業又はこれに属する資産から生ずる所得に係る分配時調整外国税相当額については、適用しない。
    modality: jogai
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-69-2-p3-zen
    type: zen_dan
    text: 第一項の規定は、確定申告書、修正申告書又は更正請求書に同項の規定による控除の対象となる分配時調整外国税相当額、控除を受ける金額及び当該金額の計算に関する明細を記載した書類の添付がある場合に限り、適用する。
    modality: unspecified
    references:
    - 同項
  - id: houjin-zei-hou-art-69-2-p3-kou
    type: kou_dan
    text: この場合において、同項の規定により控除される金額は、当該書類に当該分配時調整外国税相当額として記載された金額を限度とする。
    modality: gimu
    references:
    - 同項
    depends_on: houjin-zei-hou-art-69-2-p3-zen
- number: 4
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-art-69-2-p4
    type: simple
