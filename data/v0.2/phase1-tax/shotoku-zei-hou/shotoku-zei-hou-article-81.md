...
article_number: '81'
article_id: shotoku-zei-hou-art-81
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-art-81-p1
    type: simple
    text: 居住者がひとり親である場合には、その者のその年分の総所得金額、退職所得金額又は山林所得金額から三十五万円を控除する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-art-81-p2
    type: simple
    text: 前項の規定による控除は、ひとり親控除という。
    modality: teigi
    references:
    - 前項
cases: []
...
- effective_date: '2020-04-01'
  ...
  description: 本条を改正（「寡婦（寡夫）」→「ひとり親」ほか）
tags:
- phase1-tax
- auto-generated
parent_section:
