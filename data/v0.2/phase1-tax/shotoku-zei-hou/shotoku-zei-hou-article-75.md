...
article_number: '75'
article_id: shotoku-zei-hou-art-75
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-art-75-p1
    type: simple
    text: 居住者が、各年において、小規模企業共済等掛金を支払つた場合には、その支払つた金額を、その者のその年分の総所得金額、退職所得金額又は山林所得金額から控除する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-art-75-p2-hashira
    type: hashira
    text: 前項に規定する小規模企業共済等掛金とは、次に掲げる掛金をいう。
    modality: teigi
    references:
    - 前項
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-art-75-p3
    type: simple
    text: 第一項の規定による控除は、小規模企業共済等掛金控除という。
    modality: teigi
cases: []
amendments: []
tags:
