...
article_number: '146'
article_id: shotoku-zei-hou-art-146
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-art-146-p1
    type: simple
    text: 税務署長は、第百四十四条（青色申告の承認の申請）の申請書の提出があつた場合において、その申請につき承認又は却下の処分をするときは、その申請をした居住者に対し、書面によりその旨を通知する。
    modality: tetsuduki
cases: []
amendments: []
tags:
...
<!-- segment: simple id: shotoku-zei-hou-art-146-p1 -->
