...
article_number: 165-5-2
article_id: shotoku-zei-hou-art-165-5-2
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-art-165-5-2-p2
    type: simple
...
# 所得税法 第165-5-2条(（特定の内部取引に係る恒久的施設帰属所得に係る所得の金額の計算）)
