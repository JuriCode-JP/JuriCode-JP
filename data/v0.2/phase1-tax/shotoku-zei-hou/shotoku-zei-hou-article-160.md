...
- number: 3
  ...
  - id: shotoku-zei-hou-art-160-p3-hashira
    ...
    modality: unspecified
  - id: shotoku-zei-hou-art-160-p3-kou-1
    type: kou
    text: '一　第一項の更正等の日の翌日以後一月を経過する日（当該更正等が次に掲げるものである場合には、それぞれ次に定める日）
    ...
    modality: unspecified
    item_number: 1
  - id: shotoku-zei-hou-art-160-p3-kou-2
    type: kou
    text: 二　その還付のための支払決定をする日又はその還付金に係る充当日
    modality: unspecified
    item_number: 2
- number: 4
  has_proviso: false
