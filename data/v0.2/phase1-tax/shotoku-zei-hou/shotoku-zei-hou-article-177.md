...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-art-177-p2
    type: simple
    text: 第七条第一項第四号、第百七十四条及び第百七十五条の規定は、内国法人（当該内国法人が他の内国法人（一般社団法人等を除く。）の発行済株式又は出資（当該他の内国法人が有する自己の株式等を除く。）の総数又は総額の三分の一を超える数又は金額の株式等を有する場合として政令で定める場合における当該内国法人に限る。）が支払を受ける当該他の内国法人の株式等（前項に規定する完全子法人株式等に該当する株式等を除く。）に係る第二十四条第一項に規定する配当等については、適用しない。
    modality: jogai
    references:
    - 前項
cases: []
...
- effective_date: '2023-10-01'
  ...
  description: 本条を改正（（追加）→「（完全子法人株式等に係る配当等の課税の特例）」ほか）
- effective_date: '2023-10-01'
  law_num: 令和四年法律第七十一号
...
<!-- segment: simple id: shotoku-zei-hou-art-177-p1 -->
...
<!-- segment: simple id: shotoku-zei-hou-art-177-p2 -->
