...
- number: 1
  ...
  - id: houjin-zei-hou-shikkourei-art-32-p1-hashira
    ...
    modality: gimu
  - id: houjin-zei-hou-shikkourei-art-32-p1-kou-1
    type: kou
    text: '一　購入した棚卸資産（法第六十一条の五第三項（デリバティブ取引に係る利益相当額又は損失相当額の益金又は損金算入等）の規定の適用があるものを除く。）　次に掲げる金額の合計額
    ...
    item_number: 1
  - id: houjin-zei-hou-shikkourei-art-32-p1-kou-2
    type: kou
    text: '二　自己の製造、採掘、採取、栽培、養殖その他これらに準ずる行為（以下この項及び次項において「製造等」という。）に係る棚卸資産　次に掲げる金額の合計額
    ...
    modality: unspecified
    item_number: 2
  - id: houjin-zei-hou-shikkourei-art-32-p1-kou-3
    type: kou
    text: '三　前二号に規定する方法以外の方法により取得（適格分社型分割、適格現物出資又は適格現物分配による分割法人、現物出資法人又は現物分配法人からの取得を除く。以下この号において同じ。）をした棚卸資産　次に掲げる金額の合計額
