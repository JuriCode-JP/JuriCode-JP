...
- number: 1
  ...
  - id: houjin-zei-hou-shikkourei-art-71-p1-kou-1
    type: kou
    text: 代表取締役、代表執行役、代表理事及び清算人
    modality: unspecified
    item_number: 1
  - id: houjin-zei-hou-shikkourei-art-71-p1-kou-2
    type: kou
    text: 副社長、専務、常務その他これらに準ずる職制上の地位を有する役員
    modality: unspecified
    item_number: 2
  - id: houjin-zei-hou-shikkourei-art-71-p1-kou-3
    type: kou
    text: 合名会社、合資会社及び合同会社の業務を執行する社員
    modality: unspecified
    item_number: 3
  - id: houjin-zei-hou-shikkourei-art-71-p1-kou-4
    type: kou
    text: 取締役（指名委員会等設置会社の取締役及び監査等委員である取締役に限る。）、会計参与及び監査役並びに監事
    modality: unspecified
    item_number: 4
  - id: houjin-zei-hou-shikkourei-art-71-p1-kou-5
    type: kou
    text: '前各号に掲げるもののほか、同族会社の役員のうち次に掲げる要件の全てを満たしている者
