...
article_number: '53'
article_id: houjin-zei-hou-shikkourei-art-53
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-shikkourei-art-53-p1-hashira
    type: hashira
    text: 法第三十一条第一項（減価償却資産の償却費の計算及びその償却の方法）に規定する償却の方法を選定しなかつた場合における政令で定める方法は、次の各号に掲げる資産の区分に応じ当該各号に定める方法とする。
    modality: gimu
  - id: houjin-zei-hou-shikkourei-art-53-p1-kou-1
    type: kou
    text: '一　平成十九年三月三十一日以前に取得をされた減価償却資産　次に掲げる資産の区分に応じそれぞれ次に定める方法
    ...
    item_number: 1
  - id: houjin-zei-hou-shikkourei-art-53-p1-kou-2
    type: kou
    text: '二　平成十九年四月一日以後に取得をされた減価償却資産　次に掲げる資産の区分に応じそれぞれ次に定める方法
