...
article_number: '75'
article_id: houjin-zei-hou-shikkourei-art-75
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-shikkourei-art-75-p1
    type: simple
    text: 法第三十七条第三項第二号（指定寄附金の損金算入）に規定する政令で定める寄附金は、同号に規定する法人の設立に関する許可又は認可があることが確実であると認められる場合においてされる寄附金とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: houjin-zei-hou-shikkourei-art-75-p1 -->
