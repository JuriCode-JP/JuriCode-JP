...
article_number: '38'
article_id: shotoku-zei-hou-shikoukisoku-art-38
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-38-p1-hashira
    type: hashira
    text: 法第六十四条第三項（資産の譲渡代金が回収不能となつた場合等の所得計算の特例）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
