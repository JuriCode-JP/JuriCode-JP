...
article_number: 66-4
article_id: shotoku-zei-hou-shikoukisoku-art-66-4
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-66-4-p1
    type: simple
    text: 令第二百九十二条の三第二項第二号イ（恒久的施設に帰せられるべき純資産に対応する負債の利子の必要経費不算入）に規定する財務省令で定める場合は、第一号に掲げる割合が第二号に掲げる割合のおおむね二分の一に満たない場合とする。
    modality: gimu
  - id: shotoku-zei-hou-shikoukisoku-art-66-4-p1-kou-1
    type: kou
    ...
    item_number: 1
  - id: shotoku-zei-hou-shikoukisoku-art-66-4-p1-kou-2
    type: kou
    text: 二　令第二百九十二条の三第二項第二号に規定する非居住者の恒久的施設を通じて行う主たる事業と同種の事業を国内において行う個人の平均的な純資産の額の平均的な総資産の額に対する割合
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-66-4-p2
    type: simple
...
# 所得税法施行規則 第66-4条(（同業個人比準法を用いた恒久的施設帰属資本相当額の計算）)
