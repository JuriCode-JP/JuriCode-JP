...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-36-7-p2
    type: simple
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-36-7-p3-hashira
    type: hashira
    text: 令第百六十七条の六第一項に規定する帳簿書類その他の財務省令で定める書類は、次の各号に掲げる者の区分に応じ当該各号に定める書類とする。
    modality: gimu
