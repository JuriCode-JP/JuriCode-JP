...
article_number: 25-2
article_id: shotoku-zei-hou-shikoukisoku-art-25-2
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-25-2-p1-hashira
    type: hashira
    text: 令第百二十一条の二第二項（リース賃貸資産の償却の方法の特例）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
  - id: shotoku-zei-hou-shikoukisoku-art-25-2-p1-kou-1
    type: kou
    text: 一　令第百二十一条の二第二項に規定する届出書を提出をする者の氏名及び住所
    modality: unspecified
    item_number: 1
  - id: shotoku-zei-hou-shikoukisoku-art-25-2-p1-kou-2
    type: kou
    text: 二　令第百二十一条の二第一項に規定する旧リース期間定額法を採用しようとする資産の種類（同条第二項に規定する資産の種類をいう。）ごとの同条第三項に規定する改定取得価額の合計額
    modality: unspecified
    item_number: 2
...
# 所得税法施行規則 第25-2条(（旧リース期間定額法を採用する場合の届出書の記載事項）)
