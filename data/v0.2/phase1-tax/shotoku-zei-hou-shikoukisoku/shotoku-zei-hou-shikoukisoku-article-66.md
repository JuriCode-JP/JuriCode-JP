...
article_number: '66'
article_id: shotoku-zei-hou-shikoukisoku-art-66
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-66-p1-hashira
    type: hashira
    text: 法第百五十一条第一項（青色申告の取りやめ等）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
...
# 所得税法施行規則 第66条(（青色申告をやめようとする場合の届出）)
