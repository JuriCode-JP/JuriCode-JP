...
article_number: '20'
article_id: shotoku-zei-hou-shikoukisoku-art-20
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-20-p1-hashira
    type: hashira
    text: 法第四十二条第三項（国庫補助金等の総収入金額不算入）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
