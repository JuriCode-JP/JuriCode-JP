...
article_number: 21-2
article_id: shotoku-zei-hou-shikoukisoku-art-21-2
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-21-2-p1-hashira
    type: hashira
...
parent_section:
  ...
  setsu: 2
  setsu_name_ja: 第二節　収入金額の計算
---

# 所得税法施行規則 第21-2条(（免責許可の決定等により債務免除を受けた場合の経済的利益の総収入金額不算入の特例の適用を受けるための記載事項）)
