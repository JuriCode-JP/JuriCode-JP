...
article_number: '50'
article_id: shotoku-zei-hou-shikoukisoku-art-50
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-50-p1-hashira
    type: hashira
    text: 法第百三十一条第二項（確定申告税額の延納）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
