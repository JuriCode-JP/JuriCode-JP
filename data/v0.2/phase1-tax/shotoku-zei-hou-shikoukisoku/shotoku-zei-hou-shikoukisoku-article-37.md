...
article_number: '37'
article_id: shotoku-zei-hou-shikoukisoku-art-37
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-37-p1-hashira
    type: hashira
    text: 法第五十八条第三項（固定資産の交換の場合の譲渡所得の特例）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
...
# 所得税法施行規則 第37条(（固定資産の交換の場合の譲渡所得の特例の適用を受けるための記載事項）)
