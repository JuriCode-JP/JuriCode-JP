...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikoukisoku-art-2-p2
    type: simple
    text: 金融機関の営業所等の長は、前項の書類の提出を受けた場合には、遅滞なく、その書類に係る預貯金等に関する通帳、証書、受益証券その他の書類に、その預貯金等が法第九条第一項第二号の規定に該当するものである旨を表示しなければならない。
    modality: gimu
    references:
    - 前項
cases: []
