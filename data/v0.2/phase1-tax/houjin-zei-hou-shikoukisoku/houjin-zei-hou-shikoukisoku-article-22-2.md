...
article_number: 22-2
article_id: houjin-zei-hou-shikoukisoku-art-22-2
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-22-2-p1-hashira
    type: hashira
    text: 法第三十三条第七項（資産の評価損の損金算入に関する書類）に規定する財務省令で定める書類は、次の各号に掲げる事実の区分に応じ当該各号に定める書類とする。
    modality: gimu
...
parent_section:
  ...
  kan: 32
  kan_name_ja: 第三款の二　資産の評価損
---

# 法人税法施行規則 第22-2条(（資産の評価損の損金算入に関する書類）)
