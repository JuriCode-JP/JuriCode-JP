...
article_number: 28-10
article_id: houjin-zei-hou-shikoukisoku-art-28-10
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-28-10-p2
    type: simple
    text: 前項の規定の適用がある場合における令第百四十一条の四第四項及び第五項の規定の適用については、これらの規定に規定する危険勘案資産額には、前項各号に掲げる金額を含むものとする。
    modality: gimu
    references:
    - 前項
cases: []
...
# 法人税法施行規則 第28-10条(（危険勘案資産額の計算に関する特例）)
