...
article_number: '40'
article_id: houjin-zei-hou-shikoukisoku-art-40
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-40-p1-hashira
    type: hashira
    text: 法第八十八条第三号（退職年金等積立金に係る中間申告）に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
  - id: houjin-zei-hou-shikoukisoku-art-40-p1-kou-1
    type: kou
    text: 一　内国法人の名称、納税地及び法人番号並びにその納税地と本店又は主たる事務所の所在地とが異なる場合には、その本店又は主たる事務所の所在地
    modality: unspecified
    item_number: 1
  - id: houjin-zei-hou-shikoukisoku-art-40-p1-kou-2
    type: kou
    text: 二　代表者の氏名
    modality: unspecified
    item_number: 2
  - id: houjin-zei-hou-shikoukisoku-art-40-p1-kou-3
    type: kou
    text: 三　当該事業年度の開始及び終了の日
    modality: unspecified
    item_number: 3
  - id: houjin-zei-hou-shikoukisoku-art-40-p1-kou-4
    type: kou
    text: 四　その他参考となるべき事項
    modality: unspecified
    item_number: 4
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-40-p2
    type: simple
    text: 退職年金等積立金中間申告書（当該申告書に係る修正申告書を含む。）の記載事項のうち別表二十三に定めるものの記載については、同表の書式によらなければならない。
    modality: gimu
cases: []
amendments: []
tags:
