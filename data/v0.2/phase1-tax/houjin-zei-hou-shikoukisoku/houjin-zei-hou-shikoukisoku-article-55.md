...
article_number: '55'
article_id: houjin-zei-hou-shikoukisoku-art-55
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-55-p1
    type: simple
    text: 青色申告法人は、仕訳帳には、取引の発生順に、取引の年月日、内容、勘定科目及び金額を記載しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-55-p2
    type: simple
    text: 青色申告法人は、総勘定元帳には、その勘定ごとに記載の年月日、相手方勘定科目及び金額を記載しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
