...
article_number: 60-10
article_id: houjin-zei-hou-shikoukisoku-art-60-10
...
- number: 1
  ...
  segments:
  - id: houjin-zei-hou-shikoukisoku-art-60-10-p1-hashira
    type: hashira
    text: 法第百四十二条の七第一項（本店配賦経費に関する書類の保存がない場合における本店配賦経費の損金不算入）に規定する財務省令で定める書類は、次に掲げる書類とする。
    modality: gimu
