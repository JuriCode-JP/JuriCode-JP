...
article_number: '395'
article_id: chihou-zei-hou-art-395
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-art-395-p1
    type: simple
    text: 前条の規定により申告すべき事項について申告をせず、又は虚偽の申告をしたときは、その違反行為をした者は、一年以下の拘禁刑又は五十万円以下の罰金に処する。
    modality: gimu_kei
    references:
    - 前条
- number: 2
...
# 地方税法 第395条(（道府県知事又は総務大臣が評価する固定資産に係る申告の義務違反に関する罪）)

## 原文 (日本語)

### 第三百九十五条第一項

<!-- segment: simple id: chihou-zei-hou-art-395-p1 -->
前条の規定により申告すべき事項について申告をせず、又は虚偽の申告をしたときは、その違反行為をした者は、一年以下の拘禁刑又は五十万円以下の罰金に処する。

### 第三百九十五条第二項

<!-- segment: simple id: chihou-zei-hou-art-395-p2 -->
