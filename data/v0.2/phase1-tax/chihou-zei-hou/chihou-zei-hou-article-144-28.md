...
article_number: 144-28
article_id: chihou-zei-hou-art-144-28
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-art-144-28-p1
    type: simple
    text: 前条第一項の規定に違反して報告書を提出せず、又は虚偽の記載をした報告書を提出したときは、その違反行為をした者は、一年以下の拘禁刑又は五十万円以下の罰金に処する。
    modality: gimu_kei
    references:
    - 前条
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-144-28-p2
    type: simple
...
# 地方税法 第144-28条(（免税軽油の引取り等に係る報告義務に関する罪）)
