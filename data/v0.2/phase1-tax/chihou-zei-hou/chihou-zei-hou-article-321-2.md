...
- number: 4
  ...
  - id: chihou-zei-hou-art-321-2-p4-kou-1
    type: kou
    text: 第三百二十条の各納期限の翌日から当該減額更正に基因して変更した税額に係る納税通知書が発せられた日までの期間
    modality: unspecified
    item_number: 1
  - id: chihou-zei-hou-art-321-2-p4-kou-2
    type: kou
    text: 当該減額更正に基因して変更した税額に係る納税通知書が発せられた日（当該減額更正が更正の請求に基づくものである場合には、同日の翌日から起算して一年を経過する日）の翌日から増額更正に基因して変更した税額に係る納税通知書が発せられた日までの期間
    modality: unspecified
    item_number: 2
- number: 5
  has_proviso: false
