...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-17-2-p3
    type: simple
    text: 前二項の場合において、その地方団体の徴収金のうちに延滞金があるときは、その過誤納金は、まず延滞金の額の計算の基礎となる地方税に充当しなければならない。
    modality: gimu
    references:
    - 前二項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-17-2-p4
    type: simple
    text: 前三項の規定による充当は、政令で定める充当をするに適することとなつた時にさかのぼつてその効力を生ずる。
...
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-17-2-p5
    type: simple
    text: 地方団体の長は、第一項から第三項までの規定による充当をしたときは、その旨を納税者又は特別徴収義務者に通知しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
