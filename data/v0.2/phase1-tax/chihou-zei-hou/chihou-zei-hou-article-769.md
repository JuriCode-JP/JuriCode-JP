...
article_number: '769'
article_id: chihou-zei-hou-art-769
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-art-769-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-769-p2
    type: simple
    text: 代表者会議は、機構の業務の適正な運営を確保するため必要があると認めるときは、理事長に対し、機構の業務並びに資産及び債務の状況に関し報告をさせることができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-769-p3
    type: simple
    text: 代表者会議は、役員又は職員の行為がこの法律、他の法令又は定款に違反し、又は違反するおそれがあると認めるときは、理事長に対し、当該行為の是正のため必要な措置を講ずることを命ずることができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
