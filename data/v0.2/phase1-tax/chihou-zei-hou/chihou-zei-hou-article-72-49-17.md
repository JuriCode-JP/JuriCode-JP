...
article_number: 72-49-17
article_id: chihou-zei-hou-art-72-49-17
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-art-72-49-17-p1-hashira
    type: hashira
    text: 個人の行う事業に対する事業税の額は、次の各号に掲げる区分に応じ、それぞれ当該各号に定める金額とする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-72-49-17-p2
    type: simple
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-72-49-17-p3
    type: simple
    text: 道府県は、第一項に規定する標準税率を超える税率で事業税を課する場合には、同項各号に掲げる区分に応ずる当該各号に定める率に、それぞれ一・一を乗じて得た率を超える税率で課することができない。
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-72-49-17-p4
    type: simple
    text: 道府県が第七十二条の四十九の十五の規定によつて事業税を課する場合における税率は、第一項及び前項の税率による場合における負担と著しく均衡を失することのないようにしなければならない。
    modality: gimu
    references:
    - 前項
cases: []
