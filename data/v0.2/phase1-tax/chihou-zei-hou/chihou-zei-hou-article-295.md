...
article_number: '295'
article_id: chihou-zei-hou-art-295
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-art-295-p1-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-art-295-p3
    type: simple
    text: 市町村は、この法律の施行地に住所を有する者で均等割のみを課すべきもののうち、前年の合計所得金額が政令で定める基準に従い当該市町村の条例で定める金額以下である者に対しては、均等割を課することができない。
