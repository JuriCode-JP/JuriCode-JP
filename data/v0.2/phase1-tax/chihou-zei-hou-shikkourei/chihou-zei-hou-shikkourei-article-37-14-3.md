...
article_id: chihou-zei-hou-shikkourei-art-37-14-3
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-shikkourei-art-37-14-3-p1
    type: simple
    text: 法第七十三条の七第四号の二イに規定する政令で定める事項は、同号に規定する特定目的信託の効力が生じた日から同号イに規定する社債的受益権の元本の償還が完了する日までの期間が二十年以下であることとする。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-shikkourei-art-37-14-3-p2-hashira
    type: hashira
    text: 法第七十三条の七第四号の二ロに規定する政令で定める要件は、同号ロに規定する特定資産について、同号に規定する特定目的信託の効力が生じた時から当該特定目的信託に係る信託契約の終了の時まで引き続き同号に規定する原委託者において、一般に公正妥当と認められる会計の慣行に従い同号に規定する受託信託会社等への譲渡がなかつたものとして会計処理が行われており、かつ、次に掲げる要件のいずれかを満たすものであることとする。
    modality: gimu
...
# 地方税法施行令 第37-14-3条(（法第七十三条の七第四号の二イの事項等）)
