...
article_number: '65'
article_id: souzoku-zei-hou-art-65
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: souzoku-zei-hou-art-65-p2
    type: junyou
    text: 第十二条第二項の規定は、前項に規定する持分の定めのない法人が取得した同条第一項第三号又は第二十一条の三第一項第三号に掲げる財産について第十二条第二項に規定する事由がある場合について準用する。
    modality: unspecified
    references:
    - 前項
- number: 3
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: souzoku-zei-hou-art-65-p4
    type: simple
    text: 第一項の法人から特別の利益を受ける者の範囲、法人から受ける特別の利益の内容その他同項の規定の適用に関し必要な事項は、政令で定める。
    modality: unspecified
    references:
    - 同項
cases: []
