...
article_number: 21-18
article_id: souzoku-zei-hou-art-21-18
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: souzoku-zei-hou-art-21-18-p2-zen
    type: zen_dan
    text: 前項の規定により第二十一条の九第二項の届出書を提出した相続人は、被相続人が有することとなる同条第一項の規定の適用を受けることに伴う納税に係る権利又は義務を承継する。
    modality: unspecified
    references:
    - 前項
  - id: souzoku-zei-hou-art-21-18-p2-kou
    type: kou_dan
    text: この場合において、前条第二項及び第三項の規定を準用する。
    modality: unspecified
    references:
    - 前条
    depends_on: souzoku-zei-hou-art-21-18-p2-zen
- number: 3
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: souzoku-zei-hou-art-21-18-p3
    type: simple
    text: 第一項の規定により第二十一条の九第二項の届出書を提出することができる被相続人の相続人が当該届出書を提出しないで死亡した場合には、前二項の規定を準用する。
    modality: unspecified
    references:
    - 前二項
cases: []
