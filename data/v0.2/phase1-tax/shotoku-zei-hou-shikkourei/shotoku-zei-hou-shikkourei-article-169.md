...
article_number: '169'
article_id: shotoku-zei-hou-shikkourei-art-169
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-169-p1
    type: simple
    text: 法第五十九条第一項第二号（贈与等の場合の譲渡所得等の特例）に規定する政令で定める額は、同項に規定する山林又は譲渡所得の基因となる資産の譲渡の時における価額の二分の一に満たない金額とする。
    modality: gimu
    references:
    - 同項
cases: []
...
<!-- segment: simple id: shotoku-zei-hou-shikkourei-art-169-p1 -->
