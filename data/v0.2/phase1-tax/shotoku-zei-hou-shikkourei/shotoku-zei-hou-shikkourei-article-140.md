...
article_number: '140'
article_id: shotoku-zei-hou-shikkourei-art-140
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-140-p1
    type: simple
    text: 法第五十一条第一項（資産損失の必要経費算入）に規定する政令で定める資産は、不動産所得、事業所得又は山林所得を生ずべき事業に係る繰延資産のうちまだ必要経費に算入されていない部分とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: shotoku-zei-hou-shikkourei-art-140-p1 -->
