...
<!-- segment: simple id: shotoku-zei-hou-shikkourei-art-1-p1 -->
...
<!-- segment: hashira id: shotoku-zei-hou-shikkourei-art-1-p2-hashira -->
この政令において、次の各号に掲げる用語の意義は、当該各号に定めるところによる。

### 第一条第三項

<!-- segment: simple id: shotoku-zei-hou-shikkourei-art-1-p3 -->
