...
article_number: 136-2
article_id: shotoku-zei-hou-shikkourei-art-136-2
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-136-2-p1
    type: simple
    text: 前三目（減価償却資産の償却の方法等）に定めるもののほか、減価償却資産の償却費の計算に関する細目は、財務省令で定める。
...
parent_section:
  ...
  moku: 4
  moku_name_ja: 第四目　減価償却資産の償却費の計算の細目
---
