...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-6-p1-hashira
    type: hashira
    text: 法第二条第一項第十九号（定義）に規定する政令で定める資産は、棚卸資産、有価証券及び繰延資産以外の資産のうち次に掲げるもの（時の経過によりその価値の減少しないものを除く。）とする。
    modality: gimu
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-1
    type: kou
    text: 一　建物及びその附属設備（暖冷房設備、照明設備、通風設備、昇降機その他建物に附属する設備をいう。）
    modality: unspecified
    item_number: 1
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-2
    type: kou
    text: 二　構築物（ドック、橋、岸壁、桟橋、軌道、貯水池、坑道、煙突その他土地に定着する土木設備又は工作物をいう。）
    modality: unspecified
    item_number: 2
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-3
    type: kou
    text: 三　機械及び装置
    modality: unspecified
    item_number: 3
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-4
    type: kou
    text: 四　船舶
    modality: unspecified
    item_number: 4
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-5
    type: kou
    text: 五　航空機
    modality: unspecified
    item_number: 5
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-6
    type: kou
    text: 六　車両及び運搬具
    modality: unspecified
    item_number: 6
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-7
    type: kou
    text: 七　工具、器具及び備品（観賞用、興行用その他これらに準ずる用に供する生物を含む。）
    modality: unspecified
    item_number: 7
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-8
    type: kou
    text: '八　次に掲げる無形固定資産
    ...
    modality: unspecified
    item_number: 8
  - id: shotoku-zei-hou-shikkourei-art-6-p1-kou-9
    type: kou
