...
article_number: 208-5
article_id: shotoku-zei-hou-shikkourei-art-208-5
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-208-5-p1
    type: simple
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikkourei-art-208-5-p2
    type: junyou
    text: 前項の規定は、法第七十六条第二項第一号に規定する政令で定めるところにより計算した金額及び同条第三項第一号イに規定する政令で定めるところにより計算した金額について準用する。
...
# 所得税法施行令 第208-5条(（新生命保険料等の金額から控除する剰余金等の額）)
