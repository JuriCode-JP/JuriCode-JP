...
article_number: '92'
article_id: shotoku-zei-hou-shikkourei-art-92
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-92-p1
    type: simple
    text: 法第四十四条（移転等の支出に充てるための交付金の総収入金額不算入）に規定する政令で定める行為は、第百八十一条（資本的支出）に規定する支出に係る行為とする。
    modality: gimu
cases: []
amendments: []
tags:
