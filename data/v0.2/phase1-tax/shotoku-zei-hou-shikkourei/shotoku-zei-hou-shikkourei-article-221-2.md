...
article_number: 221-2
article_id: shotoku-zei-hou-shikkourei-art-221-2
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-221-2-p1-hashira
    type: hashira
    text: 法第九十五条第一項（外国税額控除）に規定する政令で定める金額は、居住者の各年分の次に掲げる国外源泉所得（同項に規定する国外源泉所得をいう。以下この章において同じ。）に係る所得の金額の合計額（当該合計額が零を下回る場合には、零）とする。
    modality: gimu
    references:
    - 同項
