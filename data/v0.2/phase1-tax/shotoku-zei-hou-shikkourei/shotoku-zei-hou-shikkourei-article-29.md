...
article_number: '29'
article_id: shotoku-zei-hou-shikkourei-art-29
...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-29-p1-hashira
    type: hashira
    text: 法第九条第一項第十五号ロ（非課税所得）に規定する当該使用人と政令で定める特別の関係がある者は、次に掲げる者とする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikkourei-art-29-p2
    type: junyou
    text: 前項の規定は、法第九条第一項第十五号ニに規定する当該使用人と政令で定める特別の関係がある者について準用する。
    modality: unspecified
    references:
    - 前項
cases: []
...
# 所得税法施行令 第29条(（学資に充てるため給付される金品が非課税とされない特別の関係がある者の範囲）)
