...
- number: 1
  ...
  - id: shotoku-zei-hou-shikkourei-art-350-10-p1-kou
    ...
    references:
    - 前条
    depends_on: shotoku-zei-hou-shikkourei-art-350-10-p1-zen
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: shotoku-zei-hou-shikkourei-art-350-10-p2
    type: simple
    text: 金地金等の譲渡の対価の支払者は、前項又は前条第四項の規定による確認をした場合には、財務省令で定めるところにより、これらの規定による確認に関する帳簿（これに類する帳簿又は書類を含む。）に、これらの規定による確認をした旨を明らかにし、かつ、これらの帳簿を保存しなければならない。
    modality: gimu
    references:
    - 前条
    - 前項
