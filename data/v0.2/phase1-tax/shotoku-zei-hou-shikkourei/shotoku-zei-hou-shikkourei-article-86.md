...
- number: 1
  ...
  segments:
  - id: shotoku-zei-hou-shikkourei-art-86-p1
    type: simple
    text: 法第三十九条（たな卸資産等の自家消費の場合の総収入金額算入）に規定する政令で定めるものは、第八十一条各号（譲渡所得の基因とされないたな卸資産に準ずる資産）に掲げる資産（山林を除く。）とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: shotoku-zei-hou-shikkourei-art-86-p1 -->
