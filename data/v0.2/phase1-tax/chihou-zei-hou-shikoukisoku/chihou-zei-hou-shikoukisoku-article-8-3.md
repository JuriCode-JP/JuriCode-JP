...
article_number: 8-3
article_id: chihou-zei-hou-shikoukisoku-art-8-3
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-shikoukisoku-art-8-3-p1
    type: simple
    text: 政令第三十九条の十に規定する総務省令で定める船舶は、東経百十八度及び東経百五十九度の線並びに北緯二十度及び北緯四十五度の線で囲まれた海域を除く海域において行う漁業の許可及び取締り等に関する省令（昭和三十八年農林省令第五号）第二条第九号に規定する母船式捕鯨業に従事する母船、独航船、運搬船及び補給船とする。
    modality: gimu
cases: []
amendments: []
tags:
