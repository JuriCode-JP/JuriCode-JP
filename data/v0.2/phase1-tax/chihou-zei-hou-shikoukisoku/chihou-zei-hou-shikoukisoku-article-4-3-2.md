...
article_number: 4-3-2
article_id: chihou-zei-hou-shikoukisoku-art-4-3-2
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-shikoukisoku-art-4-3-2-p1-hashira
    type: hashira
    text: 政令第二十四条の二の五第三号に規定する総務省令で定めるものは、次に掲げるものとする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-zei-hou-shikoukisoku-art-4-3-2-p2-hashira
    type: hashira
    text: 法第七十二条の二十四の十第六項に規定する総務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
...
# 地方税法施行規則 第4-3-2条(（法令の規定による整理手続によらない負債整理計画の決定等）)
