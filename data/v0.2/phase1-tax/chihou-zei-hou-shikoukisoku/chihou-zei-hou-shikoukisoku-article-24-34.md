...
article_number: 24-34
article_id: chihou-zei-hou-shikoukisoku-art-24-34
...
- number: 1
  ...
  segments:
  - id: chihou-zei-hou-shikoukisoku-art-24-34-p1-hashira
    type: hashira
    text: 法第七百十八条の五第一項（法第七百十八条の六、第七百十八条の七第三項及び第七百十八条の八第三項において読み替えて準用する場合を含む。次条において同じ。）に規定する総務省令で定める場合は、次に掲げる場合とする。
    modality: gimu
    references:
    - 次条
...
# 地方税法施行規則 第24-34条(（市町村が年金保険者等に対する通知を行う事由等）)
