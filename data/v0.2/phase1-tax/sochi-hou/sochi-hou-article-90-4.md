...
- number: 1
  ...
  - id: sochi-hou-art-90-4-p1-kou-1
    type: kou
    text: ガス状炭化水素を採取する際に採取された原油のうち温度十五度において〇・八〇一七を超えない比重を有するもので、政令で定める石油化学製品の製造に使用するもの
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-90-4-p1-kou-2
    type: kou
    text: 関税定率法別表第二七一〇・一二号の一の（一）のＣの（ａ）又は第二七一〇・二〇号の一の（一）のＣの（ａ）に掲げる揮発油のうち政令で定める石油化学製品の製造に使用するもの
    modality: unspecified
    item_number: 2
  - id: sochi-hou-art-90-4-p1-kou-3
    type: kou
    text: 関税定率法別表第二七一〇・一二号の一の（二）のＢの（ａ）、第二七一〇・一九号の一の（一）のＢの（ａ）若しくは第二七一〇・二〇号の一の（二）のＢの（ａ）に掲げる灯油又は同表第二七一〇・一二号の一の（三）のＡ、第二七一〇・一九号の一の（二）のＡ若しくは第二七一〇・二〇号の一の（三）のＡに掲げる軽油のうち政令で定める石油化学製品の製造に使用するもの
    modality: unspecified
    item_number: 3
  - id: sochi-hou-art-90-4-p1-kou-4
    type: kou
    text: 関税定率法別表第二七一〇・一九号の一の（三）のＡの（ｂ）又は第二七一〇・二〇号の一の（四）のＡの（ｂ）に掲げる農林漁業の用に供する重油及び粗油
    modality: unspecified
    item_number: 4
  - id: sochi-hou-art-90-4-p1-kou-5
    type: kou
    text: 関税定率法別表第二七一一・一二号、第二七一一・一三号又は第二七一一・一四号の二に該当する石油ガスその他のガス状炭化水素のうち液化したもので、アンモニア、オレフィン系炭化水素又は無水マレイン酸の製造に使用するもの
    modality: unspecified
    item_number: 5
- number: 2
  has_proviso: false
