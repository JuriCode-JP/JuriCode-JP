...
- number: 1
  ...
  - id: sochi-hou-art-65-9-p1-hashira
    ...
    references:
    - 前二条
  - id: sochi-hou-art-65-9-p1-kou-1
    type: kou
    text: 一　当該交換譲渡資産（他資産との交換の場合にあつては、交換差金に対応するものとして政令で定める部分に限る。）は、当該法人が、その交換の日において、同日における当該資産の価額に相当する金額をもつて第六十五条の七第一項の譲渡をしたものとみなす。
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-65-9-p1-kou-2
    type: kou
    text: 二　当該交換取得資産は、当該法人が、その交換の日において、同日における当該資産の価額に相当する金額をもつて第六十五条の七第一項の取得をし、同項及び同条第九項の届出をしたものとみなす。
    modality: unspecified
    item_number: 2
cases: []
amendments: []
