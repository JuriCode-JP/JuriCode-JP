...
- number: 1
  ...
  - id: sochi-hou-art-80-3-p1-kou-1
    type: kou
    text: 株式会社の設立又は資本金の額の増加（これらの認定により増加した資本金の額のうち三千億円を超える部分並びに次号及び第三号に掲げるものを除く。）　千分の三・五
  ...
  - id: sochi-hou-art-80-3-p1-kou-3
    type: kou
    text: 分割による株式会社の設立又は資本金の額の増加（これらの認定により増加した資本金の額のうち三千億円を超える部分を除く。）　千分の五
    modality: unspecified
    item_number: 3
  - id: sochi-hou-art-80-3-p1-kou-4
    type: kou
    text: 法人の設立、資本金若しくは出資金の額の増加又は事業に必要な資産の譲受けの場合における不動産の所有権の取得（次号及び第六号に掲げるものを除く。）　千分の十六
    modality: unspecified
    item_number: 4
