...
- number: 1
  ...
  - id: sochi-hou-art-24-2-p1-kou-1
    type: kou
    text: 当該交付金等の額のうち農業経営基盤強化に要する費用の支出に備えるものとして政令で定める金額
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-24-2-p1-kou-2
    type: kou
    text: その積立てをした年分の事業所得の金額として政令で定めるところにより計算した金額
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
...
- number: 3
  ...
  - id: sochi-hou-art-24-2-p3-kou-1
    type: kou
    text: 認定農業者等に該当しないこととなつた場合　その該当しないこととなつた日における農業経営基盤強化準備金の金額
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-24-2-p3-kou-2
    type: kou
    text: '次に掲げる農用地（農業経営基盤強化促進法第四条第一項第一号に規定する農用地をいい、当該農用地に係る賃借権を含む。以下この号において同じ。）又は特定農業用機械等（次条第一項に規定する特定農業用機械等をいう。以下この号において同じ。）の取得（同項に規定する取得をいい、特定農業用機械等にあつてはその製作又は建設の後事業の用に供されたことのないものの取得に限る。）又は製作若しくは建設（以下この号において「取得等」という。）をした場合　その取得等をした日における農業経営基盤強化準備金の金額のうちその取得等をした農用地又は特定農業用機械等の取得価額に相当する金額
  ...
  - id: sochi-hou-art-24-2-p3-kou-3
    type: kou
    text: 事業の全部を譲渡し、又は廃止した場合　その譲渡し、又は廃止した日における農業経営基盤強化準備金の金額
    modality: unspecified
    item_number: 3
  - id: sochi-hou-art-24-2-p3-kou-4
    type: kou
    text: 前項、前三号及び次項の場合以外の場合において農業経営基盤強化準備金の金額を取り崩した場合　その取り崩した日における農業経営基盤強化準備金の金額のうちその取り崩した金額に相当する金額
    modality: unspecified
    item_number: 4
- number: 4
  has_proviso: false
