...
article_number: 90-6-3
article_id: sochi-hou-art-90-6-3
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-90-6-3-p2
    type: simple
    text: 税務署長は、前項の承認の申請があつた場合において、同項に規定する製造場が非製品ガスの数量を適正に計測できない製造場であることその他の理由により、取締り上特に不適当と認められるときは、その承認を与えないことができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-90-6-3-p3
    type: simple
    text: 税務署長は、取締り上必要があると認めるときは、政令で定めるところにより、課税済みの原料をその他の物品と区分して蔵置すべきことを命ずることができる。
    modality: kanou_kenri
- number: 4
  has_proviso: false
  has_items: false
...
# 租税特別措置法 第90-6-3条(（非製品ガスに係る石油石炭税の還付）)
