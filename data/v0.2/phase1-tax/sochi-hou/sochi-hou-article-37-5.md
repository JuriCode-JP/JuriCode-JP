...
- number: 4
  ...
  - id: sochi-hou-art-37-5-p4-hashira
    ...
    references:
    - 前項
  - id: sochi-hou-art-37-5-p4-kou-1
    type: kou
    text: 一　第一項の譲渡による収入金額が買換資産の取得価額を超える場合　当該譲渡をした資産の取得価額等のうちその超える額に対応する部分以外の部分の額として政令で定めるところにより計算した金額
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-37-5-p4-kou-2
    type: kou
    text: 二　第一項の譲渡による収入金額が買換資産の取得価額に等しい場合　当該譲渡をした資産の取得価額等に相当する金額
    modality: unspecified
    item_number: 2
  - id: sochi-hou-art-37-5-p4-kou-3
    type: kou
    text: 三　第一項の譲渡による収入金額が買換資産の取得価額に満たない場合　当該譲渡をした資産の取得価額等にその満たない額を加算した金額に相当する金額
    modality: unspecified
    item_number: 3
- number: 5
  has_proviso: false
  ...
  - id: sochi-hou-art-37-5-p5-hashira
    ...
    references:
    - 前項
  - id: sochi-hou-art-37-5-p5-kou-1
    type: kou
    text: 一　当該交換譲渡資産（他資産との交換の場合にあつては、交換差金に対応するものとして政令で定める部分に限る。）は、当該個人が、その交換の日において、同日における当該資産の価額に相当する金額をもつて第一項の譲渡をしたものとみなす。
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-37-5-p5-kou-2
    type: kou
    text: 二　当該交換取得資産は、当該個人が、その交換の日において、同日における当該資産の価額に相当する金額をもつて第一項の取得をしたものとみなす。
    modality: unspecified
    item_number: 2
- number: 6
  has_proviso: false
