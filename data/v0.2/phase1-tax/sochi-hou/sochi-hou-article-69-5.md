...
- number: 2
  ...
  - id: sochi-hou-art-69-5-p2-kou-2
    type: kou
    text: 二　特定受贈森林経営計画対象山林　被相続人である特定贈与者（相続税法第二十一条の九第五項に規定する特定贈与者をいう。以下この条において同じ。）が贈与（同法第二十一条の九第三項の規定の適用を受ける財産に係る贈与に限る。以下この条において同じ。）をした立木又は土地等のうち当該贈与の前に市町村長等の認定を受けた森林経営計画が定められている区域内に存するものをいう。
    modality: teigi
    item_number: 2
  - id: sochi-hou-art-69-5-p2-kou-3
    type: kou
    text: '三　特定計画山林相続人等　次のイ又はロに掲げる者をいう。
  ...
  - id: sochi-hou-art-69-5-p2-kou-4
    type: kou
    text: '四　特定計画山林　次のイ又はロに掲げる立木又は土地等をいう。
...
- number: 5
  ...
  - id: sochi-hou-art-69-5-p5-kou-2
    type: kou
    text: 二　二百平方メートルから選択宅地等面積を控除したものの二百平方メートルに占める割合
    modality: unspecified
    item_number: 2
- number: 6
  has_proviso: false
