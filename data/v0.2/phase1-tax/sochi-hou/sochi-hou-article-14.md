...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-14-p2-hashira
    type: hashira
...
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-14-p5
    type: simple
    text: 前項に定めるもののほか、第一項及び第三項の規定の適用に関し必要な事項は、政令で定める。
    modality: unspecified
    references:
    - 前項
cases: []
