...
- number: 5
  ...
  - id: sochi-hou-art-9-2-p5-hashira
    ...
    modality: unspecified
  - id: sochi-hou-art-9-2-p5-kou-1
    type: kou
    text: 一　当該国外株式の配当等の国内における支払の取扱者から交付を受けるべき金額（第三項の規定の適用がある場合には、同項に規定する控除した後の金額）については、当該金額を第八条の五第一項第一号に規定する支払を受けるべき金額又は同条第四項に規定する支払を受けるべき配当等の額とみなす。
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-9-2-p5-kou-2
    type: kou
    text: 二　当該国外株式の配当等については、これを内国法人から支払を受けるものとみなす。
    modality: unspecified
    item_number: 2
- number: 6
  has_proviso: false
