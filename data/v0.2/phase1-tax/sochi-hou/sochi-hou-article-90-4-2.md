...
article_number: 90-4-2
article_id: sochi-hou-art-90-4-2
...
- number: 1
  ...
  segments:
  - id: sochi-hou-art-90-4-2-p1-hashira
    type: hashira
    text: 石炭のうち次に掲げるもの（以下この条において「特定石炭」という。）を、保税地域から引き取ろうとする場合において、当該引き取ろうとする者が政令で定める手続により、納税地の所轄税関長の承認を受けて当該特定石炭を引き取るときは、当分の間、当該引取りに係る石油石炭税を免除する。
    modality: unspecified
  - id: sochi-hou-art-90-4-2-p1-kou-1
    type: kou
    text: 一　鉄鋼の製造に使用する石炭
    modality: unspecified
    item_number: 1
  - id: sochi-hou-art-90-4-2-p1-kou-2
    type: kou
    text: 二　コークスの製造に使用する石炭
    modality: unspecified
    item_number: 2
  - id: sochi-hou-art-90-4-2-p1-kou-3
    type: kou
    text: 三　セメントの製造に使用する石炭
    modality: unspecified
    item_number: 3
- number: 2
  has_proviso: false
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-90-4-2-p2-zen
    type: zen_dan
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-90-4-2-p4-honbun
    type: honbun
    text: 第一項の規定の適用を受けた特定石炭は、同項の承認を受けて当該特定石炭を引き取つた日から二年以内に、当該免除に係る用途以外の用途に供し、又はこれらの用途以外の用途に供するため譲渡してはならない。
    modality: gimu_negative
    references:
    - 同項
  - id: sochi-hou-art-90-4-2-p4-tadashi
    type: tadashi
...
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-90-4-2-p5
    type: simple
    text: 前項ただし書の承認を受けたとき、又は当該承認を受けないで同項の特定石炭を同項に規定する用途以外の用途に供し、若しくはその用途以外の用途に供するため譲渡したときは、税関長は、これらの場合に該当することとなつた者から、当該特定石炭について第一項の規定により免除を受けた額の石油石炭税を直ちに徴収する。
    modality: unspecified
    references:
    - 前項
    - 同項
...
# 租税特別措置法 第90-4-2条(（引取りに係る特定石炭の免税）)
