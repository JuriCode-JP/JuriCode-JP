...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-44-2-p2
    type: simple
    text: 前項の規定は、特定事業継続力強化設備等の取得又は製作若しくは建設に充てるための国又は地方公共団体の補助金又は給付金その他これらに準ずるもの（以下この項において「補助金等」という。）の交付を受けた法人が、当該補助金等をもつて取得し、又は製作し、若しくは建設した当該補助金等の交付の目的に適合した特定事業継続力強化設備等については、適用しない。
    modality: jogai
    references:
    - 前項
- number: 3
...
# 租税特別措置法 第44-2条(（特定事業継続力強化設備等の特別償却）)

## 原文 (日本語)

### 第四十四条の二第一項

<!-- segment: tokusoku id: sochi-hou-art-44-2-p1 override_flag: true override_target: 第二項 -->
...
<!-- segment: simple id: sochi-hou-art-44-2-p2 -->
...
<!-- segment: junyou id: sochi-hou-art-44-2-p3 -->
