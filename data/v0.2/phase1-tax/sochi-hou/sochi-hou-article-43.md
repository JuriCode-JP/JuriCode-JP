...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-art-43-p2
    type: simple
    text: 前項の規定は、確定申告書等に特定船舶の償却限度額の計算に関する明細書の添付がない場合には、適用しない。
    modality: jogai
    references:
    - 前項
cases: []
