...
article_number: '5'
article_id: souzoku-zei-hou-shikoukisoku-art-5
...
- number: 1
  ...
  segments:
  - id: souzoku-zei-hou-shikoukisoku-art-5-p1-hashira
    type: hashira
    text: 施行令第四条の十六第一項に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: souzoku-zei-hou-shikoukisoku-art-5-p2
    type: simple
    text: 施行令第四条の十六第一項の規定による申告書（特定障害者が個人番号の変更をした場合に提出するものを除く。）を受理した受託者の営業所等の長は、当該申告書に、当該申告書を提出した特定障害者の個人番号を付記するものとする。
    modality: gimu
- number: 3
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: souzoku-zei-hou-shikoukisoku-art-5-p3-hashira
    type: hashira
    text: 施行令第四条の十六第二項に規定する財務省令で定める事項は、次に掲げる事項とする。
    modality: gimu
...
# 相続税法施行規則 第5条(（障害者非課税信託に関する異動申告書の記載事項）)
