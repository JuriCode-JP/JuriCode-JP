...
article_number: 26-6
article_id: sochi-hou-shikkourei-art-26-6
...
- number: 1
  ...
  segments:
  - id: sochi-hou-shikkourei-art-26-6-p1-hashira
    type: hashira
    text: 法第四十一条の四第一項に規定する政令で定めるところにより計算した金額は、次の各号に掲げる場合の区分に応じ、当該各号に定める金額とする。
    modality: gimu
  - id: sochi-hou-shikkourei-art-26-6-p1-kou-1
    type: kou
    text: 一　その年分の不動産所得の金額の計算上必要経費に算入した法第四十一条の四第一項に規定する土地等（以下この条において「土地等」という。）を取得するために要した負債の利子の額が当該不動産所得の金額の計算上生じた損失の金額を超える場合　当該損失の金額
    modality: unspecified
    item_number: 1
  - id: sochi-hou-shikkourei-art-26-6-p1-kou-2
    type: kou
    text: 二　その年分の不動産所得の金額の計算上必要経費に算入した土地等を取得するために要した負債の利子の額が当該不動産所得の金額の計算上生じた損失の金額以下である場合　当該損失の金額のうち当該負債の利子の額に相当する金額
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
...
# 租税特別措置法施行令 第26-6条(（不動産所得に係る損益通算の特例）)
