...
- number: 4
  ...
  - id: sochi-hou-shikkourei-art-5-6-4-p4-kou-3
    type: kou
    text: 三　前二号に掲げる者以外の者で当該個人から受ける金銭その他の資産（法第十条の五の四第四項第二号に規定する給与等（以下この条において「給与等」という。）に該当しないものに限る。）によつて生計の支援を受けているもの
    modality: unspecified
    item_number: 3
...
- number: 12
  ...
  - id: sochi-hou-shikkourei-art-5-6-4-p12-kou-1
    type: kou
    text: 一　法第十条の五の四第四項第八号の適用年の前年において事業を営んでいた期間の月数と当該適用年において事業を営んでいた期間の月数とが異なる場合　第九項の給与等支給額
    modality: unspecified
    item_number: 1
  - id: sochi-hou-shikkourei-art-5-6-4-p12-kou-2
    type: kou
    text: 二　第十項の規定の適用を受ける場合　同項又は前項の給与等支給額
    modality: unspecified
    item_number: 2
- number: 13
  has_proviso: false
