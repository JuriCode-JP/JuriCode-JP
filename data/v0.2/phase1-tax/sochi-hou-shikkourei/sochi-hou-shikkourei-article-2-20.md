...
- number: 2
  ...
  - id: sochi-hou-shikkourei-art-2-20-p2-kou-1
    type: kou
    text: 法律の規定に基づく措置として当該業務の停止を命ぜられたこと。
  ...
  - id: sochi-hou-shikkourei-art-2-20-p2-kou-3
    type: kou
    text: 当該業務に係る免許、認可、承認又は登録が取り消されたこと（既に前号に掲げる事由が生じている場合を除く。）。
    modality: unspecified
    item_number: 3
  - id: sochi-hou-shikkourei-art-2-20-p2-kou-4
    type: kou
    text: 当該業務を行う当該申告書に記載された金融機関の営業所等に係る財形住宅貯蓄取扱機関が解散をしたこと（既に前二号に掲げる事由が生じている場合を除く。）。
    modality: unspecified
    item_number: 4
- number: 3
  has_proviso: false
