...
article_number: 37-5
article_id: sochi-hou-shikkourei-art-37-5
...
- number: 1
  ...
  segments:
  - id: sochi-hou-shikkourei-art-37-5-p1
    type: simple
    text: 法第六十一条の四第六項第二号に規定する政令で定めるところにより計算した金額は、同項に規定する飲食費として支出する金額を当該飲食費に係る飲食その他これに類する行為に参加した者の数で除して計算した金額とし、同号に規定する政令で定める金額は、一万円とする。
    modality: gimu
    references:
    - 同項
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-shikkourei-art-37-5-p2-hashira
    type: hashira
