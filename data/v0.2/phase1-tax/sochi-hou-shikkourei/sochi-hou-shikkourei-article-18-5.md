...
article_number: 18-5
article_id: sochi-hou-shikkourei-art-18-5
...
- number: 1
  ...
  segments:
  - id: sochi-hou-shikkourei-art-18-5-p1
    type: simple
    text: 法第二十八条の二第一項に規定する事務負担に配慮する必要があるものとして政令で定めるものは、常時使用する従業員の数が四百人以下の個人とする。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-shikkourei-art-18-5-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: sochi-hou-shikkourei-art-18-5-p3
    type: simple
...
# 租税特別措置法施行令 第18-5条(（中小事業者の少額減価償却資産の取得価額の必要経費算入の特例）)
