...
article_number: '8'
article_id: kokuzei-tsuusoku-hou-shikoukisoku-art-8
...
- number: 1
  ...
  segments:
  - id: kokuzei-tsuusoku-hou-shikoukisoku-art-8-p1-hashira
    type: hashira
    text: 納付受託者は、法第三十四条の五第二項（納付受託者の納付）の規定により、次に掲げる事項を国税庁長官又は財務大臣に報告しなければならない。
    modality: gimu
  - id: kokuzei-tsuusoku-hou-shikoukisoku-art-8-p1-kou-1
    type: kou
    text: 一　報告の対象となつた期間並びに当該期間において法第三十四条の三第一項（納付受託者に対する納付の委託）の規定により国税を納付しようとする者の委託を受けた件数、合計額及び納付年月日
    modality: unspecified
    item_number: 1
  - id: kokuzei-tsuusoku-hou-shikoukisoku-art-8-p1-kou-2
    type: kou
