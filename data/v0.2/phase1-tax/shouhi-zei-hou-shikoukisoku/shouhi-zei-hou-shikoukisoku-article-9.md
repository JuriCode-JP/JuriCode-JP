...
article_number: '9'
article_id: shouhi-zei-hou-shikoukisoku-art-9
...
- number: 1
  ...
  segments:
  - id: shouhi-zei-hou-shikoukisoku-art-9-p1-hashira
    type: hashira
    text: 法第八条第四項ただし書の承認を受けようとする者は、次に掲げる事項を記載した申請書に申請者の旅券等の写しを添付して、これを同項ただし書に規定する税務署長に提出しなければならない。
    modality: gimu
    references:
    - 同項
