...
article_number: 23-5
article_id: shouhi-zei-hou-shikoukisoku-art-23-5
...
- number: 1
  ...
  segments:
  - id: shouhi-zei-hou-shikoukisoku-art-23-5-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikoukisoku-art-23-5-p2
    type: simple
    text: 法第四十六条の三第二項に規定する財務省令で定める書類は、電気通信回線の故障、災害その他の理由により電子情報処理組織を使用することが困難であることを明らかにする書類とする。
    modality: gimu
- number: 3
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: shouhi-zei-hou-shikoukisoku-art-23-5-p3-hashira
    type: hashira
...
# 消費税法施行規則 第23-5条(（電子情報処理組織による申告が困難である場合の特例を受ける旨の申請書の記載事項等）)
