...
article_number: '85'
article_id: kokuzei-tsuusoku-hou-art-85
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-85-p3-zen
    type: zen_dan
    text: 第一項の場合において、再調査の請求書がその処分に係る税務署長等に提出されたときは、当該税務署長等は、その再調査の請求書を受理することができる。
    modality: kanou_kenri
  - id: kokuzei-tsuusoku-hou-art-85-p3-kou
    type: kou_dan
    text: この場合においては、その再調査の請求書は、現在の納税地を所轄する税務署長等に提出されたものとみなす。
    modality: unspecified
    depends_on: kokuzei-tsuusoku-hou-art-85-p3-zen
- number: 4
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-85-p4
    type: simple
    text: 前項の再調査の請求書を受理した税務署長等は、その再調査の請求書を現在の納税地を所轄する税務署長等に送付し、かつ、その旨を再調査の請求人に通知しなければならない。
    modality: gimu
    references:
    - 前項
cases: []
