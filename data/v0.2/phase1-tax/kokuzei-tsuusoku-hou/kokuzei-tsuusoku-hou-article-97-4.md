...
article_number: 97-4
article_id: kokuzei-tsuusoku-hou-art-97-4
...
- number: 1
  ...
  segments:
  - id: kokuzei-tsuusoku-hou-art-97-4-p1
    type: simple
    text: 担当審判官は、必要な審理を終えたと認めるときは、審理手続を終結するものとする。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-97-4-p2-hashira
    type: hashira
    text: 前項に定めるもののほか、担当審判官は、次の各号のいずれかに該当するときは、審理手続を終結することができる。
    modality: kanou_kenri
    references:
    - 前項
  - id: kokuzei-tsuusoku-hou-art-97-4-p2-kou-1
    type: kou
    text: '一　次のイからホまでに掲げる規定の相当の期間内に、当該イからホまでに定める物件が提出されない場合において、更に一定の期間を示して、当該物件の提出を求めたにもかかわらず、当該提出期間内に当該物件が提出されなかつたとき。
    ...
    item_number: 1
  - id: kokuzei-tsuusoku-hou-art-97-4-p2-kou-2
    type: kou
    text: 二　第九十五条の二第一項（口頭意見陳述）に規定する申立てをした審査請求人又は参加人が、正当な理由がなく、口頭意見陳述に出頭しないとき。
    modality: unspecified
    item_number: 2
- number: 3
  has_proviso: false
  ...
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-97-4-p3
    type: simple
    text: 担当審判官が前二項の規定により審理手続を終結したときは、速やかに、審理関係人に対し、審理手続を終結した旨を通知するものとする。
    modality: gimu
    references:
    - 前二項
cases: []
