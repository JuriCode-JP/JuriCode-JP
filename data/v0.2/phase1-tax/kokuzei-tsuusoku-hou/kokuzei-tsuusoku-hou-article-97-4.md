...
- number: 2
  ...
  - id: kokuzei-tsuusoku-hou-art-97-4-p2-kou-1
    type: kou
    text: '次のイからホまでに掲げる規定の相当の期間内に、当該イからホまでに定める物件が提出されない場合において、更に一定の期間を示して、当該物件の提出を求めたにもかかわらず、当該提出期間内に当該物件が提出されなかつたとき。
  ...
  - id: kokuzei-tsuusoku-hou-art-97-4-p2-kou-2
    type: kou
    text: 第九十五条の二第一項（口頭意見陳述）に規定する申立てをした審査請求人又は参加人が、正当な理由がなく、口頭意見陳述に出頭しないとき。
    modality: unspecified
    item_number: 2
- number: 3
  has_proviso: false
