...
article_number: '137'
article_id: kokuzei-tsuusoku-hou-art-137
...
- number: 1
  ...
  segments:
  - id: kokuzei-tsuusoku-hou-art-137-p1
    type: simple
    text: 当該職員は、臨検、捜索、差押え又は記録命令付差押えをするため必要があるときは、錠をはずし、封を開き、その他必要な処分をすることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-137-p2
    type: simple
...
<!-- segment: simple id: kokuzei-tsuusoku-hou-art-137-p1 -->
当該職員は、臨検、捜索、差押え又は記録命令付差押えをするため必要があるときは、錠をはずし、封を開き、その他必要な処分をすることができる。

### 第百三十七条第二項

<!-- segment: simple id: kokuzei-tsuusoku-hou-art-137-p2 -->
