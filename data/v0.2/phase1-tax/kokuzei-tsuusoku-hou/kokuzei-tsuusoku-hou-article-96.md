...
article_number: '96'
article_id: kokuzei-tsuusoku-hou-art-96
...
- number: 1
  ...
  segments:
  - id: kokuzei-tsuusoku-hou-art-96-p1
    type: simple
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-96-p2
    type: simple
    text: 原処分庁は、当該処分の理由となる事実を証する書類その他の物件を提出することができる。
    modality: kanou_kenri
- number: 3
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-96-p3
    type: simple
    text: 前二項の場合において、担当審判官が、証拠書類若しくは証拠物又は書類その他の物件を提出すべき相当の期間を定めたときは、その期間内にこれを提出しなければならない。
    modality: gimu
    references:
    - 前二項
cases: []
