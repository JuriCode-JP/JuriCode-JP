...
article_number: '17'
article_id: kokuzei-tsuusoku-hou-art-17
...
- number: 1
  ...
  segments:
  - id: kokuzei-tsuusoku-hou-art-17-p1
    type: simple
    text: 申告納税方式による国税の納税者は、国税に関する法律の定めるところにより、納税申告書を法定申告期限までに税務署長に提出しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kokuzei-tsuusoku-hou-art-17-p2
    type: simple
    text: 前項の規定により提出する納税申告書は、期限内申告書という。
    modality: teigi
    references:
    - 前項
cases:
- case_id: ntt-2010-08-23-j80-1
  case_type: ruling
  source_license: pdl-1.0
  summary_source: official_pdl
  decision_date: '2010-08-23'
  case_name_ja: 請求人は、確定申告に係る一連の手続について兄に包括的に委任していたというべきであり、その委任の効力は、その後の修正申告にも及ぶと解すべきであるから、当該確定申告及び当該修正申告は有効と認められるとした事例
  url: https://www.kfs.go.jp/service/JP/80/01/index.html
  relevance: medium
  relevant_paragraph: 1
  summary_ja: '納税申告は、原則として納税義務者本人が申告書を提出して行うこととされているから、納税義務者以外の者が、本人の承諾なく勝手に納税義務者の申告書を作成し、提出した場合には、その納税申告は無効であると解される。もっとも、納税義務者以外の者が申告書を作成し提出した場合であっても、その者が、納税義務者から明示又は黙示に当該申告行為をする権限を与えられている場合は、その納税申告は有効であると解される。
