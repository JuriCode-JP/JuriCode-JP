...
article_number: '336'
article_id: kinsho-gyou-furei-art-336
...
- number: 1
  ...
  segments:
  - id: kinsho-gyou-furei-art-336-p1-hashira
    type: hashira
    text: 法第六十六条の五十五の規定により高速取引行為者が整備しなければならない業務管理体制は、次に掲げる要件を満たさなければならない。
    modality: gimu
  - id: kinsho-gyou-furei-art-336-p1-kou-1
    type: kou
    text: 一　高速取引行為に係る業務を適確に遂行するための社内規則等（社内規則その他これに準ずるものをいう。）を整備し、当該社内規則等を遵守するための従業員に対する研修その他の措置がとられていること。
...
# 金融商品取引業等に関する内閣府令 第336条(（業務管理体制の整備）)
