...
article_number: '261'
article_id: kinsho-gyou-furei-art-261
...
- number: 1
  ...
  segments:
  - id: kinsho-gyou-furei-art-261-p1
    type: simple
    text: 法第六十六条の二第三項に規定する内閣府令で定めるものは、電磁的記録媒体をもって調製するファイルに情報を記録したものとする。
    modality: gimu
cases: []
amendments: []
tags:
