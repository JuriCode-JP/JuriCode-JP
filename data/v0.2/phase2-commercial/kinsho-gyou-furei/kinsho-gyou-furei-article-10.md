...
- number: 1
  ...
  - id: kinsho-gyou-furei-art-10-p1-kou-1
    type: kou
    text: 一　最終の貸借対照表（関連する注記を含む。）及び損益計算書（関連する注記を含む。）
    modality: unspecified
    item_number: 1
  - id: kinsho-gyou-furei-art-10-p1-kou-2
    type: kou
    text: '二　第一種金融商品取引業又は投資運用業を行う場合には、次に掲げる書類
  ...
  - id: kinsho-gyou-furei-art-10-p1-kou-3
    type: kou
    text: '三　第一種金融商品取引業を行う場合には、次に掲げる書類（第一種少額電子募集取扱業務又は非上場有価証券特例仲介等業務のみを行う場合には、ロに掲げる書類を除く。）
