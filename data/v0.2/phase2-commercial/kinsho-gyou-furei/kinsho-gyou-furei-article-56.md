...
- number: 1
  ...
  - id: kinsho-gyou-furei-art-56-p1-kou-2
    type: kou
    text: 二　電磁的記録媒体をもって調製するファイルに記載事項を記録したものを交付する方法
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
  ...
  - id: kinsho-gyou-furei-art-56-p2-kou-4
    type: kou
    text: '四　前項第一号ニに掲げる方法にあっては、次に掲げる基準に適合するものであること。
