...
article_number: '60'
article_id: kinsho-gyou-furei-art-60
...
- number: 1
  ...
  segments:
  - id: kinsho-gyou-furei-art-60-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-gyou-furei-art-60-p2
    type: simple
...
# 金融商品取引業等に関する内閣府令 第60条(（申出をした特定投資家以外の顧客である法人が更新申出をするために必要な期間）)
