...
article_number: 66-83
article_id: kinsho-hou-art-66-83
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-66-83-p1-hashira
    type: hashira
    text: 投資運用関係業務受託業者が次の各号のいずれかに該当することとなつたときは、当該各号に定める者は、その日から三十日以内に、その旨を内閣総理大臣に届け出なければならない。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-66-83-p2
    type: simple
    text: 投資運用関係業務受託業者が前項各号のいずれかに該当することとなつたときは、当該投資運用関係業務受託業者の第六十六条の七十一の登録は、その効力を失う。
    modality: unspecified
    references:
    - 前項
cases: []
