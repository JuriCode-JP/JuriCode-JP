...
article_number: 89-2
article_id: kinsho-hou-art-89-2
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-89-2-p1
    type: simple
    text: 金融商品会員制法人の設立の登記は、その主たる事務所の所在地において、創立総会の終了の日から二週間以内に、しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-89-2-p2-hashira
    type: hashira
