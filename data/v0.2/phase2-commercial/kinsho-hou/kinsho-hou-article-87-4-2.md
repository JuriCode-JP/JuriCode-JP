...
article_number: 87-4-2
article_id: kinsho-hou-art-87-4-2
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-87-4-2-p1
    type: simple
    text: 金融商品取引所（子会社対象会社を子会社としているものであつて、他の金融商品取引所又は金融商品取引所持株会社の子会社でないものに限る。）は、当該金融商品取引所の属する金融商品取引所グループの経営管理を行わなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-87-4-2-p2-hashira
    type: hashira
    text: 前項の「経営管理」とは、次に掲げるものをいう。
    modality: teigi
    references:
    - 前項
...
# 金融商品取引法 第87-4-2条(（金融商品取引所による金融商品取引所グループの経営管理）)
