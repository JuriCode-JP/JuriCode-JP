...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-106-p1
    type: simple
    text: 特定株式会社金融商品取引所の取締役会は、自主規制委員会の職務の執行のため必要なものとして内閣府令で定める事項を決定しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
# 金融商品取引法 第106条(（自主規制委員会の職務執行のための決定）)

## 原文 (日本語)

### 第百六条

<!-- segment: simple id: kinsho-hou-art-106-p1 -->
