...
article_number: 102-4
article_id: kinsho-hou-art-102-4
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-102-4-p1
    type: simple
    text: 自主規制法人を設立するには、発起人が定款を作成し、その全員が署名し、又は記名押印しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-102-4-p2-hashira
    type: hashira
    text: 自主規制法人の定款には、次に掲げる事項を記載し、又は記録しなければならない。
    modality: gimu
...
十三　公告方法（自主規制法人が公告（この法律の規定により官報に掲載する方法によりしなければならないものとされているものを除く。）をする方法をいう。第百二条の九第二項第九号において同じ。）
