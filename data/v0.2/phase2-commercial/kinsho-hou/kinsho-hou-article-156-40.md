...
article_number: 156-40
article_id: kinsho-hou-art-156-40
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-156-40-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-156-40-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-156-40-p3
    type: simple
    text: 前項の場合において、定款、財産目録又は貸借対照表が電磁的記録で作成されているときは、書類に代えて当該電磁的記録を添付することができる。
