...
article_id: kinsho-hou-art-117-2
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-117-2-p1
    type: simple
    text: 金融商品取引所は、業務規程の定めるところにより、その開設する取引所金融商品市場ごとに、会員等が特定投資家等以外の者（当該有価証券の発行者その他の内閣府令で定める者を除く。）の委託を受けて行う有価証券の買付け（次項において「一般投資家等買付け」という。）を禁止することができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-117-2-p2-hashira
    type: hashira
    text: 前項の規定により一般投資家等買付けを禁止する場合において、金融商品取引所は、その業務規程において、前条第一項各号に掲げる事項のほか、特定取引所金融商品市場に関し、次に掲げる事項を定めなければならない。
    modality: gimu
    references:
    - 前条
    - 前項
