...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-109-p1
    type: simple
    text: 第百六条の二十三第三項並びに第百六条の二十八第一項及び第五項の規定は株式会社金融商品取引所を子会社とする認可金融商品取引業協会及び金融商品取引所並びに金融商品取引所持株会社を子会社とする認可金融商品取引業協会及び金融商品取引所について、第百六条の二十三第三項、第百六条の二十七並びに第百六条の二十八第一項及び第五項の規定は親商品取引所等及び金融商品取引所持株会社を子会社とする商品取引所について、それぞれ準用する。
...
# 金融商品取引法 第109条(（監督上の処分等に係る規定の準用）)

## 原文 (日本語)

### 第百九条

<!-- segment: simple id: kinsho-hou-art-109-p1 -->
