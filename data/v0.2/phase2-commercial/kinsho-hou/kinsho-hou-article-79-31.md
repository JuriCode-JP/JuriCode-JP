...
article_number: 79-31
article_id: kinsho-hou-art-79-31
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-art-79-31-p1-hashira
    type: hashira
    text: 内閣総理大臣及び財務大臣は、前条第一項の規定による認可の申請があつた場合においては、その申請が次に掲げる基準に適合するかどうかを審査しなければならない。
    modality: gimu
    references:
    - 前条
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-79-31-p3
    type: simple
    text: 内閣総理大臣及び財務大臣は、前条第一項の規定による認可の申請があつた場合において、その認可をすることが適当でないと認めるときは、認可申請者に通知して、当該職員をして審問を行わせなければならない。
    modality: gimu
    references:
    - 前条
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-79-31-p4
    type: simple
    text: 内閣総理大臣及び財務大臣は、設立の認可をすることとし、又はしないこととした場合においては、遅滞なく、その旨を書面により認可申請者に通知しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
