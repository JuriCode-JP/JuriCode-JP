...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-art-102-37-p2
    type: junyou
    text: 会社法第八百六十八条第一項、第八百七十一条、第八百七十四条（第一号に係る部分に限る。）、第八百七十五条及び第八百七十六条の規定は、自主規制法人の清算について準用する。この場合において、必要な技術的読替えは、政令で定める。
    modality: unspecified
    applies_provisions:
    - 第八百七十六条
cases: []
