...
article_number: 33-3
article_id: koukai-kaitsuke-furei-art-33-3
...
- number: 2
  ...
  - id: koukai-kaitsuke-furei-art-33-3-p2-kou-2
    type: kou
    text: 二　電磁的記録媒体をもって調製するファイルに書類に記載すべき事項を記録したものを交付する方法
    modality: unspecified
    item_number: 2
- number: 3
  has_proviso: false
...
- number: 5
  ...
  - id: koukai-kaitsuke-furei-art-33-3-p5-kou-1
    type: kou
    text: 一　第二項各号に規定する方法のうち公開買付者が使用するもの
    modality: unspecified
    item_number: 1
...
# 発行者以外の者による株券等の公開買付けの開示に関する内閣府令 第33-3条(（公開買付届出書等の写しの送付についての情報通信の技術を利用する方法）)
