...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-315-p1
    type: simple
    text: 株主総会の議長は、当該株主総会の秩序を維持し、議事を整理する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-315-p2
    type: simple
    text: 株主総会の議長は、その命令に従わない者その他当該株主総会の秩序を乱す者を退場させることができる。
