...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-360-p3
    type: simple
    text: 監査役設置会社、監査等委員会設置会社又は指名委員会等設置会社における第一項の規定の適用については、同項中「著しい損害」とあるのは、「回復することができない損害」とする。
    modality: gimu
    references:
    - 同項
cases: []
...
# 会社法 第360条(（株主による取締役の行為の差止め）)

## 原文 (日本語)

### 第三百六十条第一項

<!-- segment: simple id: kaisha-hou-art-360-p1 -->
