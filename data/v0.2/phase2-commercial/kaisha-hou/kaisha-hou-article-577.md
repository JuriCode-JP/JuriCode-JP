...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-577-p1
    type: simple
    text: 前条に規定するもののほか、持分会社の定款には、この法律の規定により定款の定めがなければその効力を生じない事項及びその他の事項でこの法律の規定に違反しないものを記載し、又は記録することができる。
...
<!-- segment: simple id: kaisha-hou-art-577-p1 -->
