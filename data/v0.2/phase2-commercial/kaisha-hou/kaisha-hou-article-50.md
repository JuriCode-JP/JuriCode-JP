...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-50-p1
    type: simple
    text: 発起人は、株式会社の成立の時に、出資の履行をした設立時発行株式の株主となる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-50-p2
    type: simple
    text: 前項の規定により株主となる権利の譲渡は、成立後の株式会社に対抗することができない。
