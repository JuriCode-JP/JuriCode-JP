...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-278-p1-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-278-p3-honbun
    type: honbun
    text: 第一項各号に掲げる事項の決定は、株主総会（取締役会設置会社にあっては、取締役会）の決議によらなければならない。
    modality: gimu
  - id: kaisha-hou-art-278-p3-tadashi
    type: tadashi
