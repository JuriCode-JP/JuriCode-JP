...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-748-p1-zen
    type: zen_dan
    text: 会社は、他の会社と合併をすることができる。
    modality: kanou_kenri
  - id: kaisha-hou-art-748-p1-kou
    type: kou_dan
    text: この場合においては、合併をする会社は、合併契約を締結しなければならない。
    modality: gimu
    depends_on: kaisha-hou-art-748-p1-zen
cases: []
amendments: []
tags:
- phase1-police
