...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-600-p1
    type: simple
    text: 持分会社は、持分会社を代表する社員その他の代表者がその職務を行うについて第三者に加えた損害を賠償する責任を負う。
...
<!-- segment: simple id: kaisha-hou-art-600-p1 -->
