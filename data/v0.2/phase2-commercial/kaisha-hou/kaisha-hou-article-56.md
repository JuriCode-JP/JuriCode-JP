...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-56-p1
    type: simple
    text: 株式会社が成立しなかったときは、発起人は、連帯して、株式会社の設立に関してした行為についてその責任を負い、株式会社の設立に関して支出した費用を負担する。
...
# 会社法 第56条(（株式会社不成立の場合の責任）)

## 原文 (日本語)

### 第五十六条

<!-- segment: simple id: kaisha-hou-art-56-p1 -->
