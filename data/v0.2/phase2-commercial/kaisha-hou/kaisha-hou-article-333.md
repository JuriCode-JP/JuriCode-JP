...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-333-p1
    type: simple
    text: 会計参与は、公認会計士若しくは監査法人又は税理士若しくは税理士法人でなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-333-p2-zen
    type: zen_dan
    text: 会計参与に選任された監査法人又は税理士法人は、その社員の中から会計参与の職務を行うべき者を選定し、これを株式会社に通知しなければならない。
    modality: gimu
  - id: kaisha-hou-art-333-p2-kou
    type: kou_dan
    text: この場合においては、次項各号に掲げる者を選定することはできない。
    modality: kanou_negative
    references:
    - 次項
    depends_on: kaisha-hou-art-333-p2-zen
- number: 3
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-333-p3-hashira
    type: hashira
