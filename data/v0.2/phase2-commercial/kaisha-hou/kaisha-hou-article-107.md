...
- number: 1
  ...
  - id: kaisha-hou-art-107-p1-kou-1
    type: kou
    text: 一　譲渡による当該株式の取得について当該株式会社の承認を要すること。
    modality: unspecified
    item_number: 1
  - id: kaisha-hou-art-107-p1-kou-2
    type: kou
    text: 二　当該株式について、株主が当該株式会社に対してその取得を請求することができること。
    modality: unspecified
    item_number: 2
  - id: kaisha-hou-art-107-p1-kou-3
    type: kou
    text: 三　当該株式について、当該株式会社が一定の事由が生じたことを条件としてこれを取得することができること。
    modality: unspecified
    item_number: 3
- number: 2
  has_proviso: false
  ...
  - id: kaisha-hou-art-107-p2-kou-1
    type: kou
    text: '一　譲渡による当該株式の取得について当該株式会社の承認を要すること　次に掲げる事項
  ...
  - id: kaisha-hou-art-107-p2-kou-2
    type: kou
    text: '二　当該株式について、株主が当該株式会社に対してその取得を請求することができること　次に掲げる事項
  ...
  - id: kaisha-hou-art-107-p2-kou-3
    type: kou
    text: '三　当該株式について、当該株式会社が一定の事由が生じたことを条件としてこれを取得することができること　次に掲げる事項
