...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-35-p1
    type: simple
    text: 前条第一項の規定による払込み又は給付（以下この章において「出資の履行」という。）をすることにより設立時発行株式の株主となる権利の譲渡は、成立後の株式会社に対抗することができない。
...
# 会社法 第35条(（設立時発行株式の株主となる権利の譲渡）)

## 原文 (日本語)

### 第三十五条

<!-- segment: simple id: kaisha-hou-art-35-p1 -->
