...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-67-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-67-p2
    type: simple
    text: 発起人は、設立時株主（創立総会において決議をすることができる事項の全部につき議決権を行使することができない設立時株主を除く。次条から第七十一条までにおいて同じ。）の数が千人以上である場合には、前項第三号に掲げる事項を定めなければならない。
    modality: gimu
    references:
    - 前項
    - 次条
