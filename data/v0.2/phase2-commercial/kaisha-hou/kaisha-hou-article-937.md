...
- number: 1
  ...
  - id: kaisha-hou-art-937-p1-hashira
    ...
    modality: gimu
  - id: kaisha-hou-art-937-p1-kou-1
    type: kou
    text: '一　次に掲げる訴えに係る請求を認容する判決が確定したとき。
    ...
    item_number: 1
  - id: kaisha-hou-art-937-p1-kou-2
    type: kou
    text: '二　次に掲げる裁判があったとき。
    ...
    modality: unspecified
    item_number: 2
  - id: kaisha-hou-art-937-p1-kou-3
    type: kou
    text: '三　次に掲げる裁判が確定したとき。
...
- number: 2
  ...
  - id: kaisha-hou-art-937-p2-hashira
    ...
    modality: gimu
  - id: kaisha-hou-art-937-p2-kou-1
    type: kou
    text: 一　日本に営業所を設けていない外国会社　日本における代表者（日本に住所を有するものに限る。）の住所地
    modality: unspecified
    item_number: 1
  - id: kaisha-hou-art-937-p2-kou-2
    type: kou
    text: 二　日本に営業所を設けている外国会社　当該営業所の所在地
    modality: unspecified
    item_number: 2
- number: 3
  has_proviso: false
  ...
  - id: kaisha-hou-art-937-p3-hashira
    ...
    modality: gimu
  - id: kaisha-hou-art-937-p3-kou-1
    type: kou
    text: 一　会社の組織変更の無効の訴え　組織変更後の会社についての解散の登記及び組織変更をする会社についての回復の登記
    modality: unspecified
    item_number: 1
  - id: kaisha-hou-art-937-p3-kou-2
    type: kou
    text: 二　会社の吸収合併の無効の訴え　吸収合併後存続する会社についての変更の登記及び吸収合併により消滅する会社についての回復の登記
    modality: unspecified
    item_number: 2
  - id: kaisha-hou-art-937-p3-kou-3
    type: kou
    text: 三　会社の新設合併の無効の訴え　新設合併により設立する会社についての解散の登記及び新設合併により消滅する会社についての回復の登記
    modality: unspecified
    item_number: 3
  - id: kaisha-hou-art-937-p3-kou-4
    type: kou
    text: 四　会社の吸収分割の無効の訴え　吸収分割をする会社及び当該会社がその事業に関して有する権利義務の全部又は一部を当該会社から承継する会社についての変更の登記
    modality: unspecified
    item_number: 4
  - id: kaisha-hou-art-937-p3-kou-5
    type: kou
    text: 五　会社の新設分割の無効の訴え　新設分割をする会社についての変更の登記及び新設分割により設立する会社についての解散の登記
    modality: unspecified
    item_number: 5
  - id: kaisha-hou-art-937-p3-kou-6
    type: kou
    text: 六　株式会社の株式交換の無効の訴え　株式交換をする株式会社（第七百六十八条第一項第四号に掲げる事項についての定めがある場合に限る。）及び株式交換をする株式会社の発行済株式の全部を取得する会社についての変更の登記
    modality: unspecified
    item_number: 6
  - id: kaisha-hou-art-937-p3-kou-7
    type: kou
    text: 七　株式会社の株式移転の無効の訴え　株式移転をする株式会社（第七百七十三条第一項第九号に掲げる事項についての定めがある場合に限る。）についての変更の登記及び株式移転により設立する株式会社についての解散の登記
    modality: unspecified
    item_number: 7
  - id: kaisha-hou-art-937-p3-kou-8
    type: kou
    text: 八　株式会社の株式交付の無効の訴え　株式交付親会社についての変更の登記
    modality: unspecified
    item_number: 8
cases: []
amendments: []
