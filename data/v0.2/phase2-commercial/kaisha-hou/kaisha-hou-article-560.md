...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-560-p1
    type: simple
    text: 債権者集会においてその延期又は続行について決議があった場合には、第五百四十八条（第四項を除く。）及び第五百四十九条の規定は、適用しない。
    modality: jogai
cases: []
amendments: []
tags:
...
<!-- segment: simple id: kaisha-hou-art-560-p1 -->
