...
article_number: 213-2
article_id: kaisha-hou-art-213-2
...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-213-2-p1-hashira
    type: hashira
    text: 募集株式の引受人は、次の各号に掲げる場合には、株式会社に対し、当該各号に定める行為をする義務を負う。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-213-2-p2
    type: simple
    text: 前項の規定により募集株式の引受人の負う義務は、総株主の同意がなければ、免除することができない。
...
# 会社法 第213-2条(（出資の履行を仮装した募集株式の引受人の責任）)
