...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-11-p1
    type: simple
    text: 支配人は、会社に代わってその事業に関する一切の裁判上又は裁判外の行為をする権限を有する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-11-p2
    type: simple
    text: 支配人は、他の使用人を選任し、又は解任することができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-11-p3
    type: simple
    text: 支配人の代理権に加えた制限は、善意の第三者に対抗することができない。
