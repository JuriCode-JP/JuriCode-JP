...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-666-p1
    type: simple
    text: 残余財産の分配の割合について定款の定めがないときは、その割合は、各社員の出資の価額に応じて定める。
...
parent_section:
  ...
  shou_name_ja: 第八章　清算
  setsu: 5
  setsu_name_ja: 第五節　残余財産の分配
---

# 会社法 第666条(（残余財産の分配の割合）)
