...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-531-p1
    type: simple
    text: 監督委員は、善良な管理者の注意をもって、その職務を行わなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-531-p2
    type: simple
    text: 監督委員が前項の注意を怠ったときは、その監督委員は、利害関係人に対し、連帯して損害を賠償する責任を負う。
...
<!-- segment: simple id: kaisha-hou-art-531-p1 -->
監督委員は、善良な管理者の注意をもって、その職務を行わなければならない。

### 第五百三十一条第二項

<!-- segment: simple id: kaisha-hou-art-531-p2 -->
