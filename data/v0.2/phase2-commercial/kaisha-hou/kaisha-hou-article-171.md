...
- number: 1
  ...
  - id: kaisha-hou-art-171-p1-kou-1
    type: kou
    text: '全部取得条項付種類株式を取得するのと引換えに金銭等を交付するときは、当該金銭等（以下この条において「取得対価」という。）についての次に掲げる事項
  ...
  - id: kaisha-hou-art-171-p1-kou-2
    type: kou
    text: 前号に規定する場合には、全部取得条項付種類株式の株主に対する取得対価の割当てに関する事項
    modality: unspecified
    item_number: 2
  - id: kaisha-hou-art-171-p1-kou-3
    type: kou
    text: 株式会社が全部取得条項付種類株式を取得する日（以下この款において「取得日」という。）
    modality: unspecified
    item_number: 3
- number: 2
  has_proviso: false
