...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-509-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-509-p2
    type: simple
    text: 第二章第四節の二の規定は、対象会社が清算株式会社である場合には、適用しない。
    modality: jogai
- number: 3
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-509-p3
    type: simple
    text: 清算株式会社は、無償で取得する場合その他法務省令で定める場合に限り、当該清算株式会社の株式を取得することができる。
