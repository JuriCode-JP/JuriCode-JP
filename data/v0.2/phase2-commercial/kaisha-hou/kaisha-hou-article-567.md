...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-567-p1
    type: tokusoku
    text: 第五百五十四条第一項の規定にかかわらず、債権者集会において協定を可決するには、次に掲げる同意のいずれもがなければならない。
    modality: gimu
    override_flag: true
    override_target:
    - 第五百五十四条
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-567-p2
    type: junyou
    text: 第五百五十四条第二項の規定は、前項第一号の規定の適用について準用する。
