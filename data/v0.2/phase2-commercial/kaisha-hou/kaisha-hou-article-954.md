...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-954-p1
    type: simple
    text: 法務大臣は、調査機関が次のいずれかに該当するときは、その登録を取り消し、又は期間を定めて電子公告調査の業務の全部若しくは一部の停止を命ずることができる。
...
<!-- segment: simple id: kaisha-hou-art-954-p1 -->
