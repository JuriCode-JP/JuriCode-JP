...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-476-p1
    type: simple
    text: 前条の規定により清算をする株式会社（以下「清算株式会社」という。）は、清算の目的の範囲内において、清算が結了するまではなお存続するものとみなす。
...
<!-- segment: simple id: kaisha-hou-art-476-p1 -->
