...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-536-p1-hashira
    type: hashira
    text: 特別清算開始の命令があった場合には、清算株式会社が次に掲げる行為をするには、裁判所の許可を得なければならない。
    modality: gimu
  - id: kaisha-hou-art-536-p1-kou-1
    type: kou
    text: 一　事業の全部の譲渡
    modality: unspecified
    item_number: 1
  - id: kaisha-hou-art-536-p1-kou-2
    type: kou
    text: 二　事業の重要な一部の譲渡（当該譲渡により譲り渡す資産の帳簿価額が当該清算株式会社の総資産額として法務省令で定める方法により算定される額の五分の一（これを下回る割合を定款で定めた場合にあっては、その割合）を超えないものを除く。）
    modality: unspecified
    item_number: 2
  - id: kaisha-hou-art-536-p1-kou-3
    type: kou
    text: '三　その子会社の株式又は持分の全部又は一部の譲渡（次のいずれにも該当する場合における譲渡に限る。）
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-536-p2
    type: junyou
    text: 前条第三項の規定は、前項の許可を得ないでした行為について準用する。
    modality: unspecified
    references:
    - 前条
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-536-p3
    type: simple
    text: 第七章（第四百六十七条第一項第五号を除く。）の規定は、特別清算の場合には、適用しない。
    modality: jogai
cases: []
amendments: []
tags:
