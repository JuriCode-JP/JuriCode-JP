...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-276-p1-zen
    type: zen_dan
    text: 株式会社は、自己新株予約権を消却することができる。
    modality: kanou_kenri
  - id: kaisha-hou-art-276-p1-kou
    type: kou_dan
    text: この場合においては、消却する自己新株予約権の内容及び数を定めなければならない。
    modality: gimu
    depends_on: kaisha-hou-art-276-p1-zen
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-276-p2
    type: simple
