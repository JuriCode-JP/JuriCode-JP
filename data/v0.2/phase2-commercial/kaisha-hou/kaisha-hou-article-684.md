...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-684-p1
    type: simple
    text: 社債発行会社は、社債原簿をその本店（社債原簿管理人がある場合にあっては、その営業所）に備え置かなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-684-p2-hashira
    type: hashira
...
- number: 3
  ...
  - id: kaisha-hou-art-684-p3
    type: simple
    text: 社債発行会社は、前項の請求があったときは、次のいずれかに該当する場合を除き、これを拒むことができない。
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-684-p4-zen
    type: zen_dan
    text: 社債発行会社が株式会社である場合には、当該社債発行会社の親会社社員は、その権利を行使するため必要があるときは、裁判所の許可を得て、当該社債発行会社の社債原簿について第二項各号に掲げる請求をすることができる。
    modality: kanou_kenri
  - id: kaisha-hou-art-684-p4-kou
    type: kou_dan
    text: この場合においては、当該請求の理由を明らかにしてしなければならない。
    modality: gimu
    depends_on: kaisha-hou-art-684-p4-zen
- number: 5
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-684-p5
    type: simple
