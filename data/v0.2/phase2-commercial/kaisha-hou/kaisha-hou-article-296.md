...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-296-p2
    type: simple
    text: 株主総会は、必要がある場合には、いつでも、招集することができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-296-p3
    type: simple
    text: 株主総会は、次条第四項の規定により招集する場合を除き、取締役が招集する。
