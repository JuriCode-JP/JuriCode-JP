...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-367-p1
    type: simple
    text: 取締役会設置会社（監査役設置会社、監査等委員会設置会社及び指名委員会等設置会社を除く。）の株主は、取締役が取締役会設置会社の目的の範囲外の行為その他法令若しくは定款に違反する行為をし、又はこれらの行為をするおそれがあると認めるときは、取締役会の招集を請求することができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-367-p3
    type: junyou
    text: 前条第三項の規定は、第一項の規定による請求があった場合について準用する。
...
# 会社法 第367条(（株主による招集の請求）)

## 原文 (日本語)

### 第三百六十七条第一項

<!-- segment: simple id: kaisha-hou-art-367-p1 -->
...
<!-- segment: simple id: kaisha-hou-art-367-p2 -->
前項の規定による請求は、取締役（前条第一項ただし書に規定する場合にあっては、招集権者）に対し、取締役会の目的である事項を示して行わなければならない。

### 第三百六十七条第三項

<!-- segment: junyou id: kaisha-hou-art-367-p3 -->
前条第三項の規定は、第一項の規定による請求があった場合について準用する。

### 第三百六十七条第四項

<!-- segment: simple id: kaisha-hou-art-367-p4 -->
