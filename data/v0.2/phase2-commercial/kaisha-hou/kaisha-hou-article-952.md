...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-952-p1
    type: simple
    text: 法務大臣は、調査機関が第九百四十四条第一項各号のいずれかに適合しなくなったと認めるときは、その調査機関に対し、これらの規定に適合するため必要な措置をとるべきことを命ずることができる。
...
<!-- segment: simple id: kaisha-hou-art-952-p1 -->
