...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-927-p1
    type: simple
    text: 第四百七十三条、第六百四十二条第一項又は第八百四十五条の規定により会社が継続したときは、二週間以内に、その本店の所在地において、継続の登記をしなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: kaisha-hou-art-927-p1 -->
