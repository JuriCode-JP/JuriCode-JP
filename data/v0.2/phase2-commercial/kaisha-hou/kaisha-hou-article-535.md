...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-535-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-535-p2
    type: tokusoku
    text: 前項の規定にかかわらず、同項第一号から第五号までに掲げる行為については、次に掲げる場合には、同項の許可を要しない。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-535-p3-honbun
    type: honbun
    text: 第一項の許可又はこれに代わる監督委員の同意を得ないでした行為は、無効とする。
    modality: koka_mukou
  - id: kaisha-hou-art-535-p3-tadashi
    type: tadashi
    text: ただし、これをもって善意の第三者に対抗することができない。
