...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-396-p1-zen
    type: zen_dan
    text: 会計監査人は、次章の定めるところにより、株式会社の計算書類及びその附属明細書、臨時計算書類並びに連結計算書類を監査する。
    modality: unspecified
  - id: kaisha-hou-art-396-p1-kou
    type: kou_dan
    text: この場合において、会計監査人は、法務省令で定めるところにより、会計監査報告を作成しなければならない。
    modality: gimu
    depends_on: kaisha-hou-art-396-p1-zen
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-396-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-396-p3
    type: simple
    text: 会計監査人は、その職務を行うため必要があるときは、会計監査人設置会社の子会社に対して会計に関する報告を求め、又は会計監査人設置会社若しくはその子会社の業務及び財産の状況の調査をすることができる。
    modality: kanou_kenri
- number: 4
  has_proviso: false
  has_items: false
...
- number: 6
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-396-p6
    type: simple
    text: 指名委員会等設置会社における第二項の規定の適用については、同項中「取締役」とあるのは、「執行役、取締役」とする。
    modality: gimu
    references:
    - 同項
cases: []
