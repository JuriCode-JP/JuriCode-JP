...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-910-p1
    type: simple
    text: この法律の規定により登記すべき事項のうち官庁の許可を要するものの登記の期間については、その許可書の到達した日から起算する。
...
<!-- segment: simple id: kaisha-hou-art-910-p1 -->
