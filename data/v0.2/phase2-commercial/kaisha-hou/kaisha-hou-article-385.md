...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-385-p1
    type: simple
    text: 監査役は、取締役が監査役設置会社の目的の範囲外の行為その他法令若しくは定款に違反する行為をし、又はこれらの行為をするおそれがある場合において、当該行為によって当該監査役設置会社に著しい損害が生ずるおそれがあるときは、当該取締役に対し、当該行為をやめることを請求することができる。
...
<!-- segment: simple id: kaisha-hou-art-385-p1 -->
...
<!-- segment: simple id: kaisha-hou-art-385-p2 -->
