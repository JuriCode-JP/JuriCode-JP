...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-894-p1
    type: simple
    text: 裁判所は、監督委員を解任する場合には、当該監督委員の陳述を聴かなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-894-p2
    type: simple
    text: 第五百三十二条第一項の規定による決定に対しては、即時抗告をすることができる。
