...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-875-p1
    type: simple
    text: この法律の規定による非訟事件については、非訟事件手続法第四十条及び第五十七条第二項第二号の規定は、適用しない。
    modality: jogai
cases: []
amendments: []
tags:
...
# 会社法 第875条(（非訟事件手続法の規定の適用除外）)

## 原文 (日本語)

### 第八百七十五条

<!-- segment: simple id: kaisha-hou-art-875-p1 -->
