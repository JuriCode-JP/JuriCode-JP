...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-511-p1
    type: simple
    text: 債権者、清算人、監査役又は株主は、特別清算開始の申立てをすることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-511-p2
    type: simple
    text: 清算株式会社に債務超過の疑いがあるときは、清算人は、特別清算開始の申立てをしなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: kaisha-hou-art-511-p1 -->
債権者、清算人、監査役又は株主は、特別清算開始の申立てをすることができる。

### 第五百十一条第二項

<!-- segment: simple id: kaisha-hou-art-511-p2 -->
