...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-522-p2
    type: simple
    text: 清算株式会社の財産につき担保権（特別の先取特権、質権、抵当権又はこの法律若しくは商法の規定による留置権に限る。）を有する債権者がその担保権の行使によって弁済を受けることができる債権の額は、前項の債権の額に算入しない。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-522-p3
    type: simple
    text: 公開会社でない清算株式会社における第一項の規定の適用については、同項中「六箇月（これを下回る期間を定款で定めた場合にあっては、その期間）前から引き続き有する」とあるのは、「有する」とする。
    modality: gimu
    references:
    - 同項
cases: []
...
<!-- segment: hashira id: kaisha-hou-art-522-p1-hashira -->
