...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-734-p1
    type: simple
    text: 社債権者集会の決議は、裁判所の認可を受けなければ、その効力を生じない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-734-p2
    type: simple
    text: 社債権者集会の決議は、当該種類の社債を有するすべての社債権者に対してその効力を有する。
    modality: unspecified
cases: []
amendments: []
tags:
