...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-965-p1
    type: simple
    text: 第九百六十条第一項第一号から第七号までに掲げる者が、株式の発行に係る払込みを仮装するため預合いを行ったときは、五年以下の拘禁刑若しくは五百万円以下の罰金に処し、又はこれを併科する。預合いに応じた者も、同様とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: kaisha-hou-art-965-p1 -->
