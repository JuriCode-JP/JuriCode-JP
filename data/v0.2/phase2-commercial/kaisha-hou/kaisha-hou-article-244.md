...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-244-p1
    type: simple
    text: 前二条の規定は、募集新株予約権を引き受けようとする者がその総数の引受けを行う契約を締結する場合には、適用しない。
    modality: jogai
    references:
    - 前二条
- number: 2
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-244-p3-hashira
    type: hashira
    text: 第一項に規定する場合において、次に掲げるときは、株式会社は、株主総会（取締役会設置会社にあっては、取締役会）の決議によって、同項の契約の承認を受けなければならない。ただし、定款に別段の定めがある場合は、この限りでない。
    modality: jogai
    references:
    - 同項
cases: []
...
# 会社法 第244条(（募集新株予約権の申込み及び割当てに関する特則）)
