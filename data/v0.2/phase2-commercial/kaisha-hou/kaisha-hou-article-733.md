...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-733-p1
    type: simple
    text: 裁判所は、次のいずれかに該当する場合には、社債権者集会の決議の認可をすることができない。
...
# 会社法 第733条(（社債権者集会の決議の不認可）)

## 原文 (日本語)

### 第七百三十三条

<!-- segment: simple id: kaisha-hou-art-733-p1 -->
