...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-66-p1
    type: simple
    text: 創立総会は、この節に規定する事項及び株式会社の設立の廃止、創立総会の終結その他株式会社の設立に関する事項に限り、決議をすることができる。
...
<!-- segment: simple id: kaisha-hou-art-66-p1 -->
