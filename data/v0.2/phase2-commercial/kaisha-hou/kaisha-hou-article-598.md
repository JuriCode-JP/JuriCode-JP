...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-598-p1
    type: simple
    text: 法人が業務を執行する社員である場合には、当該法人は、当該業務を執行する社員の職務を行うべき者を選任し、その者の氏名及び住所を他の社員に通知しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
