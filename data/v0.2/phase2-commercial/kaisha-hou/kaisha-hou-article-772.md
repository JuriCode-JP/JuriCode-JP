...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-772-p1-zen
    type: zen_dan
    text: 一又は二以上の株式会社は、株式移転をすることができる。
    modality: kanou_kenri
  - id: kaisha-hou-art-772-p1-kou
    type: kou_dan
    text: この場合においては、株式移転計画を作成しなければならない。
    modality: gimu
    depends_on: kaisha-hou-art-772-p1-zen
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-772-p2
    type: simple
    text: 二以上の株式会社が共同して株式移転をする場合には、当該二以上の株式会社は、共同して株式移転計画を作成しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
