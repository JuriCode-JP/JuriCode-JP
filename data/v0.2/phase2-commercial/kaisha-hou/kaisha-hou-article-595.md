...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-595-p1-hashira
    type: hashira
    text: 業務を執行する社員は、次に掲げる場合には、当該取引について当該社員以外の社員の過半数の承認を受けなければならない。ただし、定款に別段の定めがある場合は、この限りでない。
    modality: jogai
- number: 2
  has_proviso: false
  has_items: false
...
<!-- segment: hashira id: kaisha-hou-art-595-p1-hashira -->
業務を執行する社員は、次に掲げる場合には、当該取引について当該社員以外の社員の過半数の承認を受けなければならない。ただし、定款に別段の定めがある場合は、この限りでない。

### 第五百九十五条第二項

<!-- segment: simple id: kaisha-hou-art-595-p2 -->
