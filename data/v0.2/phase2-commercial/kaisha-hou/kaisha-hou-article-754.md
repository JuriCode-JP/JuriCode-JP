...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-754-p1
    type: simple
    text: 新設合併設立株式会社は、その成立の日に、新設合併消滅会社の権利義務を承継する。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-754-p3-hashira
    type: hashira
    text: 次の各号に掲げる場合には、新設合併消滅株式会社の株主又は新設合併消滅持分会社の社員は、新設合併設立株式会社の成立の日に、前条第一項第九号に掲げる事項についての定めに従い、当該各号に定める者となる。
    modality: unspecified
    references:
    - 前条
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: kaisha-hou-art-754-p4
    type: simple
    text: 新設合併消滅株式会社の新株予約権は、新設合併設立株式会社の成立の日に、消滅する。
    modality: unspecified
- number: 5
  has_proviso: false
  has_items: false
