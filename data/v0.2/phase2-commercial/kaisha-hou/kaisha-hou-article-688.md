...
- number: 1
  ...
  segments:
  - id: kaisha-hou-art-688-p1
    type: simple
    text: 社債の譲渡は、その社債を取得した者の氏名又は名称及び住所を社債原簿に記載し、又は記録しなければ、社債発行会社その他の第三者に対抗することができない。
