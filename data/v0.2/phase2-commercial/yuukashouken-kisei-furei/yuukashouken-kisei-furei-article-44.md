...
article_number: '44'
article_id: yuukashouken-kisei-furei-art-44
...
- number: 1
  ...
  segments:
  - id: yuukashouken-kisei-furei-art-44-p1
    type: simple
    text: 法第百六十五条の二第十二項の組合利益関係書類の写しは、関東財務局に備え置き、公衆の縦覧に供するものとする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 有価証券の取引等の規制に関する内閣府令 第44条(（組合利益関係書類の写しの公衆縦覧）)
