...
article_number: '33'
article_id: yuukashouken-kisei-furei-art-33
...
- number: 1
  ...
  segments:
  - id: yuukashouken-kisei-furei-art-33-p1
    type: simple
    text: 法第百六十四条第九項に規定する内閣府令で定める場合は、第三十条第一項各号に掲げる場合とする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 有価証券の取引等の規制に関する内閣府令 第33条(（短期売買利益の返還の適用除外）)
