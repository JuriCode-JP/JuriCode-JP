...
article_number: 19-6
article_id: kigyou-kaiji-furei-art-19-6
...
- number: 1
  ...
  segments:
  - id: kigyou-kaiji-furei-art-19-6-p1-hashira
    type: hashira
    text: 法第二十四条の七第一項に規定する親会社等状況報告書を提出すべき外国親会社等が令第四条の五ただし書に規定する承認を受けようとする場合には、次に掲げる事項を記載した承認申請書を財務局長等に提出しなければならない。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kigyou-kaiji-furei-art-19-6-p2
    type: junyou
    text: 第十九条の四第一項の規定は、外国親会社等が前項の承認申請書を提出する場合について準用する。
    modality: unspecified
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kigyou-kaiji-furei-art-19-6-p3-hashira
    type: hashira
    text: 第一項の承認申請書には、次に掲げる書類を添付しなければならない。
    modality: gimu
...
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: kigyou-kaiji-furei-art-19-6-p5-hashira
    type: hashira
    text: 前項の規定による承認（第一項第三号に規定する理由が本国の法令又は慣行である場合に限る。）は、前項の外国親会社等が毎事業年度経過後三月以内に次に掲げる事項を記載した書面を財務局長等に提出することを条件として、行われるものとする。ただし、第二号に掲げる事項を記載した書面については、当該書面提出前五年以内に提出されたものと同一内容のものである場合には、当該書面は提出しないことができる。
...
- number: 6
  ...
  is_added_by_amendment: false
  segments:
  - id: kigyou-kaiji-furei-art-19-6-p6
    type: simple
    text: 第四項の規定による承認に係る第一項第三号に規定する理由について消滅又は変更があつた場合には、財務局長等は、第四項の規定による承認に係る期間を変更し、又は当該承認を将来に向かつて取り消すことができる。
...
- number: 7
  ...
  is_added_by_amendment: false
  segments:
  - id: kigyou-kaiji-furei-art-19-6-p7
    type: simple
    text: 第三項各号に掲げる書類及び第五項各号に掲げる事項を記載した書面が日本語によつて記載したものでないときは、その日本語による翻訳文を付さなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
# 企業内容等の開示に関する内閣府令 第19-6条(（外国親会社等に係る親会社等状況報告書の提出期限の承認の手続等）)
...
前項の規定による承認（第一項第三号に規定する理由が本国の法令又は慣行である場合に限る。）は、前項の外国親会社等が毎事業年度経過後三月以内に次に掲げる事項を記載した書面を財務局長等に提出することを条件として、行われるものとする。ただし、第二号に掲げる事項を記載した書面については、当該書面提出前五年以内に提出されたものと同一内容のものである場合には、当該書面は提出しないことができる。
