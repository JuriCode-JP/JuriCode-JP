...
article_number: 1-8
article_id: kinsho-hou-shikkourei-art-1-8
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-shikkourei-art-1-8-p1
    type: simple
    text: 法第二条第四項第一号に規定する多数の者を相手方として行う場合として政令で定める場合は、五十名以上の者を相手方として行う場合とする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 金融商品取引法施行令 第1-8条(（多数の者を相手方とする場合）)
