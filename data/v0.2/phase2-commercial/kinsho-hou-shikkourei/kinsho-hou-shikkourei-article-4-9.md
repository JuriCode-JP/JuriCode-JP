...
article_number: 4-9
article_id: kinsho-hou-shikkourei-art-4-9
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-shikkourei-art-4-9-p1
    type: simple
    text: 法第二十七条の規定において発行者が会社以外の者である場合について法の規定を準用する場合における同条の規定による技術的読替えは、次の表のとおりとする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 金融商品取引法施行令 第4-9条(（発行者が会社以外の者である場合の読替え）)
