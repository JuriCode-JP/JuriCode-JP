...
article_number: 1-15
article_id: kinsho-hou-shikkourei-art-1-15
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-shikkourei-art-1-15-p1-hashira
    type: hashira
    text: 法第二条第二十二項に規定する公益又は投資者の保護のため支障を生ずることがないと認められるものとして政令で定めるものは、次に掲げるものとする。
    modality: gimu
...
# 金融商品取引法施行令 第1-15条(（店頭デリバティブ取引から除かれるもの）)
