...
article_number: 15-21
article_id: kinsho-hou-shikkourei-art-15-21
...
- number: 1
  ...
  segments:
  - id: kinsho-hou-shikkourei-art-15-21-p1
    type: simple
    text: 法第三十三条の八第二項に規定する特定金融商品取引業務を行う者は、当該業務を行う場合には、当該業務に係る登録金融機関の代理を行う者である旨を明示しなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kinsho-hou-shikkourei-art-15-21-p2-hashira
    type: hashira
    text: 法第三十三条の八第二項第一号に規定する政令で定める者は、次に掲げる者とする。
    modality: gimu
...
# 金融商品取引法施行令 第15-21条(（特定金融商品取引業務を行う者）)
...
四　個人である損害保険代理店の使用人のうち保険業法第三百二条の規定による届出が行われているもの

五　法人である損害保険代理店の役員又は使用人のうち保険業法第三百二条の規定による届出が行われているもの
