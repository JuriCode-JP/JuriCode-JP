...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhou-art-546-p2
    type: simple
    text: 前項の場合においては、当事者が直ちに履行をすべきときを除き、仲立人は、各当事者に結約書に署名させ、又は記名押印させた後、これをその相手方に交付しなければならない。
    modality: gimu
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: shouhou-art-546-p3
    type: simple
    text: 前二項の場合において、当事者の一方が結約書を受領せず、又はこれに署名若しくは記名押印をしないときは、仲立人は、遅滞なく、相手方に対してその旨の通知を発しなければならない。
    modality: gimu
    references:
    - 前二項
cases: []
