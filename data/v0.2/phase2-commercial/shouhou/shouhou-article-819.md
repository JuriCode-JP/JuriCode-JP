...
- number: 1
  ...
  segments:
  - id: shouhou-art-819-p1
    type: simple
    text: 貨物を保険の目的物とする海上保険契約（以下この章において「貨物保険契約」という。）については、その船積みがされた地及び時における当該貨物の価額、運送賃並びに保険に関する費用の合計額を保険価額とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: shouhou-art-819-p1 -->
