...
- number: 1
  ...
  segments:
  - id: shouhou-art-798-p1
    type: simple
    text: 船舶所有者が前条第四項の規定により救助料の割合を決定するには、航海を終了するまでにその案を作成し、これを船員に示さなければならない。
    modality: gimu
    references:
    - 前条
cases: []
...
<!-- segment: simple id: shouhou-art-798-p1 -->
