...
- number: 1
  ...
  segments:
  - id: shouhou-art-818-p1
    type: simple
    text: 船舶を保険の目的物とする海上保険契約（以下この章において「船舶保険契約」という。）については、保険期間の始期における当該船舶の価額を保険価額とする。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: shouhou-art-818-p1 -->
