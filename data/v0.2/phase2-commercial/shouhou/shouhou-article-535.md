...
- number: 1
  ...
  segments:
  - id: shouhou-art-535-p1
    type: simple
    text: 匿名組合契約は、当事者の一方が相手方の営業のために出資をし、その営業から生ずる利益を分配することを約することによって、その効力を生ずる。
...
<!-- segment: simple id: shouhou-art-535-p1 -->
