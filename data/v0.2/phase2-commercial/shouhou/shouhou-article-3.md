...
- number: 1
  ...
  - id: shouhou-art-3-p1
    type: simple
    text: 当事者の一方のために商行為となる行為については、この法律をその双方に適用する。
...
- number: 2
  ...
  - id: shouhou-art-3-p2
    type: simple
    text: 当事者の一方が二人以上ある場合において、その一人のために商行為となる行為については、この法律をその全員に適用する。
    modality: unspecified
cases: []
amendments: []
tags:
...
<!-- segment: simple id: shouhou-art-3-p1 -->
当事者の一方のために商行為となる行為については、この法律をその双方に適用する。

### 第三条第二項

<!-- segment: simple id: shouhou-art-3-p2 -->
