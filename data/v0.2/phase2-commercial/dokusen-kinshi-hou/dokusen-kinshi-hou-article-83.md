...
article_number: '83'
article_id: dokusen-kinshi-hou-art-83
...
- number: 1
  ...
  segments:
  - id: dokusen-kinshi-hou-art-83-p1
    type: simple
    text: 秘密保持命令が発せられた訴訟（すべての秘密保持命令が取り消された訴訟を除く。）に係る訴訟記録につき、民事訴訟法第九十二条第一項の決定があつた場合において、当事者から同項に規定する秘密記載部分の閲覧等の請求があり、かつ、その請求の手続を行つた者が当該訴訟において秘密保持命令を受けていない者であるときは、裁判所書記官は、同項の申立てをした当事者（その請求をした者を除く。第三項において同じ。）に対し、その請求後直ちに、その請求があつた旨を通知しなければならない。
    modality: gimu
    references:
    - 同項
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: dokusen-kinshi-hou-art-83-p2
    type: simple
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: dokusen-kinshi-hou-art-83-p3
    type: simple
...
# 昭和二十二年法律第五十四号（私的独占の禁止及び公正取引の確保に関する法律） 第83条

## 原文 (日本語)

### 第八十三条第一項

<!-- segment: simple id: dokusen-kinshi-hou-art-83-p1 -->
...
<!-- segment: simple id: dokusen-kinshi-hou-art-83-p2 -->
...
<!-- segment: simple id: dokusen-kinshi-hou-art-83-p3 -->
