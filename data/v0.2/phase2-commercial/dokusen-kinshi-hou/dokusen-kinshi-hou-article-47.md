...
- number: 1
  ...
  segments:
  - id: dokusen-kinshi-hou-art-47-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: dokusen-kinshi-hou-art-47-p2
    type: simple
    text: 公正取引委員会が相当と認めるときは、政令で定めるところにより、公正取引委員会の職員を審査官に指定し、前項の処分をさせることができる。
    modality: kanou_kenri
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: dokusen-kinshi-hou-art-47-p3
    type: simple
    text: 前項の規定により職員に立入検査をさせる場合においては、これに身分を示す証明書を携帯させ、関係者に提示させなければならない。
    modality: gimu
    references:
    - 前項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: dokusen-kinshi-hou-art-47-p4
    type: simple
    text: 第一項の規定による処分の権限は、犯罪捜査のために認められたものと解釈してはならない。
