...
article_number: '1'
article_id: kinsho-teigi-furei-art-1
...
- number: 1
  ...
  segments:
  - id: kinsho-teigi-furei-art-1-p1
    type: simple
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-teigi-furei-art-1-p2
    type: simple
    text: この府令において「第一種金融商品取引業」、「第二種金融商品取引業」、「投資運用業」又は「有価証券関連業」とは、それぞれ法第二十八条に規定する第一種金融商品取引業、第二種金融商品取引業、投資運用業又は有価証券関連業をいう。
    modality: teigi
- number: 3
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: kinsho-teigi-furei-art-1-p3-hashira
    type: hashira
