...
article_number: 1-14
article_id: kinsho-kachoukin-furei-art-1-14
...
- number: 1
  ...
  segments:
  - id: kinsho-kachoukin-furei-art-1-14-p1-hashira
    type: hashira
    text: 法第百七十四条第五項第一号に規定する内閣府令で定める者は、次の各号に掲げる者とする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kinsho-kachoukin-furei-art-1-14-p2-hashira
    type: hashira
    text: 法第百七十四条第五項第二号に規定する内閣府令で定める者は、次の各号に掲げる者とする。
    modality: gimu
...
# 金融商品取引法第六章の二の規定による課徴金に関する内閣府令 第1-14条(（仮装売買等による相場操縦行為に係る課徴金の計算における違反者と密接な関係を有する者等）)
