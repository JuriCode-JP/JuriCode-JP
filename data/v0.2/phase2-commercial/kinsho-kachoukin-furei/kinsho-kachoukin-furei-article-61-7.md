...
- number: 1
  ...
  - id: kinsho-kachoukin-furei-art-61-7-p1-kou-1
    type: kou
    text: '別紙様式による報告書を次に掲げる方法のいずれかにより証券取引等監視委員会に提出する方法
  ...
  - id: kinsho-kachoukin-furei-art-61-7-p1-kou-2
    type: kou
    text: 別紙様式による報告書に記載すべき事項を記録した電磁的記録（法第十三条第五項に規定する電磁的記録をいう。）を電子メール（特定電子メールの送信の適正化等に関する法律（平成十四年法律第二十六号）第二条第一号に規定する電子メールをいう。）を利用して証券取引等監視委員会があらかじめ指定した電子メールアドレス（同条第三号に規定する電子メールアドレスをいう。）宛てに送信する方法又はこれに準ずる方法により証券取引等監視委員会に提供する方法
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
