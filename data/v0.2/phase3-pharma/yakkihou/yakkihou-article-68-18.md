...
article_number: 68-18
article_id: yakkihou-art-68-18
...
- number: 1
  ...
  segments:
  - id: yakkihou-art-68-18-p1-hashira
    type: hashira
    text: 厚生労働大臣が指定する生物由来製品は、第五十二条第二項各号（第六十条又は第六十二条において準用する場合を含む。）又は第六十三条の二第二項各号に掲げる事項のほか、これに添付する文書又はその容器若しくは被包に、次に掲げる事項が記載されていなければならない。ただし、厚生労働省令で別段の定めをしたときは、この限りでない。
    modality: jogai
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律 第68-18条(（添付文書等の記載事項）)
