...
- number: 1
  ...
  segments:
  - id: yakkihou-art-6-3-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-art-6-3-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-art-6-3-p3
    type: simple
    text: 第一項の認定を受けた者は、専門医療機関連携薬局と称するに当たつては、厚生労働省令で定めるところにより、同項に規定する傷病の区分を明示しなければならない。
    modality: gimu
    references:
    - 同項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-art-6-3-p4
    type: simple
    text: 専門医療機関連携薬局でないものは、これに専門医療機関連携薬局又はこれに紛らわしい名称を用いてはならない。
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律 第6-3条(（専門医療機関連携薬局）)
