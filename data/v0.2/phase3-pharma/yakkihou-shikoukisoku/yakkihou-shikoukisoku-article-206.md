...
- number: 1
  ...
  - id: yakkihou-shikoukisoku-art-206-p1-kou-2
    type: kou
    text: 電磁的記録媒体をもつて調製するファイルに書面に記載すべき事項を記録したものを交付する方法
    modality: unspecified
    item_number: 2
- number: 2
  has_proviso: false
  ...
  - id: yakkihou-shikoukisoku-art-206-p2-kou-1
    type: kou
    text: 薬局開設者等がファイルへの記録を出力することによる文書を作成することができるものであること。
    modality: unspecified
    item_number: 1
  - id: yakkihou-shikoukisoku-art-206-p2-kou-2
    type: kou
    text: ファイルに記録された文書に記載すべき事項について、改変が行われていないかどうかを確認することができる措置を講じていること。
    modality: unspecified
    item_number: 2
- number: 3
  has_proviso: false
