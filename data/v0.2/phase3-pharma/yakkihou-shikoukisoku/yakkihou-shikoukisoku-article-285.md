...
article_number: '285'
article_id: yakkihou-shikoukisoku-art-285
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-285-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-285-p2
    type: simple
    text: 許可事業者は、前項の書面を、法の規定により許可を受けて業務を行う場所ごとに、記載の日から三年間、保存しなければならない。
    modality: gimu
    references:
    - 前項
cases: []
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第285条
