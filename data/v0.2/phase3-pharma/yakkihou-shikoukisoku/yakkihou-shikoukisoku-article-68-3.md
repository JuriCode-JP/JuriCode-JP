...
article_number: 68-3
article_id: yakkihou-shikoukisoku-art-68-3
...
- number: 1
  ...
  - id: yakkihou-shikoukisoku-art-68-3-p1-kou-7
    type: kou
    text: 前各号に掲げるもののほか、最終的な製品の有効性及び安全性に影響を与えないと認められる事項
    modality: unspecified
    item_number: 7
cases: []
amendments: []
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第68-3条(（変更計画の確認を受けることができる場合）)
