...
article_number: 228-12
article_id: yakkihou-shikoukisoku-art-228-12
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-228-12-p1
    type: simple
    text: 法第六十八条の五第四項の厚生労働省令で定める基準は、本邦内において特定医療機器の一の品目の全てを取り扱う販売業者若しくは貸与業者又は製造販売業者（当該品目について法第二十三条の二の五第一項の承認を受けた者を除く。）であることとする。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-228-12-p2-hashira
    type: hashira
    text: 法第六十八条の五第四項の厚生労働省令で定める事項は、次のとおりとする。
    modality: gimu
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-228-12-p3
    type: simple
    text: 法第六十八条の五第四項の規定による届出は、様式第九十八による届書（正副二通）を提出することによつて行うものとする。
    modality: gimu
- number: 4
  has_proviso: true
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-228-12-p4-hashira
    type: hashira
    text: 前項の届書には、次に掲げる書類を添付しなければならない。ただし、申請等の行為の際厚生労働大臣に提出された書類については、当該届書にその旨が付記されたときは、この限りでない。
    modality: jogai
    references:
    - 前項
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第228-12条(（記録等の事務の委託）)
