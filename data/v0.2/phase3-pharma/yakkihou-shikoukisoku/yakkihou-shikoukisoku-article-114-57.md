...
article_number: 114-57
article_id: yakkihou-shikoukisoku-art-114-57
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-114-57-p1
    type: simple
    text: 製造のために医療機器又は体外診断用医薬品を、業として、輸入しようとする製造業者は、通関のときまでに、輸入しようとする品目について、次のいずれかが行われていることを証する書類又はその写しを有していなければならない。
    modality: gimu
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第114-57条(（製造のための医療機器又は体外診断用医薬品の輸入に係る手続）)
