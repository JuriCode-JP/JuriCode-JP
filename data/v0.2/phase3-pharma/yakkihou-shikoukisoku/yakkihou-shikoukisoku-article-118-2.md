...
article_number: 118-2
article_id: yakkihou-shikoukisoku-art-118-2
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-118-2-p1-hashira
    type: hashira
    text: 法第二十三条の三の二第一項の厚生労働省令で定める資料及び情報は、次のとおりとする。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-118-2-p2
    type: simple
    text: 法第二十三条の三の二第三項の規定による届出は、様式第六十八の五による届書（正副二通）を登録認証機関に提出することによつて行うものとする。
    modality: gimu
- number: 3
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-118-2-p3
    type: simple
    text: 前項の届書には、医療機器等認証取得者の地位を承継する者であることを証する書類を添えなければならない。
    modality: gimu
    references:
    - 前項
cases: []
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第118-2条(（承継の届出）)
