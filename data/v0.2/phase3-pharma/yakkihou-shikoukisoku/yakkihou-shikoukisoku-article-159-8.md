...
article_number: 159-8
article_id: yakkihou-shikoukisoku-art-159-8
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-159-8-p1-hashira
    type: hashira
    text: 販売従事登録を行うため、都道府県に登録販売者名簿を備え、次に掲げる事項を登録する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-159-8-p2
    type: simple
    text: 都道府県知事は、販売従事登録を行つたときは、当該販売従事登録を受けた者に対して、様式第八十六の三による登録証（以下「販売従事登録証」という。）を交付しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第159-8条(（登録販売者名簿及び登録証の交付）)
