...
article_number: '204'
article_id: yakkihou-shikoukisoku-art-204
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-204-p1
    type: simple
    text: 法第四十四条第一項及び第二項に規定する毒薬及び劇薬は、別表第三のとおりとする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第204条(（毒薬及び劇薬の範囲）)
