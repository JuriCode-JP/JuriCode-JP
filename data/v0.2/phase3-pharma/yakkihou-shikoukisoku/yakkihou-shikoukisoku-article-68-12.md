...
article_id: yakkihou-shikoukisoku-art-68-12
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第68-12条(（届出後に変更を行うことができるようになるまでの日数）)
