...
article_number: 149-5
article_id: yakkihou-shikoukisoku-art-149-5
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-149-5-p1-hashira
    type: hashira
    text: 配置販売業者は、医薬品を購入し、又は譲り受けたときは、次に掲げる事項を書面に記載しなければならない。
    modality: gimu
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-149-5-p2-honbun
    type: honbun
    text: 配置販売業者は、前項の規定に基づき書面に記載するに際し、当該配置販売業者に対して医薬品を販売又は授与した者から、許可証等の写しその他の資料の提示を受けることで、当該者の住所又は所在地、電話番号その他の連絡先を確認しなければならない。
    modality: gimu
    references:
    - 前項
  - id: yakkihou-shikoukisoku-art-149-5-p2-tadashi
    type: tadashi
    text: ただし、当該者が当該配置販売業者と常時取引関係にある場合は、この限りではない。
    modality: unspecified
- number: 3
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-149-5-p3-hashira
    type: hashira
    text: 配置販売業者は、第一類医薬品を配置したときは、次に掲げる事項を書面に記載しなければならない。
    modality: gimu
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-149-5-p4
    type: simple
    text: 配置販売業者は、第一項の書面を記載の日から三年間、前項の書面を記載の日から二年間、保存しなければならない。
    modality: gimu
    references:
    - 前項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-149-5-p5-hashira
    type: hashira
    text: 配置販売業者は、第二類医薬品又は第三類医薬品を配置したときは、次に掲げる事項を書面に記載し、これを保存するよう努めなければならない。
...
- number: 6
  ...
  is_added_by_amendment: false
  segments:
  - id: yakkihou-shikoukisoku-art-149-5-p6
    type: simple
    text: 配置販売業者は、一般用医薬品を配置したときは、当該一般用医薬品を配置販売によつて購入し、又は譲り受けようとする者の連絡先を書面に記載し、これを保存するよう努めなければならない。
    modality: doryoku_gimu
cases: []
amendments: []
tags:
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第149-5条(（医薬品の購入等に関する記録）)
