...
article_number: '182'
article_id: yakkihou-shikoukisoku-art-182
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-182-p1
    type: simple
    text: 医療機器の修理業の許可証は、様式第九十二によるものとする。
    modality: gimu
cases: []
amendments: []
tags:
...
# 医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律施行規則 第182条(（修理業の許可証の様式）)
