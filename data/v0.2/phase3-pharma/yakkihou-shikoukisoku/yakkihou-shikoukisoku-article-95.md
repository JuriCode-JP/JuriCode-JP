...
article_number: '95'
article_id: yakkihou-shikoukisoku-art-95
...
- number: 1
  ...
  segments:
  - id: yakkihou-shikoukisoku-art-95-p1
    type: simple
    text: 製造のために医薬品、医薬部外品又は化粧品を、業として、輸入しようとする製造業者は、通関のときまでに、輸入しようとする品目について、次のいずれかが行われていることを証する書類又はその写しを有していなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: yakkihou-shikoukisoku-art-95-p1 -->
