...
article_number: '106'
article_id: roudou-kijun-hou-art-106
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-106-p2
    type: simple
    text: 使用者は、この法律及びこの法律に基いて発する命令のうち、寄宿舎に関する規定及び寄宿舎規則を、寄宿舎の見易い場所に掲示し、又は備え付ける等の方法によつて、寄宿舎に寄宿する労働者に周知させなければならない。
    modality: gimu
cases: []
amendments: []
tags:
