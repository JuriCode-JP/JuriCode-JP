...
article_number: '38'
article_id: roudou-kijun-hou-art-38
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-38-p2
    type: simple
    text: 坑内労働については、労働者が坑口に入つた時刻から坑口を出た時刻までの時間を、休憩時間を含め労働時間とみなす。但し、この場合においては、第三十四条第二項及び第三項の休憩に関する規定は適用しない。
    modality: jogai
cases: []
amendments: []
tags:
