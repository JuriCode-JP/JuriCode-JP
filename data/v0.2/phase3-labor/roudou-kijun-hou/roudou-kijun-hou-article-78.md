...
article_number: '78'
article_id: roudou-kijun-hou-art-78
...
- number: 1
  ...
  segments:
  - id: roudou-kijun-hou-art-78-p1
    type: simple
    text: 労働者が重大な過失によつて業務上負傷し、又は疾病にかかり、且つ使用者がその過失について行政官庁の認定を受けた場合においては、休業補償又は障害補償を行わなくてもよい。
...
<!-- segment: simple id: roudou-kijun-hou-art-78-p1 -->
