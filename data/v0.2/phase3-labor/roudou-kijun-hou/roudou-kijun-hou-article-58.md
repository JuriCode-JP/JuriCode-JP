...
article_number: '58'
article_id: roudou-kijun-hou-art-58
...
- number: 1
  ...
  segments:
  - id: roudou-kijun-hou-art-58-p1
    type: simple
    text: 親権者又は後見人は、未成年者に代つて労働契約を締結してはならない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-58-p2
    type: simple
    text: 親権者若しくは後見人又は行政官庁は、労働契約が未成年者に不利であると認める場合においては、将来に向つてこれを解除することができる。
