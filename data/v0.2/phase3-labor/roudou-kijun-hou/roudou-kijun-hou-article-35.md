...
article_number: '35'
article_id: roudou-kijun-hou-art-35
...
- number: 1
  ...
  segments:
  - id: roudou-kijun-hou-art-35-p1
    type: simple
    text: 使用者は、労働者に対して、毎週少くとも一回の休日を与えなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-35-p2
    type: simple
    text: 前項の規定は、四週間を通じ四日以上の休日を与える使用者については適用しない。
    modality: jogai
    references:
    - 前項
cases: []
