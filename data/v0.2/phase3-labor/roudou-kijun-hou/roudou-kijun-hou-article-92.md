...
article_number: '92'
article_id: roudou-kijun-hou-art-92
...
- number: 1
  ...
  segments:
  - id: roudou-kijun-hou-art-92-p1
    type: simple
    text: 就業規則は、法令又は当該事業場について適用される労働協約に反してはならない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-92-p2
    type: simple
    text: 行政官庁は、法令又は労働協約に牴触する就業規則の変更を命ずることができる。
