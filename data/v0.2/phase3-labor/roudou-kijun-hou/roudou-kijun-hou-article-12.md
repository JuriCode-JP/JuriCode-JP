...
article_number: '12'
article_id: roudou-kijun-hou-art-12
...
- number: 1
  ...
  segments:
  - id: roudou-kijun-hou-art-12-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p2
    type: simple
    text: 前項の期間は、賃金締切日がある場合においては、直前の賃金締切日から起算する。
    modality: unspecified
    references:
    - 前項
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p3-hashira
    type: hashira
    text: 前二項に規定する期間中に、次の各号のいずれかに該当する期間がある場合においては、その日数及びその期間中の賃金は、前二項の期間及び賃金の総額から控除する。
    modality: unspecified
    references:
    - 前二項
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p4
    type: simple
    text: 第一項の賃金の総額には、臨時に支払われた賃金及び三箇月を超える期間ごとに支払われる賃金並びに通貨以外のもので支払われた賃金で一定の範囲に属しないものは算入しない。
    modality: unspecified
- number: 5
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p5
    type: simple
    text: 賃金が通貨以外のもので支払われる場合、第一項の賃金の総額に算入すべきものの範囲及び評価に関し必要な事項は、厚生労働省令で定める。
    modality: unspecified
- number: 6
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p6
    type: simple
    text: 雇入後三箇月に満たない者については、第一項の期間は、雇入後の期間とする。
    modality: gimu
- number: 7
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p7
    type: simple
    text: 日日雇い入れられる者については、その従事する事業又は職業について、厚生労働大臣の定める金額を平均賃金とする。
    modality: gimu
- number: 8
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: roudou-kijun-hou-art-12-p8
    type: simple
    text: 第一項乃至第六項によつて算定し得ない場合の平均賃金は、厚生労働大臣の定めるところによる。
    modality: unspecified
cases: []
amendments: []
tags:
