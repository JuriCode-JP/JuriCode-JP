...
article_number: '67'
article_id: gyousei-fufuku-shinsa-hou-art-67
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-67-p1
    type: simple
    text: 総務省に、行政不服審査会（以下「審査会」という。）を置く。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-67-p2
    type: simple
    text: 審査会は、この法律の規定によりその権限に属させられた事項を処理する。
    modality: unspecified
cases: []
amendments: []
tags:
