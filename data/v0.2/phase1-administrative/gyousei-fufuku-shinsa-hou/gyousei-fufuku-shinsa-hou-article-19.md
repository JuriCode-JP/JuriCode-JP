...
article_number: '19'
article_id: gyousei-fufuku-shinsa-hou-art-19
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-19-p1
    type: simple
    text: 審査請求は、他の法律（条例に基づく処分については、条例）に口頭ですることができる旨の定めがある場合を除き、政令で定めるところにより、審査請求書を提出してしなければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: true
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-19-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-19-p3-hashira
    type: hashira
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-19-p4
    type: simple
    text: 審査請求人が、法人その他の社団若しくは財団である場合、総代を互選した場合又は代理人によって審査請求をする場合には、審査請求書には、第二項各号又は前項各号に掲げる事項のほか、その代表者若しくは管理人、総代又は代理人の氏名及び住所又は居所を記載しなければならない。
    modality: gimu
    references:
    - 前項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-19-p5-hashira
    type: hashira
    text: 処分についての審査請求書には、第二項及び前項に規定する事項のほか、次の各号に掲げる場合においては、当該各号に定める事項を記載しなければならない。
    modality: gimu
    references:
    - 前項
