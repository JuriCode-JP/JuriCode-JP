...
article_number: '40'
article_id: gyousei-fufuku-shinsa-hou-art-40
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-40-p1
    type: simple
    text: 審理員は、必要があると認める場合には、審査庁に対し、執行停止をすべき旨の意見書を提出することができる。
...
# 行政不服審査法 第40条(（審理員による執行停止の意見書の提出）)
