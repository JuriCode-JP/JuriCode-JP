...
article_number: '5'
article_id: gyousei-fufuku-shinsa-hou-art-5
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-5-p1-honbun
    type: honbun
    text: 行政庁の処分につき処分庁以外の行政庁に対して審査請求をすることができる場合において、法律に再調査の請求をすることができる旨の定めがあるときは、当該処分に不服がある者は、処分庁に対して再調査の請求をすることができる。
    modality: kanou_kenri
  - id: gyousei-fufuku-shinsa-hou-art-5-p1-tadashi
    type: tadashi
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-5-p2-hashira
    type: hashira
    text: 前項本文の規定により再調査の請求をしたときは、当該再調査の請求についての決定を経た後でなければ、審査請求をすることができない。ただし、次の各号のいずれかに該当する場合は、この限りでない。
    modality: jogai
    references:
    - 前項
  - id: gyousei-fufuku-shinsa-hou-art-5-p2-kou-1
    type: kou
    text: 一　当該処分につき再調査の請求をした日（第六十一条において読み替えて準用する第二十三条の規定により不備を補正すべきことを命じられた場合にあっては、当該不備を補正した日）の翌日から起算して三月を経過しても、処分庁が当該再調査の請求につき決定をしない場合
