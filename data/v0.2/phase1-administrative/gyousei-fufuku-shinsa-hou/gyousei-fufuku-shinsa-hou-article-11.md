...
article_number: '11'
article_id: gyousei-fufuku-shinsa-hou-art-11
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-11-p1
    type: simple
    text: 多数人が共同して審査請求をしようとするときは、三人を超えない総代を互選することができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-11-p2
    type: simple
    text: 共同審査請求人が総代を互選しない場合において、必要があると認めるときは、第九条第一項の規定により指名された者（以下「審理員」という。）は、総代の互選を命ずることができる。
    modality: kanou_kenri
- number: 3
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-11-p3
    type: simple
    text: 総代は、各自、他の共同審査請求人のために、審査請求の取下げを除き、当該審査請求に関する一切の行為をすることができる。
    modality: kanou_kenri
- number: 4
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-11-p4
    type: simple
    text: 総代が選任されたときは、共同審査請求人は、総代を通じてのみ、前項の行為をすることができる。
    modality: kanou_kenri
    references:
    - 前項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-11-p5
    type: simple
    text: 共同審査請求人に対する行政庁の通知その他の行為は、二人以上の総代が選任されている場合においても、一人の総代に対してすれば足りる。
...
- number: 6
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-11-p6
    type: simple
    text: 共同審査請求人は、必要があると認める場合には、総代を解任することができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
