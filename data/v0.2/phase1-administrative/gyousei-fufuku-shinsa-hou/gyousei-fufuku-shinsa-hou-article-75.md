...
article_number: '75'
article_id: gyousei-fufuku-shinsa-hou-art-75
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-75-p1-honbun
    type: honbun
    text: 審査会は、審査関係人の申立てがあった場合には、当該審査関係人に口頭で意見を述べる機会を与えなければならない。
    modality: gimu
  - id: gyousei-fufuku-shinsa-hou-art-75-p1-tadashi
    type: tadashi
    text: ただし、審査会が、その必要がないと認める場合には、この限りでない。
    modality: jogai
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-75-p2
    type: simple
    text: 前項本文の場合において、審査請求人又は参加人は、審査会の許可を得て、補佐人とともに出頭することができる。
