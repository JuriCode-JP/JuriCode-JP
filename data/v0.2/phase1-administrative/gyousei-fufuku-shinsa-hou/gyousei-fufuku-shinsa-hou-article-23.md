...
article_number: '23'
article_id: gyousei-fufuku-shinsa-hou-art-23
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-23-p1
    type: simple
    text: 審査請求書が第十九条の規定に違反する場合には、審査庁は、相当の期間を定め、その期間内に不備を補正すべきことを命じなければならない。
    modality: gimu
cases: []
amendments: []
tags:
