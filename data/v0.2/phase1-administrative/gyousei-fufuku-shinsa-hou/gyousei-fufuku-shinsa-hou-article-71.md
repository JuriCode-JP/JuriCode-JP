...
article_number: '71'
article_id: gyousei-fufuku-shinsa-hou-art-71
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-71-p1
    type: simple
    text: 審査会に、専門の事項を調査させるため、専門委員を置くことができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-71-p2
    type: simple
    text: 専門委員は、学識経験のある者のうちから、総務大臣が任命する。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-71-p3
    type: simple
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-71-p4
    type: simple
    text: 専門委員は、非常勤とする。
    modality: gimu
cases: []
