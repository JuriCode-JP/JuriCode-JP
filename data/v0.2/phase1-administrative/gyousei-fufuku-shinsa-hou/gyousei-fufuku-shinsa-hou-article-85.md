...
article_number: '85'
article_id: gyousei-fufuku-shinsa-hou-art-85
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-85-p1
    type: simple
    text: 不服申立てにつき裁決等をする権限を有する行政庁は、当該行政庁がした裁決等の内容その他当該行政庁における不服申立ての処理状況について公表するよう努めなければならない。
...
<!-- segment: simple id: gyousei-fufuku-shinsa-hou-art-85-p1 -->
