...
article_number: '58'
article_id: gyousei-fufuku-shinsa-hou-art-58
...
- number: 1
  ...
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-58-p1
    type: simple
    text: 再調査の請求が法定の期間経過後にされたものである場合その他不適法である場合には、処分庁は、決定で、当該再調査の請求を却下する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-fufuku-shinsa-hou-art-58-p2
    type: simple
    text: 再調査の請求が理由がない場合には、処分庁は、決定で、当該再調査の請求を棄却する。
    modality: unspecified
cases: []
amendments: []
tags:
