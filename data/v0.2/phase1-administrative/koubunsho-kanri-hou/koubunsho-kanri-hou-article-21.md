...
article_number: '21'
article_id: koubunsho-kanri-hou-art-21
...
- number: 1
  ...
  segments:
  - id: koubunsho-kanri-hou-art-21-p1
    type: simple
    text: 利用請求に対する処分又は利用請求に係る不作為について不服がある者は、国立公文書館等の長に対し、審査請求をすることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: koubunsho-kanri-hou-art-21-p2
    type: simple
    text: 利用請求に対する処分又は利用請求に係る不作為に係る審査請求については、行政不服審査法（平成二十六年法律第六十八号）第九条、第十七条、第二十四条、第二章第三節及び第四節並びに第五十条第二項の規定は、適用しない。
    modality: jogai
- number: 3
  has_proviso: false
  has_items: false
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: koubunsho-kanri-hou-art-21-p4-hashira
    type: hashira
  ...
  - id: koubunsho-kanri-hou-art-21-p4-kou-2
    type: kou
    text: 二　裁決で、審査請求の全部を認容し、当該審査請求に係る特定歴史公文書等の全部を利用させることとする場合（当該特定歴史公文書等の利用について反対意見書が提出されている場合を除く。）
    modality: unspecified
    item_number: 2
cases: []
amendments: []
...
# 公文書等の管理に関する法律 第21条(（審査請求及び公文書管理委員会への諮問）)
