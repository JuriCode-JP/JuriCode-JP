...
article_number: '43'
article_id: gyousei-tetsuzuki-hou-art-43
...
- number: 1
  ...
  segments:
  - id: gyousei-tetsuzuki-hou-art-43-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-tetsuzuki-hou-art-43-p2
    type: tokusoku
    text: 命令等制定機関は、前項の規定にかかわらず、必要に応じ、同項第三号の提出意見に代えて、当該提出意見を整理又は要約したものを公示することができる。この場合においては、当該公示の後遅滞なく、当該提出意見を当該命令等制定機関の事務所における備付けその他の適当な方法により公にしなければならない。
    modality: gimu
    override_flag: true
    override_target:
    - 前項
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-tetsuzuki-hou-art-43-p3
    type: simple
    text: 命令等制定機関は、前二項の規定により提出意見を公示し又は公にすることにより第三者の利益を害するおそれがあるとき、その他正当な理由があるときは、当該提出意見の全部又は一部を除くことができる。
...
- number: 4
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-tetsuzuki-hou-art-43-p4
    type: simple
...
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: gyousei-tetsuzuki-hou-art-43-p5-hashira
    type: hashira
    text: 命令等制定機関は、第三十九条第四項各号のいずれかに該当することにより意見公募手続を実施しないで命令等を定めた場合には、当該命令等の公布と同時期に、次に掲げる事項を公示しなければならない。ただし、第一号に掲げる事項のうち命令等の趣旨については、同項第一号から第四号までのいずれかに該当することにより意見公募手続を実施しなかった場合において、当該命令等自体から明らかでないときに限る。
    modality: unspecified
    references:
    - 同項
