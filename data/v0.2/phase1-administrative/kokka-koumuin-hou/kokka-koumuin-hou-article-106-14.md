...
article_number: 106-14
article_id: kokka-koumuin-hou-art-106-14
...
- number: 1
  ...
  segments:
  - id: kokka-koumuin-hou-art-106-14-p1
    type: simple
    text: 委員会に、再就職等監察官（以下「監察官」という。）を置く。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kokka-koumuin-hou-art-106-14-p2-hashira
    type: hashira
    text: 監察官は、委員会の定めるところにより、次に掲げる事務を行う。
    modality: unspecified
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kokka-koumuin-hou-art-106-14-p3
    type: simple
    text: 監察官のうち常勤とすべきものの定数は、政令で定める。
    modality: unspecified
- number: 4
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kokka-koumuin-hou-art-106-14-p4
    type: simple
    text: 前項に規定するもののほか、監察官は、非常勤とする。
    modality: gimu
    references:
    - 前項
- number: 5
  ...
  is_added_by_amendment: false
  segments:
  - id: kokka-koumuin-hou-art-106-14-p5
    type: simple
    text: 監察官は、役職員又は自衛隊員としての前歴（検察官その他の職務の特殊性を勘案して政令で定める者としての前歴を除く。）を有しない者のうちから、委員会の議決を経て、内閣総理大臣が任命する。
    modality: unspecified
cases: []
amendments: []
tags:
...
parent_section:
  ...
  kan: 2
  kan_name_ja: 第二款　再就職等監視委員会
---

# 国家公務員法 第106-14条(（再就職等監察官）)
