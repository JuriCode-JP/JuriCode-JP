...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kokka-koumuin-hou-art-18-2-p2
    type: simple
    text: 内閣総理大臣は、前項に規定するもののほか、各行政機関がその職員について行なう人事管理に関する方針、計画等に関し、その統一保持上必要な総合調整に関する事務をつかさどる。
    modality: unspecified
    references:
    - 前項
cases: []
