...
article_number: '134'
article_id: chihou-jichi-hou-art-134
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-134-p1
    type: simple
    text: 普通地方公共団体の議会は、この法律並びに会議規則及び委員会に関する条例に違反した議員に対し、議決により懲罰を科することができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-jichi-hou-art-134-p2
    type: simple
    text: 懲罰に関し必要な事項は、会議規則中にこれを定めなければならない。
    modality: gimu
cases: []
amendments: []
tags:
