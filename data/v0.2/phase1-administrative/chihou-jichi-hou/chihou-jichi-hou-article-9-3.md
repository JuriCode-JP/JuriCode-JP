...
article_number: 9-3
article_id: chihou-jichi-hou-art-9-3
...
- number: 4
  ...
  - id: chihou-jichi-hou-art-9-3-p4
    type: simple
    text: 第一項若しくは第二項の規定による公有水面のみに係る市町村の境界変更又は前項の規定による公有水面のみに係る市町村の境界の裁定は、当該公有水面の埋立て（干拓を含む。以下同じ。）が行なわれる場合においては、前三項の規定にかかわらず、公有水面の埋立てに関する法令により当該埋立ての竣しゆん功の認可又は通知がなされる時までこれをすることができる。
    modality: kanou_kenri
    references:
    - 前三項
    - 前項
