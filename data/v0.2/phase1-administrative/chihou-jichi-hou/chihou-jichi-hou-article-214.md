...
article_number: '214'
article_id: chihou-jichi-hou-art-214
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-214-p1
    type: simple
    text: 歳出予算の金額、継続費の総額又は繰越明許費の金額の範囲内におけるものを除くほか、普通地方公共団体が債務を負担する行為をするには、予算で債務負担行為として定めておかなければならない。
    modality: gimu
cases: []
amendments: []
tags:
...
<!-- segment: simple id: chihou-jichi-hou-art-214-p1 -->
