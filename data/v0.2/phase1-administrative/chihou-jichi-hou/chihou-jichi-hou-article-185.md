...
article_number: '185'
article_id: chihou-jichi-hou-art-185
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-185-p1
    type: simple
    text: 選挙管理委員会の委員長が退職しようとするときは、当該選挙管理委員会の承認を得なければならない。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: chihou-jichi-hou-art-185-p2
    type: simple
    text: 委員が退職しようとするときは、委員長の承認を得なければならない。
    modality: gimu
cases: []
amendments: []
tags:
