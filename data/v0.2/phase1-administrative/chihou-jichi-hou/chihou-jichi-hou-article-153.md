...
article_number: '153'
article_id: chihou-jichi-hou-art-153
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-153-p1
    type: simple
    text: 普通地方公共団体の長は、その権限に属する事務の一部をその補助機関である職員に委任し、又はこれに臨時に代理させることができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-jichi-hou-art-153-p2
    type: simple
    text: 普通地方公共団体の長は、その権限に属する事務の一部をその管理に属する行政庁に委任することができる。
    modality: kanou_kenri
cases: []
amendments: []
tags:
