...
article_number: '169'
article_id: chihou-jichi-hou-art-169
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-169-p1
    type: simple
    text: 普通地方公共団体の長、副知事若しくは副市町村長又は監査委員と親子、夫婦又は兄弟姉妹の関係にある者は、会計管理者となることができない。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: chihou-jichi-hou-art-169-p2
    type: simple
    text: 会計管理者は、前項に規定する関係が生じたときは、その職を失う。
