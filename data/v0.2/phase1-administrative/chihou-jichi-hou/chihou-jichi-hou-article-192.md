...
article_number: '192'
article_id: chihou-jichi-hou-art-192
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-192-p1
    type: simple
    text: 選挙管理委員会の処分又は裁決に係る普通地方公共団体を被告とする訴訟については、選挙管理委員会が当該普通地方公共団体を代表する。
...
<!-- segment: simple id: chihou-jichi-hou-art-192-p1 -->
