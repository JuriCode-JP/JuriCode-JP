...
article_number: '226'
article_id: chihou-jichi-hou-art-226
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-226-p1
    type: simple
    text: 市町村は、第二百三十八条の六の規定による公有財産の使用につき使用料を徴収することができるほか、同条第二項の規定により使用の許可を受けた者から加入金を徴収することができる。
