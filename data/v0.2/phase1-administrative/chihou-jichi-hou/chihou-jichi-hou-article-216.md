...
article_number: '216'
article_id: chihou-jichi-hou-art-216
...
- number: 1
  ...
  segments:
  - id: chihou-jichi-hou-art-216-p1
    type: simple
    text: 歳入歳出予算は、歳入にあつては、その性質に従つて款に大別し、かつ、各款中においてはこれを項に区分し、歳出にあつては、その目的に従つてこれを款項に区分しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
