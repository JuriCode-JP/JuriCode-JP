...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-138-p1
    type: simple
    text: 委員長は、委員会の会務を総理し、委員会を代表する。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-138-p2
    type: simple
    text: 委員会は、あらかじめ常勤の委員のうちから、委員長に事故がある場合に委員長を代理する者を定めておかなければならない。
    modality: gimu
cases: []
amendments: []
tags:
