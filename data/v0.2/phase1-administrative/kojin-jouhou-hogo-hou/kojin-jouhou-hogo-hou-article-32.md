...
article_number: '32'
article_id: kojin-jouhou-hogo-hou-art-32
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-32-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-32-p2-hashira
    type: hashira
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-32-p3
    type: simple
    text: 個人情報取扱事業者は、前項の規定に基づき求められた保有個人データの利用目的を通知しない旨の決定をしたときは、本人に対し、遅滞なく、その旨を通知しなければならない。
    modality: gimu
    references:
    - 前項
cases: []
