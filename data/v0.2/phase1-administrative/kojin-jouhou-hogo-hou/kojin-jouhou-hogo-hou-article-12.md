...
article_number: '12'
article_id: kojin-jouhou-hogo-hou-art-12
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-12-p1
    type: simple
    text: 地方公共団体は、その機関が保有する個人情報の適正な取扱いが確保されるよう必要な措置を講ずるものとする。
    modality: gimu
- number: 2
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-12-p2
    type: simple
    text: 地方公共団体は、その設立に係る地方独立行政法人について、その保有する個人情報の適正な取扱いが確保されるよう必要な措置を講ずるものとする。
    modality: gimu
cases: []
amendments: []
tags:
...
parent_section:
  ...
  setsu: 3
  setsu_name_ja: 第三節　地方公共団体の施策
---

# 個人情報の保護に関する法律 第12条(（地方公共団体の機関等が保有する個人情報の保護）)
