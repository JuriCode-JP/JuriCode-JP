...
article_number: '168'
article_id: kojin-jouhou-hogo-hou-art-168
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-168-p1
    type: simple
    text: 委員会は、毎年、内閣総理大臣を経由して国会に対し所掌事務の処理状況を報告するとともに、その概要を公表しなければならない。
    modality: gimu
cases: []
amendments: []
tags:
