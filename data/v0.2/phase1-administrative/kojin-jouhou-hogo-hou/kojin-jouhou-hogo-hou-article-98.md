...
article_number: '98'
article_id: kojin-jouhou-hogo-hou-art-98
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-98-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-98-p2
    type: simple
    text: 代理人は、本人に代わって前項の規定による利用停止の請求（以下この節及び第百二十七条において「利用停止請求」という。）をすることができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-98-p3
    type: simple
    text: 利用停止請求は、保有個人情報の開示を受けた日から九十日以内にしなければならない。
    modality: gimu
cases: []
amendments: []
tags:
