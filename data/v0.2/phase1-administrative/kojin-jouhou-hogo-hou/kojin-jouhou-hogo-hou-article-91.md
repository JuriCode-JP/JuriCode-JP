...
article_number: '91'
article_id: kojin-jouhou-hogo-hou-art-91
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-91-p2
    type: simple
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-91-p3
    type: simple
    text: 行政機関の長等は、訂正請求書に形式上の不備があると認めるときは、訂正請求をした者（以下この節において「訂正請求者」という。）に対し、相当の期間を定めて、その補正を求めることができる。
