...
article_number: '90'
article_id: kojin-jouhou-hogo-hou-art-90
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-90-p1-hashira
    type: hashira
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-90-p2
    type: simple
    text: 代理人は、本人に代わって前項の規定による訂正の請求（以下この節及び第百二十七条において「訂正請求」という。）をすることができる。
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-90-p3
    type: simple
    text: 訂正請求は、保有個人情報の開示を受けた日から九十日以内にしなければならない。
    modality: gimu
cases: []
amendments: []
tags:
