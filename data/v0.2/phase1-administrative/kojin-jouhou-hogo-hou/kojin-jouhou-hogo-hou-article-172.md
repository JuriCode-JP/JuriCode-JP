...
article_number: '172'
article_id: kojin-jouhou-hogo-hou-art-172
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-172-p1
    type: simple
    text: 委員会は、この法律に相当する外国の法令を執行する外国の当局（以下この条において「外国執行当局」という。）に対し、その職務（この法律に規定する委員会の職務に相当するものに限る。次項において同じ。）の遂行に資すると認める情報の提供を行うことができる。
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-172-p2
    type: simple
...
- number: 3
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-172-p3-hashira
    type: hashira
    text: 委員会は、外国執行当局からの要請があったときは、次の各号のいずれかに該当する場合を除き、第一項の規定により提供した情報を当該要請に係る外国の刑事事件の捜査等に使用することについて同意をすることができる。
    modality: kanou_kenri
- number: 4
  has_proviso: false
  has_items: false
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-172-p4
    type: simple
...
# 個人情報の保護に関する法律 第172条(（外国執行当局への情報提供）)

## 原文 (日本語)

### 第百七十二条第一項

<!-- segment: simple id: kojin-jouhou-hogo-hou-art-172-p1 -->
委員会は、この法律に相当する外国の法令を執行する外国の当局（以下この条において「外国執行当局」という。）に対し、その職務（この法律に規定する委員会の職務に相当するものに限る。次項において同じ。）の遂行に資すると認める情報の提供を行うことができる。

### 第百七十二条第二項

<!-- segment: simple id: kojin-jouhou-hogo-hou-art-172-p2 -->
...
<!-- segment: hashira id: kojin-jouhou-hogo-hou-art-172-p3-hashira -->
委員会は、外国執行当局からの要請があったときは、次の各号のいずれかに該当する場合を除き、第一項の規定により提供した情報を当該要請に係る外国の刑事事件の捜査等に使用することについて同意をすることができる。

### 第百七十二条第四項

<!-- segment: simple id: kojin-jouhou-hogo-hou-art-172-p4 -->
