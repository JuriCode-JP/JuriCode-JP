...
article_number: '68'
article_id: kojin-jouhou-hogo-hou-art-68
...
- number: 1
  ...
  segments:
  - id: kojin-jouhou-hogo-hou-art-68-p1
    type: simple
...
- number: 2
  ...
  is_added_by_amendment: false
  segments:
  - id: kojin-jouhou-hogo-hou-art-68-p2-hashira
    type: hashira
    text: 前項に規定する場合には、行政機関の長等は、本人に対し、個人情報保護委員会規則で定めるところにより、当該事態が生じた旨を通知しなければならない。ただし、次の各号のいずれかに該当するときは、この限りでない。
    modality: jogai
    references:
    - 前項
cases: []
