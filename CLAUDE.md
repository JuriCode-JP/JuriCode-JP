...
2026-05-21 時点で Phase 1 拡大第二波完了: **8,022 条 / 30 法令** 投入済 (Phase 2 の商法・会社法・独占禁止法 + Phase 3 労働基準法 を bulk-ingest 先取り投入を含む). 詳細は `docs/strategy.md` を参照。
...
├── data/                  # 構造化済み法令データ(本体) — 2026-05-21 時点 8,022 条 / 30 法令
│   ├── README.md
...
│   ├── phase2-commercial/        # 商法・会社法・独占禁止法 (1,509 条, Phase 2 先取り)
...
*Last updated: 2026-05-21 (Phase 1 expansion 2nd wave: +12 statutes, 6,984 → 8,022 articles, 30 statutes total. Added phase3-labor preview directory.)*
