...
*Last updated: 2026-06-20 (§0 判断・検証の共通OS〔選択的厳密性とAI検証〕を統合: 司令塔『共通規範』のコード作業向け凝縮版を冒頭に追加 + ① Vault CLAUDE.md と相互リンク. 既存§5/§7/§8/§10/§11は全保持・重複は参照で一本化. 前回: 2026-05-25 夕方 FU-108 v0.2 manifest sprint 完了 / 11,758 条 / 43 法令 / 153 tests PASS / CI green)*
